...
timer Tips__mtimer= CreateTimer()
integer Tips__num= 0
string array Tips__tips
...
integer baseItemNum= 30
integer array baseItemList
integer array itemAbiList
hashtable initData__ht= InitHashtable()
constant integer initData__keyId=10
constant integer initData__keyClass=12
constant integer initData__keyDamageType=14
constant integer initData__keyIcon=16
constant integer initData__keyName=18
unit initData__dummy
...
integer array keyBoardMove__isMove
integer array keyBoardMove__movePulse
trigger keyBoardMove__keyMove
item keyBoardMove__pick= null
real array keyBoardMove__DOWNAngle
real array keyBoardMove__LEFTAngle
real array keyBoardMove__UPAngle
real array keyBoardMove__RIGHTAngle
//endglobals from keyBoardMove
//globals from rectChange:
constant boolean LIBRARY_rectChange=true
timer rectChange__mtimer= CreateTimer()
//endglobals from rectChange
//globals from userState:
constant boolean LIBRARY_userState=true
hashtable userState__ht= InitHashtable()
...
//globals from YDWEAdvancedUnitDataSystem:
constant boolean LIBRARY_YDWEAdvancedUnitDataSystem=true
constant real YDWEAdvancedUnitDataSystem__ARMOR_REDUCTION_MULTIPLIER1= 0.1
constant real YDWEAdvancedUnitDataSystem__ARMOR_REDUCTION_MULTIPLIER2= 0.9
constant real YDWEAdvancedUnitDataSystem__NATLOG_094= - 0.105361
...
//endglobals from YDWEAdvancedUnitDataSystem
...
timer dotBuff__mtimer= CreateTimer()
integer dotBuff__max= 0
unit array dotBuff__source
unit array dotBuff__target
real array dotBuff__time
real array dotBuff__pass
real array dotBuff__pulse
real array dotBuff__pulsePass
real array dotBuff__damage
string array dotBuff__damageCast
string array dotBuff__damageIcon
effect array dotBuff__show
//endglobals from dotBuff
//globals from item:
constant boolean LIBRARY_item=true
location item__point
unit item__dummy
trigger array item__spellTrigger
//endglobals from item
//globals from reward:
constant boolean LIBRARY_reward=true
hashtable reward__ht= InitHashtable()
...
hashtable select__ht= InitHashtable()
integer array select__pickList
integer select__pickId= 0
integer select__pickMax= 0
integer array select__baseAbiListNum
...
hashtable talent__ht= InitHashtable()
trigger talent__pickTrg= CreateTrigger()
...
integer array udg_armySpcType
integer udg_armySpcTypeTotal= 0
    // Generated
...
rect gg_rct_Boss_7= null
rect gg_rct_Boss_8= null
...
trigger gg_trg_spcUnitTips= null
...
trigger gg_trg_ItemSpell_26= null
trigger gg_trg_ItemSpell_27= null
trigger gg_trg_ItemSpell_28= null
trigger gg_trg_ItemSpell_29= null
...
unit gg_unit_nech_0096= null
unit gg_unit_nwgt_0050= null
unit gg_unit_nwgt_0100= null
unit gg_unit_nech_0101= null
...
trigger gg_trg_ItemSpell_30= null
...
//library Tips:
    function Tips__roll takes nothing returns nothing
        call DisplayTimedTextFromPlayer(GetLocalPlayer(), 0, 0, 15, "|cff1cadebTips:|r|cffe5cd31" + Tips__tips[GetRandomInt(1, Tips__num)])
    endfunction
    function Tips__insert takes string s returns nothing
        set Tips__num=Tips__num + 1
        set Tips__tips[Tips__num]=s
    endfunction
    function Tips__init takes nothing returns nothing
        call TimerStart(Tips__mtimer, 20, true, function Tips__roll)
        call Tips__insert("出生地墓穴可以选择你当前想要被指引猎杀的领域Boss")
        call Tips__insert("每隔几分钟会出现精英敌人，猎杀他们掉落一个宝箱")
        call Tips__insert("装备通过等级提升最多升到10级，只有宝箱才能帮助你将装备升到Max")
        call Tips__insert("一部分带有持续时间的装备在生效期间会暂停CD")
        call Tips__insert("计分板上的日出倒计时结束后，吸血鬼们将会死于太阳的炙烤，尽快在吸血鬼猎人到来后将其猎杀")
        call Tips__insert("点击角色身上的血液容器，可以查看已经获得的血液能力，也能查看其他领域Boss")
        call Tips__insert("领域Boss死亡后会出现一个传送门，传送回初始坟墓")
        call Tips__insert("幸运值不仅能提高装备和能力的概率，还能提高抽奖获得更好物品的概率")
        call Tips__insert("在左上角英雄的第二个图标来进行一些游戏内设置！")
        call Tips__insert("左上角图鉴(F9)可以查看游戏内所有装备和能力的简略介绍")
        call Tips__insert("如果出现卡顿，可以输入-showoff来关闭一部分特效和跳字")
        call Tips__insert("喜欢本地图，可以来QQ群837754655对作者指手画脚")
        call Tips__insert("注意只有胜利或者失败以后，才会保存数据，提前退出游戏将丢失进度")
    endfunction
...
//library baseSystem:
    ...
    function handBook takes nothing returns nothing
        local quest qm
            ...
            set qm=CreateQuest()
            call QuestSetTitle(qm, "翡翠晶石")
            call QuestSetDescription(qm, "装备变化:|n召唤翡翠之源，引发魔力脉动|n--->>>|n召唤翡翠之源，引发剧烈的魔力脉动")
            call QuestSetIconPath(qm, "ReplaceableTextures\\CommandButtons\\BTNGem.blp")
            ...
            set qm=CreateQuest()
            call QuestSetTitle(qm, "裁决之杖")
            call QuestSetDescription(qm, "装备变化:|n对一个弱小的敌人降下裁决，瞬杀目标|n--->>>|n极快对一个弱小的敌人降下裁决，瞬杀目标")
            call QuestSetIconPath(qm, "ReplaceableTextures\\CommandButtons\\BTNStaffOfSilence.blp")
            ...
            call QuestSetDescription(qm, "装备变化:|n在一段时间内不断产生回旋弯刀，切割最多6个敌人|n--->>>|n在一段时间内不断产生回旋弯刀，切割路径上所有敌人")
            call QuestSetIconPath(qm, "ReplaceableTextures\\CommandButtons\\BTNAdvancedStrengthOfTheMoon.blp")
        
            set qm=CreateQuest()
            call QuestSetTitle(qm, "神圣明灯")
            call QuestSetDescription(qm, "装备变化:|n召唤腐化的神圣之光杀戮敌人|n--->>>|n腐化神灵将跟随吸血鬼，使用腐化神圣之光杀戮敌人")
            call QuestSetIconPath(qm, "ReplaceableTextures\\CommandButtons\\BTNPotionOfRestoration.blp")
            ...
            set qm=CreateQuest()
            call QuestSetTitle(qm, "极地水晶")
            call QuestSetDescription(qm, "装备变化:|n呼唤多段连环的暴风雪|n--->>>|n永不停止的暴风雪")
            call QuestSetIconPath(qm, "ReplaceableTextures\\CommandButtons\\BTNCrystalBall.blp")
            ...
            set qm=CreateQuest()
            call QuestSetTitle(qm, "炎魔心脏")
            call QuestSetDescription(qm, "装备变化:|n向周围喷射火焰|n--->>>|n以极快的速度向周围喷射火焰")
            call QuestSetIconPath(qm, "ReplaceableTextures\\CommandButtons\\BTNHeartOfAszune.blp")
            ...
            set qm=CreateQuest()
            call QuestSetTitle(qm, "升级或获得魔力掌控")
            call QuestSetRequired(qm, false)
            call QuestSetDescription(qm, "|cff3399ff魔法|r伤害可以使得接下来的|cffffcc00非魔法|r伤害更高，最多叠加10层|n|n")
            call QuestSetIconPath(qm, "ReplaceableTextures\\CommandButtons\\BTNMagicalSentry.blp")
            ...
            call QuestSetRequired(qm, false)
            call QuestSetDescription(qm, "增加暴击率,初始暴击伤害为150%|n|n")
            ...
            set qm=CreateQuest()
            call QuestSetTitle(qm, "升级或获得腐坏意志")
            call QuestSetRequired(qm, false)
            call QuestSetDescription(qm, "|cff3399ff魔法|r伤害可以使得接下来的|cffffcc00非魔法|r伤害更高，最多叠加10层|n|n")
            call QuestSetIconPath(qm, "ReplaceableTextures\\CommandButtons\\BTNMagicalSentry.blp")
            ...
            call QuestSetRequired(qm, false)
            call QuestSetDescription(qm, "获得5%的暴击几率，额外提高暴击伤害，初始暴击伤害为150%|n|n")
            ...
            call QuestSetRequired(qm, false)
            call QuestSetDescription(qm, "每当击杀1个敌人获得治疗|n|n")
            call QuestSetIconPath(qm, "ReplaceableTextures\\CommandButtons\\BTNIncinerate.blp")
        
            set qm=CreateQuest()
            call QuestSetTitle(qm, "升级或获得温差撕裂")
            call QuestSetRequired(qm, false)
            call QuestSetDescription(qm, "使用|cff3399ff冰冻|r伤害攻击被|cffaa5555火焰|r伤害过的敌人时附加额外伤害|n|n")
            call QuestSetIconPath(qm, "ReplaceableTextures\\CommandButtons\\BTNtemtear.blp")
            ...
            set qm=CreateQuest()
            call QuestSetTitle(qm, "|cff00ff00森之始祖的能力|r : |cff6699ff幻视")
            call QuestSetRequired(qm, false)
            call QuestSetDescription(qm, "不再能够累积经验值，但被你猎杀的小怪也有几率会掉落宝箱\n        \n|cff22bb22概率：|r 2%\n    \n|cffa4ef0d舍弃力量|r")
            call QuestSetIconPath(qm, "ReplaceableTextures\\CommandButtons\\BTNRavenForm.blp")
        
            set qm=CreateQuest()
            call QuestSetTitle(qm, "|cff00ff00森之始祖的能力|r : |cff6699ff万物")
            call QuestSetRequired(qm, false)
            call QuestSetDescription(qm, "获得一定次数经验值后将获取尊贵之血\n        \n|cff22bb22次数：|r 1/20次\n    \n|cffa4ef0d天生万物以养人|r")
            call QuestSetIconPath(qm, "ReplaceableTextures\\CommandButtons\\BTNNightElfBuild.blp")
            ...
            set qm=CreateQuest()
            call QuestSetTitle(qm, "|cff00ff00腐烂树灵的能力|r : |cff6699ff暗朽")
            call QuestSetRequired(qm, false)
            call QuestSetDescription(qm, "伤害会叠加腐败，一旦超过20层便大幅削弱目标的防御能力\n       \n|cffeeee55增加伤害：|r 50%\n|cffa4ef0d日渐腐朽的不仅仅是身躯|r")
            call QuestSetIconPath(qm, "ReplaceableTextures\\CommandButtons\\BTNAntiMagicShell.blp")
            ...
            set qm=CreateQuest()
            call QuestSetTitle(qm, "|cff00ff00腐烂树灵的能力|r : |cff6699ff败火")
            call QuestSetRequired(qm, false)
            call QuestSetDescription(qm, "每次伤害都会附加固定的伤害\n       \n|cff22bb22附加伤害：|r 120\n        \n|cffa4ef0d树灵腐烂于被衰败的火焰|r")
            call QuestSetIconPath(qm, "ReplaceableTextures\\CommandButtons\\BTNUnholyFrenzy.blp")
        
            set qm=CreateQuest()
            call QuestSetTitle(qm, "|cff00ff00烈阳祭司的能力|r : |cff6699ff虚幻偶像")
            call QuestSetRequired(qm, false)
            call QuestSetDescription(qm, "减少来自敌人的伤害\n|cffeeee55比例：|r 50%\n    \n|cffeee686重要的情报|r")
            ...
            set qm=CreateQuest()
            call QuestSetTitle(qm, "|cff00ff00森之始祖的能力|r : |cff6699ff源水")
            call QuestSetRequired(qm, false)
            call QuestSetDescription(qm, "获得生命恢复能力\n|cff22bb22每秒恢复：|r 20\n    \n|cffa4ef0d滋润大地|r")
            call QuestSetIconPath(qm, "ReplaceableTextures\\CommandButtons\\BTNRejuvenation.blp")
        
            set qm=CreateQuest()
            call QuestSetTitle(qm, "|cff00ff00腐烂树灵的能力|r : |cff6699ff混乱")
            call QuestSetRequired(qm, false)
            call QuestSetDescription(qm, "造成伤害的类型，与上一次不同，便能够叠加1层额外伤害。\n如果造成同类型的伤害则会减少2层\n    \n|cff22bb22叠加伤害：|r 60/层\n    \n|cffa4ef0d为世界带来混乱的代价|r")
            call QuestSetIconPath(qm, "ReplaceableTextures\\CommandButtons\\BTNDestroyer.blp")
    ...
    function baseSystem__init takes nothing returns nothing
...
//library initData:
    ...
    function initItem takes nothing returns nothing
        ...
        local integer id= 0
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I01A', 1)
                call SaveStr(initData__ht, initData__keyClass, 'I01A', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I01A', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I01A', "ReplaceableTextures\\CommandButtons\\BTNPendantOfMana.blp")
                call SaveStr(initData__ht, initData__keyName, 'I01A', "魔法垂饰")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I02A', 2)
                call SaveStr(initData__ht, initData__keyClass, 'I02A', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I02A', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I02A', "ReplaceableTextures\\CommandButtons\\BTNClawsOfAttack.blp")
                call SaveStr(initData__ht, initData__keyName, 'I02A', "三相血刃")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I03A', 3)
                call SaveStr(initData__ht, initData__keyClass, 'I03A', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I03A', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I03A', "ReplaceableTextures\\CommandButtons\\BTNManaFlareOff.blp")
                call SaveStr(initData__ht, initData__keyName, 'I03A', "雷电花芯")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I04A', 4)
                call SaveStr(initData__ht, initData__keyClass, 'I04A', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I04A', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I04A', "ReplaceableTextures\\CommandButtons\\BTNCloakOfFlames.blp")
                call SaveStr(initData__ht, initData__keyName, 'I04A', "火焰风衣")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I05A', 5)
                call SaveStr(initData__ht, initData__keyClass, 'I05A', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I05A', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I05A', "ReplaceableTextures\\CommandButtons\\BTNBoneChimes.blp")
                call SaveStr(initData__ht, initData__keyName, 'I05A', "天灾骨钟")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I06A', 6)
                call SaveStr(initData__ht, initData__keyClass, 'I06A', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I06A', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I06A', "ReplaceableTextures\\CommandButtons\\BTNPotionOfOmniscience.blp")
                call SaveStr(initData__ht, initData__keyName, 'I06A', "酸性药剂")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I07A', 7)
                call SaveStr(initData__ht, initData__keyClass, 'I07A', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I07A', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I07A', "ReplaceableTextures\\CommandButtons\\BTNIceShard.blp")
                call SaveStr(initData__ht, initData__keyName, 'I07A', "冰冻碎片")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I08A', 8)
                call SaveStr(initData__ht, initData__keyClass, 'I08A', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I08A', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I08A', "ReplaceableTextures\\CommandButtons\\BTNInfernal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I08A', "毁灭魔球")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I09A', 9)
                call SaveStr(initData__ht, initData__keyClass, 'I09A', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I09A', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I09A', "ReplaceableTextures\\CommandButtons\\BTNMaskOfDeath.blp")
                call SaveStr(initData__ht, initData__keyName, 'I09A', "死亡面罩")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I10A', 10)
                call SaveStr(initData__ht, initData__keyClass, 'I10A', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I10A', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I10A', "ReplaceableTextures\\CommandButtons\\BTNStormHammer.blp")
                call SaveStr(initData__ht, initData__keyName, 'I10A', "风暴战锤")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I11A', 11)
                call SaveStr(initData__ht, initData__keyClass, 'I11A', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I11A', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I11A', "ReplaceableTextures\\CommandButtons\\BTNOrbOfCorruption.blp")
                call SaveStr(initData__ht, initData__keyName, 'I11A', "鬼魂容器")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I12A', 12)
                call SaveStr(initData__ht, initData__keyClass, 'I12A', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I12A', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I12A', "ReplaceableTextures\\CommandButtons\\BTNSpellSteal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I12A', "恶魔手套")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I13A', 13)
                call SaveStr(initData__ht, initData__keyClass, 'I13A', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I13A', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I13A', "ReplaceableTextures\\CommandButtons\\BTNGoblinLandMine.blp")
                call SaveStr(initData__ht, initData__keyName, 'I13A', "工匠地雷")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I14A', 14)
                call SaveStr(initData__ht, initData__keyClass, 'I14A', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I14A', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I14A', "ReplaceableTextures\\CommandButtons\\BTNGhoulFrenzy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I14A', "屠夫锯刃")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I15A', 15)
                call SaveStr(initData__ht, initData__keyClass, 'I15A', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I15A', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I15A', "ReplaceableTextures\\CommandButtons\\BTNNecromancerMaster.blp")
                call SaveStr(initData__ht, initData__keyName, 'I15A', "恶灵之书")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I16A', 16)
                call SaveStr(initData__ht, initData__keyClass, 'I16A', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I16A', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I16A', "ReplaceableTextures\\CommandButtons\\BTNOrbOfLightning.blp")
                call SaveStr(initData__ht, initData__keyName, 'I16A', "双子雷鸣")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I17A', 17)
                call SaveStr(initData__ht, initData__keyClass, 'I17A', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I17A', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I17A', "ReplaceableTextures\\CommandButtons\\BTNRevenant.blp")
                call SaveStr(initData__ht, initData__keyName, 'I17A', "深海意志")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I18A', 18)
                call SaveStr(initData__ht, initData__keyClass, 'I18A', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I18A', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I18A', "ReplaceableTextures\\CommandButtons\\BTNAdvancedUnholyStrength.blp")
                call SaveStr(initData__ht, initData__keyName, 'I18A', "灰烬利爪")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I19A', 19)
                call SaveStr(initData__ht, initData__keyClass, 'I19A', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I19A', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I19A', "ReplaceableTextures\\CommandButtons\\BTNImprovedBows.blp")
                call SaveStr(initData__ht, initData__keyName, 'I19A', "月光大弓")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I20A', 20)
                call SaveStr(initData__ht, initData__keyClass, 'I20A', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I20A', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I20A', "ReplaceableTextures\\CommandButtons\\BTNOrbOfFire.blp")
                call SaveStr(initData__ht, initData__keyName, 'I20A', "血焰核心")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I21A', 21)
                call SaveStr(initData__ht, initData__keyClass, 'I21A', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I21A', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I21A', "ReplaceableTextures\\CommandButtons\\BTNHeartOfSearinox.blp")
                call SaveStr(initData__ht, initData__keyName, 'I21A', "灵魂炸弹")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I22A', 22)
                call SaveStr(initData__ht, initData__keyClass, 'I22A', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I22A', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I22A', "ReplaceableTextures\\CommandButtons\\BTNRodOfNecromancy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I22A', "墓穴枯骨")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I23A', 23)
                call SaveStr(initData__ht, initData__keyClass, 'I23A', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I23A', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I23A', "ReplaceableTextures\\CommandButtons\\BTNUrnOfKelThuzad.blp")
                call SaveStr(initData__ht, initData__keyName, 'I23A', "旧日灵壶")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I24A', 24)
                call SaveStr(initData__ht, initData__keyClass, 'I24A', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I24A', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I24A', "ReplaceableTextures\\CommandButtons\\BTNAdvancedStrengthOfTheMoon.blp")
                call SaveStr(initData__ht, initData__keyName, 'I24A', "月之弯刀")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I25A', 25)
                call SaveStr(initData__ht, initData__keyClass, 'I25A', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I25A', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I25A', "ReplaceableTextures\\CommandButtons\\BTNHornOfFog.blp")
                call SaveStr(initData__ht, initData__keyName, 'I25A', "瘟疫号角")
            
                set id=S2I("26")
                set udg_itemList[id * 100 + 1]='I26A'
                set udg_itemListNum=udg_itemListNum + 1
                
                    set baseItemList[id]='I26A'
                    set itemAbiList[26]='AA26'
                
                call SaveInteger(initData__ht, initData__keyId, 'I26A', 26)
                call SaveStr(initData__ht, initData__keyClass, 'I26A', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I26A', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I26A', "ReplaceableTextures\\CommandButtons\\BTNHeartOfAszune.blp")
                call SaveStr(initData__ht, initData__keyName, 'I26A', "炎魔心脏")
            
                set id=S2I("27")
                set udg_itemList[id * 100 + 1]='I27A'
                set udg_itemListNum=udg_itemListNum + 1
                
                    set baseItemList[id]='I27A'
                    set itemAbiList[27]='AA27'
                
                call SaveInteger(initData__ht, initData__keyId, 'I27A', 27)
                call SaveStr(initData__ht, initData__keyClass, 'I27A', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I27A', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I27A', "ReplaceableTextures\\CommandButtons\\BTNCrystalBall.blp")
                call SaveStr(initData__ht, initData__keyName, 'I27A', "极地水晶")
            
                set id=S2I("28")
                set udg_itemList[id * 100 + 1]='I28A'
                set udg_itemListNum=udg_itemListNum + 1
                
                    set baseItemList[id]='I28A'
                    set itemAbiList[28]='AA28'
                
                call SaveInteger(initData__ht, initData__keyId, 'I28A', 28)
                call SaveStr(initData__ht, initData__keyClass, 'I28A', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I28A', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I28A', "ReplaceableTextures\\CommandButtons\\BTNPotionOfRestoration.blp")
                call SaveStr(initData__ht, initData__keyName, 'I28A', "神圣明灯")
            
                set id=S2I("29")
                set udg_itemList[id * 100 + 1]='I29A'
                set udg_itemListNum=udg_itemListNum + 1
                
                    set baseItemList[id]='I29A'
                    set itemAbiList[29]='AA29'
                
                call SaveInteger(initData__ht, initData__keyId, 'I29A', 29)
                call SaveStr(initData__ht, initData__keyClass, 'I29A', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I29A', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I29A', "ReplaceableTextures\\CommandButtons\\BTNGem.blp")
                call SaveStr(initData__ht, initData__keyName, 'I29A', "翡翠晶石")
            
                set id=S2I("30")
                set udg_itemList[id * 100 + 1]='I30A'
                set udg_itemListNum=udg_itemListNum + 1
                
                    set baseItemList[id]='I30A'
                    set itemAbiList[30]='AA30'
                
                call SaveInteger(initData__ht, initData__keyId, 'I30A', 30)
                call SaveStr(initData__ht, initData__keyClass, 'I30A', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I30A', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I30A', "ReplaceableTextures\\CommandButtons\\BTNStaffOfSilence.blp")
                call SaveStr(initData__ht, initData__keyName, 'I30A', "裁决之杖")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I01B', 1)
                call SaveStr(initData__ht, initData__keyClass, 'I01B', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I01B', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I01B', "ReplaceableTextures\\CommandButtons\\BTNPendantOfMana.blp")
                call SaveStr(initData__ht, initData__keyName, 'I01B', "魔法垂饰")
            
                set id=S2I("02")
                set udg_itemList[id * 100 + 2]='I02B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I02B', 2)
                call SaveStr(initData__ht, initData__keyClass, 'I02B', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I02B', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I02B', "ReplaceableTextures\\CommandButtons\\BTNClawsOfAttack.blp")
                call SaveStr(initData__ht, initData__keyName, 'I02B', "三相血刃")
            
                set id=S2I("03")
                set udg_itemList[id * 100 + 2]='I03B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I03B', 3)
                call SaveStr(initData__ht, initData__keyClass, 'I03B', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I03B', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I03B', "ReplaceableTextures\\CommandButtons\\BTNManaFlareOff.blp")
                call SaveStr(initData__ht, initData__keyName, 'I03B', "雷电花芯")
            
                set id=S2I("04")
                set udg_itemList[id * 100 + 2]='I04B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I04B', 4)
                call SaveStr(initData__ht, initData__keyClass, 'I04B', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I04B', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I04B', "ReplaceableTextures\\CommandButtons\\BTNCloakOfFlames.blp")
                call SaveStr(initData__ht, initData__keyName, 'I04B', "火焰风衣")
            
                set id=S2I("05")
                set udg_itemList[id * 100 + 2]='I05B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I05B', 5)
                call SaveStr(initData__ht, initData__keyClass, 'I05B', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I05B', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I05B', "ReplaceableTextures\\CommandButtons\\BTNBoneChimes.blp")
                call SaveStr(initData__ht, initData__keyName, 'I05B', "天灾骨钟")
            
                set id=S2I("06")
                set udg_itemList[id * 100 + 2]='I06B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I06B', 6)
                call SaveStr(initData__ht, initData__keyClass, 'I06B', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I06B', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I06B', "ReplaceableTextures\\CommandButtons\\BTNPotionOfOmniscience.blp")
                call SaveStr(initData__ht, initData__keyName, 'I06B', "酸性药剂")
            
                set id=S2I("07")
                set udg_itemList[id * 100 + 2]='I07B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I07B', 7)
                call SaveStr(initData__ht, initData__keyClass, 'I07B', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I07B', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I07B', "ReplaceableTextures\\CommandButtons\\BTNIceShard.blp")
                call SaveStr(initData__ht, initData__keyName, 'I07B', "冰冻碎片")
            
                set id=S2I("08")
                set udg_itemList[id * 100 + 2]='I08B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I08B', 8)
                call SaveStr(initData__ht, initData__keyClass, 'I08B', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I08B', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I08B', "ReplaceableTextures\\CommandButtons\\BTNInfernal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I08B', "毁灭魔球")
            
                set id=S2I("09")
                set udg_itemList[id * 100 + 2]='I09B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I09B', 9)
                call SaveStr(initData__ht, initData__keyClass, 'I09B', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I09B', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I09B', "ReplaceableTextures\\CommandButtons\\BTNMaskOfDeath.blp")
                call SaveStr(initData__ht, initData__keyName, 'I09B', "死亡面罩")
            
                set id=S2I("10")
                set udg_itemList[id * 100 + 2]='I10B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I10B', 10)
                call SaveStr(initData__ht, initData__keyClass, 'I10B', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I10B', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I10B', "ReplaceableTextures\\CommandButtons\\BTNStormHammer.blp")
                call SaveStr(initData__ht, initData__keyName, 'I10B', "风暴战锤")
            
                set id=S2I("11")
                set udg_itemList[id * 100 + 2]='I11B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I11B', 11)
                call SaveStr(initData__ht, initData__keyClass, 'I11B', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I11B', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I11B', "ReplaceableTextures\\CommandButtons\\BTNOrbOfCorruption.blp")
                call SaveStr(initData__ht, initData__keyName, 'I11B', "鬼魂容器")
            
                set id=S2I("12")
                set udg_itemList[id * 100 + 2]='I12B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I12B', 12)
                call SaveStr(initData__ht, initData__keyClass, 'I12B', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I12B', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I12B', "ReplaceableTextures\\CommandButtons\\BTNSpellSteal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I12B', "恶魔手套")
            
                set id=S2I("13")
                set udg_itemList[id * 100 + 2]='I13B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I13B', 13)
                call SaveStr(initData__ht, initData__keyClass, 'I13B', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I13B', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I13B', "ReplaceableTextures\\CommandButtons\\BTNGoblinLandMine.blp")
                call SaveStr(initData__ht, initData__keyName, 'I13B', "工匠地雷")
            
                set id=S2I("14")
                set udg_itemList[id * 100 + 2]='I14B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I14B', 14)
                call SaveStr(initData__ht, initData__keyClass, 'I14B', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I14B', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I14B', "ReplaceableTextures\\CommandButtons\\BTNGhoulFrenzy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I14B', "屠夫锯刃")
            
                set id=S2I("15")
                set udg_itemList[id * 100 + 2]='I15B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I15B', 15)
                call SaveStr(initData__ht, initData__keyClass, 'I15B', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I15B', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I15B', "ReplaceableTextures\\CommandButtons\\BTNNecromancerMaster.blp")
                call SaveStr(initData__ht, initData__keyName, 'I15B', "恶灵之书")
            
                set id=S2I("16")
                set udg_itemList[id * 100 + 2]='I16B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I16B', 16)
                call SaveStr(initData__ht, initData__keyClass, 'I16B', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I16B', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I16B', "ReplaceableTextures\\CommandButtons\\BTNOrbOfLightning.blp")
                call SaveStr(initData__ht, initData__keyName, 'I16B', "双子雷鸣")
            
                set id=S2I("17")
                set udg_itemList[id * 100 + 2]='I17B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I17B', 17)
                call SaveStr(initData__ht, initData__keyClass, 'I17B', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I17B', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I17B', "ReplaceableTextures\\CommandButtons\\BTNRevenant.blp")
                call SaveStr(initData__ht, initData__keyName, 'I17B', "深海意志")
            
                set id=S2I("18")
                set udg_itemList[id * 100 + 2]='I18B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I18B', 18)
                call SaveStr(initData__ht, initData__keyClass, 'I18B', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I18B', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I18B', "ReplaceableTextures\\CommandButtons\\BTNAdvancedUnholyStrength.blp")
                call SaveStr(initData__ht, initData__keyName, 'I18B', "灰烬利爪")
            
                set id=S2I("19")
                set udg_itemList[id * 100 + 2]='I19B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I19B', 19)
                call SaveStr(initData__ht, initData__keyClass, 'I19B', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I19B', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I19B', "ReplaceableTextures\\CommandButtons\\BTNImprovedBows.blp")
                call SaveStr(initData__ht, initData__keyName, 'I19B', "月光大弓")
            
                set id=S2I("20")
                set udg_itemList[id * 100 + 2]='I20B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I20B', 20)
                call SaveStr(initData__ht, initData__keyClass, 'I20B', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I20B', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I20B', "ReplaceableTextures\\CommandButtons\\BTNOrbOfFire.blp")
                call SaveStr(initData__ht, initData__keyName, 'I20B', "血焰核心")
            
                set id=S2I("21")
                set udg_itemList[id * 100 + 2]='I21B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I21B', 21)
                call SaveStr(initData__ht, initData__keyClass, 'I21B', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I21B', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I21B', "ReplaceableTextures\\CommandButtons\\BTNHeartOfSearinox.blp")
                call SaveStr(initData__ht, initData__keyName, 'I21B', "灵魂炸弹")
            
                set id=S2I("22")
                set udg_itemList[id * 100 + 2]='I22B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I22B', 22)
                call SaveStr(initData__ht, initData__keyClass, 'I22B', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I22B', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I22B', "ReplaceableTextures\\CommandButtons\\BTNRodOfNecromancy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I22B', "墓穴枯骨")
            
                set id=S2I("23")
                set udg_itemList[id * 100 + 2]='I23B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I23B', 23)
                call SaveStr(initData__ht, initData__keyClass, 'I23B', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I23B', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I23B', "ReplaceableTextures\\CommandButtons\\BTNUrnOfKelThuzad.blp")
                call SaveStr(initData__ht, initData__keyName, 'I23B', "旧日灵壶")
            
                set id=S2I("24")
                set udg_itemList[id * 100 + 2]='I24B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I24B', 24)
                call SaveStr(initData__ht, initData__keyClass, 'I24B', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I24B', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I24B', "ReplaceableTextures\\CommandButtons\\BTNAdvancedStrengthOfTheMoon.blp")
                call SaveStr(initData__ht, initData__keyName, 'I24B', "月之弯刀")
            
                set id=S2I("25")
                set udg_itemList[id * 100 + 2]='I25B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I25B', 25)
                call SaveStr(initData__ht, initData__keyClass, 'I25B', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I25B', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I25B', "ReplaceableTextures\\CommandButtons\\BTNHornOfFog.blp")
                call SaveStr(initData__ht, initData__keyName, 'I25B', "瘟疫号角")
            
                set id=S2I("26")
                set udg_itemList[id * 100 + 2]='I26B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I26B', 26)
                call SaveStr(initData__ht, initData__keyClass, 'I26B', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I26B', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I26B', "ReplaceableTextures\\CommandButtons\\BTNHeartOfAszune.blp")
                call SaveStr(initData__ht, initData__keyName, 'I26B', "炎魔心脏")
            
                set id=S2I("27")
                set udg_itemList[id * 100 + 2]='I27B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I27B', 27)
                call SaveStr(initData__ht, initData__keyClass, 'I27B', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I27B', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I27B', "ReplaceableTextures\\CommandButtons\\BTNCrystalBall.blp")
                call SaveStr(initData__ht, initData__keyName, 'I27B', "极地水晶")
            
                set id=S2I("28")
                set udg_itemList[id * 100 + 2]='I28B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I28B', 28)
                call SaveStr(initData__ht, initData__keyClass, 'I28B', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I28B', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I28B', "ReplaceableTextures\\CommandButtons\\BTNPotionOfRestoration.blp")
                call SaveStr(initData__ht, initData__keyName, 'I28B', "神圣明灯")
            
                set id=S2I("29")
                set udg_itemList[id * 100 + 2]='I29B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I29B', 29)
                call SaveStr(initData__ht, initData__keyClass, 'I29B', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I29B', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I29B', "ReplaceableTextures\\CommandButtons\\BTNGem.blp")
                call SaveStr(initData__ht, initData__keyName, 'I29B', "翡翠晶石")
            
                set id=S2I("30")
                set udg_itemList[id * 100 + 2]='I30B'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I30B', 30)
                call SaveStr(initData__ht, initData__keyClass, 'I30B', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I30B', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I30B', "ReplaceableTextures\\CommandButtons\\BTNStaffOfSilence.blp")
                call SaveStr(initData__ht, initData__keyName, 'I30B', "裁决之杖")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I01C', 1)
                call SaveStr(initData__ht, initData__keyClass, 'I01C', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I01C', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I01C', "ReplaceableTextures\\CommandButtons\\BTNPendantOfMana.blp")
                call SaveStr(initData__ht, initData__keyName, 'I01C', "魔法垂饰")
            
                set id=S2I("02")
                set udg_itemList[id * 100 + 3]='I02C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I02C', 2)
                call SaveStr(initData__ht, initData__keyClass, 'I02C', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I02C', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I02C', "ReplaceableTextures\\CommandButtons\\BTNClawsOfAttack.blp")
                call SaveStr(initData__ht, initData__keyName, 'I02C', "三相血刃")
            
                set id=S2I("03")
                set udg_itemList[id * 100 + 3]='I03C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I03C', 3)
                call SaveStr(initData__ht, initData__keyClass, 'I03C', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I03C', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I03C', "ReplaceableTextures\\CommandButtons\\BTNManaFlareOff.blp")
                call SaveStr(initData__ht, initData__keyName, 'I03C', "雷电花芯")
            
                set id=S2I("04")
                set udg_itemList[id * 100 + 3]='I04C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I04C', 4)
                call SaveStr(initData__ht, initData__keyClass, 'I04C', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I04C', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I04C', "ReplaceableTextures\\CommandButtons\\BTNCloakOfFlames.blp")
                call SaveStr(initData__ht, initData__keyName, 'I04C', "火焰风衣")
            
                set id=S2I("05")
                set udg_itemList[id * 100 + 3]='I05C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I05C', 5)
                call SaveStr(initData__ht, initData__keyClass, 'I05C', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I05C', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I05C', "ReplaceableTextures\\CommandButtons\\BTNBoneChimes.blp")
                call SaveStr(initData__ht, initData__keyName, 'I05C', "天灾骨钟")
            
                set id=S2I("06")
                set udg_itemList[id * 100 + 3]='I06C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I06C', 6)
                call SaveStr(initData__ht, initData__keyClass, 'I06C', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I06C', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I06C', "ReplaceableTextures\\CommandButtons\\BTNPotionOfOmniscience.blp")
                call SaveStr(initData__ht, initData__keyName, 'I06C', "酸性药剂")
            
                set id=S2I("07")
                set udg_itemList[id * 100 + 3]='I07C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I07C', 7)
                call SaveStr(initData__ht, initData__keyClass, 'I07C', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I07C', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I07C', "ReplaceableTextures\\CommandButtons\\BTNIceShard.blp")
                call SaveStr(initData__ht, initData__keyName, 'I07C', "冰冻碎片")
            
                set id=S2I("08")
                set udg_itemList[id * 100 + 3]='I08C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I08C', 8)
                call SaveStr(initData__ht, initData__keyClass, 'I08C', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I08C', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I08C', "ReplaceableTextures\\CommandButtons\\BTNInfernal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I08C', "毁灭魔球")
            
                set id=S2I("09")
                set udg_itemList[id * 100 + 3]='I09C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I09C', 9)
                call SaveStr(initData__ht, initData__keyClass, 'I09C', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I09C', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I09C', "ReplaceableTextures\\CommandButtons\\BTNMaskOfDeath.blp")
                call SaveStr(initData__ht, initData__keyName, 'I09C', "死亡面罩")
            
                set id=S2I("10")
                set udg_itemList[id * 100 + 3]='I10C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I10C', 10)
                call SaveStr(initData__ht, initData__keyClass, 'I10C', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I10C', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I10C', "ReplaceableTextures\\CommandButtons\\BTNStormHammer.blp")
                call SaveStr(initData__ht, initData__keyName, 'I10C', "风暴战锤")
            
                set id=S2I("11")
                set udg_itemList[id * 100 + 3]='I11C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I11C', 11)
                call SaveStr(initData__ht, initData__keyClass, 'I11C', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I11C', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I11C', "ReplaceableTextures\\CommandButtons\\BTNOrbOfCorruption.blp")
                call SaveStr(initData__ht, initData__keyName, 'I11C', "鬼魂容器")
            
                set id=S2I("12")
                set udg_itemList[id * 100 + 3]='I12C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I12C', 12)
                call SaveStr(initData__ht, initData__keyClass, 'I12C', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I12C', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I12C', "ReplaceableTextures\\CommandButtons\\BTNSpellSteal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I12C', "恶魔手套")
            
                set id=S2I("13")
                set udg_itemList[id * 100 + 3]='I13C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I13C', 13)
                call SaveStr(initData__ht, initData__keyClass, 'I13C', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I13C', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I13C', "ReplaceableTextures\\CommandButtons\\BTNGoblinLandMine.blp")
                call SaveStr(initData__ht, initData__keyName, 'I13C', "工匠地雷")
            
                set id=S2I("14")
                set udg_itemList[id * 100 + 3]='I14C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I14C', 14)
                call SaveStr(initData__ht, initData__keyClass, 'I14C', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I14C', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I14C', "ReplaceableTextures\\CommandButtons\\BTNGhoulFrenzy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I14C', "屠夫锯刃")
            
                set id=S2I("15")
                set udg_itemList[id * 100 + 3]='I15C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I15C', 15)
                call SaveStr(initData__ht, initData__keyClass, 'I15C', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I15C', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I15C', "ReplaceableTextures\\CommandButtons\\BTNNecromancerMaster.blp")
                call SaveStr(initData__ht, initData__keyName, 'I15C', "恶灵之书")
            
                set id=S2I("16")
                set udg_itemList[id * 100 + 3]='I16C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I16C', 16)
                call SaveStr(initData__ht, initData__keyClass, 'I16C', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I16C', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I16C', "ReplaceableTextures\\CommandButtons\\BTNOrbOfLightning.blp")
                call SaveStr(initData__ht, initData__keyName, 'I16C', "双子雷鸣")
            
                set id=S2I("17")
                set udg_itemList[id * 100 + 3]='I17C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I17C', 17)
                call SaveStr(initData__ht, initData__keyClass, 'I17C', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I17C', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I17C', "ReplaceableTextures\\CommandButtons\\BTNRevenant.blp")
                call SaveStr(initData__ht, initData__keyName, 'I17C', "深海意志")
            
                set id=S2I("18")
                set udg_itemList[id * 100 + 3]='I18C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I18C', 18)
                call SaveStr(initData__ht, initData__keyClass, 'I18C', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I18C', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I18C', "ReplaceableTextures\\CommandButtons\\BTNAdvancedUnholyStrength.blp")
                call SaveStr(initData__ht, initData__keyName, 'I18C', "灰烬利爪")
            
                set id=S2I("19")
                set udg_itemList[id * 100 + 3]='I19C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I19C', 19)
                call SaveStr(initData__ht, initData__keyClass, 'I19C', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I19C', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I19C', "ReplaceableTextures\\CommandButtons\\BTNImprovedBows.blp")
                call SaveStr(initData__ht, initData__keyName, 'I19C', "月光大弓")
            
                set id=S2I("20")
                set udg_itemList[id * 100 + 3]='I20C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I20C', 20)
                call SaveStr(initData__ht, initData__keyClass, 'I20C', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I20C', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I20C', "ReplaceableTextures\\CommandButtons\\BTNOrbOfFire.blp")
                call SaveStr(initData__ht, initData__keyName, 'I20C', "血焰核心")
            
                set id=S2I("21")
                set udg_itemList[id * 100 + 3]='I21C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I21C', 21)
                call SaveStr(initData__ht, initData__keyClass, 'I21C', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I21C', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I21C', "ReplaceableTextures\\CommandButtons\\BTNHeartOfSearinox.blp")
                call SaveStr(initData__ht, initData__keyName, 'I21C', "灵魂炸弹")
            
                set id=S2I("22")
                set udg_itemList[id * 100 + 3]='I22C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I22C', 22)
                call SaveStr(initData__ht, initData__keyClass, 'I22C', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I22C', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I22C', "ReplaceableTextures\\CommandButtons\\BTNRodOfNecromancy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I22C', "墓穴枯骨")
            
                set id=S2I("23")
                set udg_itemList[id * 100 + 3]='I23C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I23C', 23)
                call SaveStr(initData__ht, initData__keyClass, 'I23C', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I23C', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I23C', "ReplaceableTextures\\CommandButtons\\BTNUrnOfKelThuzad.blp")
                call SaveStr(initData__ht, initData__keyName, 'I23C', "旧日灵壶")
            
                set id=S2I("24")
                set udg_itemList[id * 100 + 3]='I24C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I24C', 24)
                call SaveStr(initData__ht, initData__keyClass, 'I24C', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I24C', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I24C', "ReplaceableTextures\\CommandButtons\\BTNAdvancedStrengthOfTheMoon.blp")
                call SaveStr(initData__ht, initData__keyName, 'I24C', "月之弯刀")
            
                set id=S2I("25")
                set udg_itemList[id * 100 + 3]='I25C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I25C', 25)
                call SaveStr(initData__ht, initData__keyClass, 'I25C', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I25C', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I25C', "ReplaceableTextures\\CommandButtons\\BTNHornOfFog.blp")
                call SaveStr(initData__ht, initData__keyName, 'I25C', "瘟疫号角")
            
                set id=S2I("26")
                set udg_itemList[id * 100 + 3]='I26C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I26C', 26)
                call SaveStr(initData__ht, initData__keyClass, 'I26C', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I26C', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I26C', "ReplaceableTextures\\CommandButtons\\BTNHeartOfAszune.blp")
                call SaveStr(initData__ht, initData__keyName, 'I26C', "炎魔心脏")
            
                set id=S2I("27")
                set udg_itemList[id * 100 + 3]='I27C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I27C', 27)
                call SaveStr(initData__ht, initData__keyClass, 'I27C', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I27C', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I27C', "ReplaceableTextures\\CommandButtons\\BTNCrystalBall.blp")
                call SaveStr(initData__ht, initData__keyName, 'I27C', "极地水晶")
            
                set id=S2I("28")
                set udg_itemList[id * 100 + 3]='I28C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I28C', 28)
                call SaveStr(initData__ht, initData__keyClass, 'I28C', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I28C', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I28C', "ReplaceableTextures\\CommandButtons\\BTNPotionOfRestoration.blp")
                call SaveStr(initData__ht, initData__keyName, 'I28C', "神圣明灯")
            
                set id=S2I("29")
                set udg_itemList[id * 100 + 3]='I29C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I29C', 29)
                call SaveStr(initData__ht, initData__keyClass, 'I29C', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I29C', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I29C', "ReplaceableTextures\\CommandButtons\\BTNGem.blp")
                call SaveStr(initData__ht, initData__keyName, 'I29C', "翡翠晶石")
            
                set id=S2I("30")
                set udg_itemList[id * 100 + 3]='I30C'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I30C', 30)
                call SaveStr(initData__ht, initData__keyClass, 'I30C', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I30C', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I30C', "ReplaceableTextures\\CommandButtons\\BTNStaffOfSilence.blp")
                call SaveStr(initData__ht, initData__keyName, 'I30C', "裁决之杖")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I01D', 1)
                call SaveStr(initData__ht, initData__keyClass, 'I01D', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I01D', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I01D', "ReplaceableTextures\\CommandButtons\\BTNPendantOfMana.blp")
                call SaveStr(initData__ht, initData__keyName, 'I01D', "魔法垂饰")
            
                set id=S2I("02")
                set udg_itemList[id * 100 + 4]='I02D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I02D', 2)
                call SaveStr(initData__ht, initData__keyClass, 'I02D', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I02D', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I02D', "ReplaceableTextures\\CommandButtons\\BTNClawsOfAttack.blp")
                call SaveStr(initData__ht, initData__keyName, 'I02D', "三相血刃")
            
                set id=S2I("03")
                set udg_itemList[id * 100 + 4]='I03D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I03D', 3)
                call SaveStr(initData__ht, initData__keyClass, 'I03D', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I03D', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I03D', "ReplaceableTextures\\CommandButtons\\BTNManaFlareOff.blp")
                call SaveStr(initData__ht, initData__keyName, 'I03D', "雷电花芯")
            
                set id=S2I("04")
                set udg_itemList[id * 100 + 4]='I04D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I04D', 4)
                call SaveStr(initData__ht, initData__keyClass, 'I04D', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I04D', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I04D', "ReplaceableTextures\\CommandButtons\\BTNCloakOfFlames.blp")
                call SaveStr(initData__ht, initData__keyName, 'I04D', "火焰风衣")
            
                set id=S2I("05")
                set udg_itemList[id * 100 + 4]='I05D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I05D', 5)
                call SaveStr(initData__ht, initData__keyClass, 'I05D', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I05D', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I05D', "ReplaceableTextures\\CommandButtons\\BTNBoneChimes.blp")
                call SaveStr(initData__ht, initData__keyName, 'I05D', "天灾骨钟")
            
                set id=S2I("06")
                set udg_itemList[id * 100 + 4]='I06D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I06D', 6)
                call SaveStr(initData__ht, initData__keyClass, 'I06D', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I06D', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I06D', "ReplaceableTextures\\CommandButtons\\BTNPotionOfOmniscience.blp")
                call SaveStr(initData__ht, initData__keyName, 'I06D', "酸性药剂")
            
                set id=S2I("07")
                set udg_itemList[id * 100 + 4]='I07D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I07D', 7)
                call SaveStr(initData__ht, initData__keyClass, 'I07D', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I07D', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I07D', "ReplaceableTextures\\CommandButtons\\BTNIceShard.blp")
                call SaveStr(initData__ht, initData__keyName, 'I07D', "冰冻碎片")
            
                set id=S2I("08")
                set udg_itemList[id * 100 + 4]='I08D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I08D', 8)
                call SaveStr(initData__ht, initData__keyClass, 'I08D', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I08D', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I08D', "ReplaceableTextures\\CommandButtons\\BTNInfernal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I08D', "毁灭魔球")
            
                set id=S2I("09")
                set udg_itemList[id * 100 + 4]='I09D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I09D', 9)
                call SaveStr(initData__ht, initData__keyClass, 'I09D', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I09D', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I09D', "ReplaceableTextures\\CommandButtons\\BTNMaskOfDeath.blp")
                call SaveStr(initData__ht, initData__keyName, 'I09D', "死亡面罩")
            
                set id=S2I("10")
                set udg_itemList[id * 100 + 4]='I10D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I10D', 10)
                call SaveStr(initData__ht, initData__keyClass, 'I10D', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I10D', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I10D', "ReplaceableTextures\\CommandButtons\\BTNStormHammer.blp")
                call SaveStr(initData__ht, initData__keyName, 'I10D', "风暴战锤")
            
                set id=S2I("11")
                set udg_itemList[id * 100 + 4]='I11D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I11D', 11)
                call SaveStr(initData__ht, initData__keyClass, 'I11D', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I11D', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I11D', "ReplaceableTextures\\CommandButtons\\BTNOrbOfCorruption.blp")
                call SaveStr(initData__ht, initData__keyName, 'I11D', "鬼魂容器")
            
                set id=S2I("12")
                set udg_itemList[id * 100 + 4]='I12D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I12D', 12)
                call SaveStr(initData__ht, initData__keyClass, 'I12D', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I12D', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I12D', "ReplaceableTextures\\CommandButtons\\BTNSpellSteal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I12D', "恶魔手套")
            
                set id=S2I("13")
                set udg_itemList[id * 100 + 4]='I13D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I13D', 13)
                call SaveStr(initData__ht, initData__keyClass, 'I13D', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I13D', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I13D', "ReplaceableTextures\\CommandButtons\\BTNGoblinLandMine.blp")
                call SaveStr(initData__ht, initData__keyName, 'I13D', "工匠地雷")
            
                set id=S2I("14")
                set udg_itemList[id * 100 + 4]='I14D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I14D', 14)
                call SaveStr(initData__ht, initData__keyClass, 'I14D', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I14D', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I14D', "ReplaceableTextures\\CommandButtons\\BTNGhoulFrenzy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I14D', "屠夫锯刃")
            
                set id=S2I("15")
                set udg_itemList[id * 100 + 4]='I15D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I15D', 15)
                call SaveStr(initData__ht, initData__keyClass, 'I15D', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I15D', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I15D', "ReplaceableTextures\\CommandButtons\\BTNNecromancerMaster.blp")
                call SaveStr(initData__ht, initData__keyName, 'I15D', "恶灵之书")
            
                set id=S2I("16")
                set udg_itemList[id * 100 + 4]='I16D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I16D', 16)
                call SaveStr(initData__ht, initData__keyClass, 'I16D', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I16D', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I16D', "ReplaceableTextures\\CommandButtons\\BTNOrbOfLightning.blp")
                call SaveStr(initData__ht, initData__keyName, 'I16D', "双子雷鸣")
            
                set id=S2I("17")
                set udg_itemList[id * 100 + 4]='I17D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I17D', 17)
                call SaveStr(initData__ht, initData__keyClass, 'I17D', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I17D', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I17D', "ReplaceableTextures\\CommandButtons\\BTNRevenant.blp")
                call SaveStr(initData__ht, initData__keyName, 'I17D', "深海意志")
            
                set id=S2I("18")
                set udg_itemList[id * 100 + 4]='I18D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I18D', 18)
                call SaveStr(initData__ht, initData__keyClass, 'I18D', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I18D', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I18D', "ReplaceableTextures\\CommandButtons\\BTNAdvancedUnholyStrength.blp")
                call SaveStr(initData__ht, initData__keyName, 'I18D', "灰烬利爪")
            
                set id=S2I("19")
                set udg_itemList[id * 100 + 4]='I19D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I19D', 19)
                call SaveStr(initData__ht, initData__keyClass, 'I19D', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I19D', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I19D', "ReplaceableTextures\\CommandButtons\\BTNImprovedBows.blp")
                call SaveStr(initData__ht, initData__keyName, 'I19D', "月光大弓")
            
                set id=S2I("20")
                set udg_itemList[id * 100 + 4]='I20D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I20D', 20)
                call SaveStr(initData__ht, initData__keyClass, 'I20D', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I20D', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I20D', "ReplaceableTextures\\CommandButtons\\BTNOrbOfFire.blp")
                call SaveStr(initData__ht, initData__keyName, 'I20D', "血焰核心")
            
                set id=S2I("21")
                set udg_itemList[id * 100 + 4]='I21D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I21D', 21)
                call SaveStr(initData__ht, initData__keyClass, 'I21D', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I21D', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I21D', "ReplaceableTextures\\CommandButtons\\BTNHeartOfSearinox.blp")
                call SaveStr(initData__ht, initData__keyName, 'I21D', "灵魂炸弹")
            
                set id=S2I("22")
                set udg_itemList[id * 100 + 4]='I22D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I22D', 22)
                call SaveStr(initData__ht, initData__keyClass, 'I22D', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I22D', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I22D', "ReplaceableTextures\\CommandButtons\\BTNRodOfNecromancy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I22D', "墓穴枯骨")
            
                set id=S2I("23")
                set udg_itemList[id * 100 + 4]='I23D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I23D', 23)
                call SaveStr(initData__ht, initData__keyClass, 'I23D', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I23D', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I23D', "ReplaceableTextures\\CommandButtons\\BTNUrnOfKelThuzad.blp")
                call SaveStr(initData__ht, initData__keyName, 'I23D', "旧日灵壶")
            
                set id=S2I("24")
                set udg_itemList[id * 100 + 4]='I24D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I24D', 24)
                call SaveStr(initData__ht, initData__keyClass, 'I24D', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I24D', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I24D', "ReplaceableTextures\\CommandButtons\\BTNAdvancedStrengthOfTheMoon.blp")
                call SaveStr(initData__ht, initData__keyName, 'I24D', "月之弯刀")
            
                set id=S2I("25")
                set udg_itemList[id * 100 + 4]='I25D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I25D', 25)
                call SaveStr(initData__ht, initData__keyClass, 'I25D', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I25D', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I25D', "ReplaceableTextures\\CommandButtons\\BTNHornOfFog.blp")
                call SaveStr(initData__ht, initData__keyName, 'I25D', "瘟疫号角")
            
                set id=S2I("26")
                set udg_itemList[id * 100 + 4]='I26D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I26D', 26)
                call SaveStr(initData__ht, initData__keyClass, 'I26D', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I26D', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I26D', "ReplaceableTextures\\CommandButtons\\BTNHeartOfAszune.blp")
                call SaveStr(initData__ht, initData__keyName, 'I26D', "炎魔心脏")
            
                set id=S2I("27")
                set udg_itemList[id * 100 + 4]='I27D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I27D', 27)
                call SaveStr(initData__ht, initData__keyClass, 'I27D', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I27D', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I27D', "ReplaceableTextures\\CommandButtons\\BTNCrystalBall.blp")
                call SaveStr(initData__ht, initData__keyName, 'I27D', "极地水晶")
            
                set id=S2I("28")
                set udg_itemList[id * 100 + 4]='I28D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I28D', 28)
                call SaveStr(initData__ht, initData__keyClass, 'I28D', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I28D', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I28D', "ReplaceableTextures\\CommandButtons\\BTNPotionOfRestoration.blp")
                call SaveStr(initData__ht, initData__keyName, 'I28D', "神圣明灯")
            
                set id=S2I("29")
                set udg_itemList[id * 100 + 4]='I29D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I29D', 29)
                call SaveStr(initData__ht, initData__keyClass, 'I29D', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I29D', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I29D', "ReplaceableTextures\\CommandButtons\\BTNGem.blp")
                call SaveStr(initData__ht, initData__keyName, 'I29D', "翡翠晶石")
            
                set id=S2I("30")
                set udg_itemList[id * 100 + 4]='I30D'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I30D', 30)
                call SaveStr(initData__ht, initData__keyClass, 'I30D', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I30D', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I30D', "ReplaceableTextures\\CommandButtons\\BTNStaffOfSilence.blp")
                call SaveStr(initData__ht, initData__keyName, 'I30D', "裁决之杖")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I01E', 1)
                call SaveStr(initData__ht, initData__keyClass, 'I01E', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I01E', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I01E', "ReplaceableTextures\\CommandButtons\\BTNPendantOfMana.blp")
                call SaveStr(initData__ht, initData__keyName, 'I01E', "魔法垂饰")
            
                set id=S2I("02")
                set udg_itemList[id * 100 + 5]='I02E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I02E', 2)
                call SaveStr(initData__ht, initData__keyClass, 'I02E', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I02E', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I02E', "ReplaceableTextures\\CommandButtons\\BTNClawsOfAttack.blp")
                call SaveStr(initData__ht, initData__keyName, 'I02E', "三相血刃")
            
                set id=S2I("03")
                set udg_itemList[id * 100 + 5]='I03E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I03E', 3)
                call SaveStr(initData__ht, initData__keyClass, 'I03E', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I03E', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I03E', "ReplaceableTextures\\CommandButtons\\BTNManaFlareOff.blp")
                call SaveStr(initData__ht, initData__keyName, 'I03E', "雷电花芯")
            
                set id=S2I("04")
                set udg_itemList[id * 100 + 5]='I04E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I04E', 4)
                call SaveStr(initData__ht, initData__keyClass, 'I04E', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I04E', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I04E', "ReplaceableTextures\\CommandButtons\\BTNCloakOfFlames.blp")
                call SaveStr(initData__ht, initData__keyName, 'I04E', "火焰风衣")
            
                set id=S2I("05")
                set udg_itemList[id * 100 + 5]='I05E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I05E', 5)
                call SaveStr(initData__ht, initData__keyClass, 'I05E', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I05E', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I05E', "ReplaceableTextures\\CommandButtons\\BTNBoneChimes.blp")
                call SaveStr(initData__ht, initData__keyName, 'I05E', "天灾骨钟")
            
                set id=S2I("06")
                set udg_itemList[id * 100 + 5]='I06E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I06E', 6)
                call SaveStr(initData__ht, initData__keyClass, 'I06E', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I06E', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I06E', "ReplaceableTextures\\CommandButtons\\BTNPotionOfOmniscience.blp")
                call SaveStr(initData__ht, initData__keyName, 'I06E', "酸性药剂")
            
                set id=S2I("07")
                set udg_itemList[id * 100 + 5]='I07E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I07E', 7)
                call SaveStr(initData__ht, initData__keyClass, 'I07E', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I07E', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I07E', "ReplaceableTextures\\CommandButtons\\BTNIceShard.blp")
                call SaveStr(initData__ht, initData__keyName, 'I07E', "冰冻碎片")
            
                set id=S2I("08")
                set udg_itemList[id * 100 + 5]='I08E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I08E', 8)
                call SaveStr(initData__ht, initData__keyClass, 'I08E', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I08E', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I08E', "ReplaceableTextures\\CommandButtons\\BTNInfernal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I08E', "毁灭魔球")
            
                set id=S2I("09")
                set udg_itemList[id * 100 + 5]='I09E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I09E', 9)
                call SaveStr(initData__ht, initData__keyClass, 'I09E', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I09E', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I09E', "ReplaceableTextures\\CommandButtons\\BTNMaskOfDeath.blp")
                call SaveStr(initData__ht, initData__keyName, 'I09E', "死亡面罩")
            
                set id=S2I("10")
                set udg_itemList[id * 100 + 5]='I10E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I10E', 10)
                call SaveStr(initData__ht, initData__keyClass, 'I10E', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I10E', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I10E', "ReplaceableTextures\\CommandButtons\\BTNStormHammer.blp")
                call SaveStr(initData__ht, initData__keyName, 'I10E', "风暴战锤")
            
                set id=S2I("11")
                set udg_itemList[id * 100 + 5]='I11E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I11E', 11)
                call SaveStr(initData__ht, initData__keyClass, 'I11E', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I11E', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I11E', "ReplaceableTextures\\CommandButtons\\BTNOrbOfCorruption.blp")
                call SaveStr(initData__ht, initData__keyName, 'I11E', "鬼魂容器")
            
                set id=S2I("12")
                set udg_itemList[id * 100 + 5]='I12E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I12E', 12)
                call SaveStr(initData__ht, initData__keyClass, 'I12E', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I12E', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I12E', "ReplaceableTextures\\CommandButtons\\BTNSpellSteal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I12E', "恶魔手套")
            
                set id=S2I("13")
                set udg_itemList[id * 100 + 5]='I13E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I13E', 13)
                call SaveStr(initData__ht, initData__keyClass, 'I13E', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I13E', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I13E', "ReplaceableTextures\\CommandButtons\\BTNGoblinLandMine.blp")
                call SaveStr(initData__ht, initData__keyName, 'I13E', "工匠地雷")
            
                set id=S2I("14")
                set udg_itemList[id * 100 + 5]='I14E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I14E', 14)
                call SaveStr(initData__ht, initData__keyClass, 'I14E', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I14E', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I14E', "ReplaceableTextures\\CommandButtons\\BTNGhoulFrenzy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I14E', "屠夫锯刃")
            
                set id=S2I("15")
                set udg_itemList[id * 100 + 5]='I15E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I15E', 15)
                call SaveStr(initData__ht, initData__keyClass, 'I15E', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I15E', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I15E', "ReplaceableTextures\\CommandButtons\\BTNNecromancerMaster.blp")
                call SaveStr(initData__ht, initData__keyName, 'I15E', "恶灵之书")
            
                set id=S2I("16")
                set udg_itemList[id * 100 + 5]='I16E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I16E', 16)
                call SaveStr(initData__ht, initData__keyClass, 'I16E', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I16E', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I16E', "ReplaceableTextures\\CommandButtons\\BTNOrbOfLightning.blp")
                call SaveStr(initData__ht, initData__keyName, 'I16E', "双子雷鸣")
            
                set id=S2I("17")
                set udg_itemList[id * 100 + 5]='I17E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I17E', 17)
                call SaveStr(initData__ht, initData__keyClass, 'I17E', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I17E', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I17E', "ReplaceableTextures\\CommandButtons\\BTNRevenant.blp")
                call SaveStr(initData__ht, initData__keyName, 'I17E', "深海意志")
            
                set id=S2I("18")
                set udg_itemList[id * 100 + 5]='I18E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I18E', 18)
                call SaveStr(initData__ht, initData__keyClass, 'I18E', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I18E', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I18E', "ReplaceableTextures\\CommandButtons\\BTNAdvancedUnholyStrength.blp")
                call SaveStr(initData__ht, initData__keyName, 'I18E', "灰烬利爪")
            
                set id=S2I("19")
                set udg_itemList[id * 100 + 5]='I19E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I19E', 19)
                call SaveStr(initData__ht, initData__keyClass, 'I19E', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I19E', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I19E', "ReplaceableTextures\\CommandButtons\\BTNImprovedBows.blp")
                call SaveStr(initData__ht, initData__keyName, 'I19E', "月光大弓")
            
                set id=S2I("20")
                set udg_itemList[id * 100 + 5]='I20E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I20E', 20)
                call SaveStr(initData__ht, initData__keyClass, 'I20E', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I20E', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I20E', "ReplaceableTextures\\CommandButtons\\BTNOrbOfFire.blp")
                call SaveStr(initData__ht, initData__keyName, 'I20E', "血焰核心")
            
                set id=S2I("21")
                set udg_itemList[id * 100 + 5]='I21E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I21E', 21)
                call SaveStr(initData__ht, initData__keyClass, 'I21E', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I21E', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I21E', "ReplaceableTextures\\CommandButtons\\BTNHeartOfSearinox.blp")
                call SaveStr(initData__ht, initData__keyName, 'I21E', "灵魂炸弹")
            
                set id=S2I("22")
                set udg_itemList[id * 100 + 5]='I22E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I22E', 22)
                call SaveStr(initData__ht, initData__keyClass, 'I22E', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I22E', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I22E', "ReplaceableTextures\\CommandButtons\\BTNRodOfNecromancy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I22E', "墓穴枯骨")
            
                set id=S2I("23")
                set udg_itemList[id * 100 + 5]='I23E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I23E', 23)
                call SaveStr(initData__ht, initData__keyClass, 'I23E', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I23E', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I23E', "ReplaceableTextures\\CommandButtons\\BTNUrnOfKelThuzad.blp")
                call SaveStr(initData__ht, initData__keyName, 'I23E', "旧日灵壶")
            
                set id=S2I("24")
                set udg_itemList[id * 100 + 5]='I24E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I24E', 24)
                call SaveStr(initData__ht, initData__keyClass, 'I24E', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I24E', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I24E', "ReplaceableTextures\\CommandButtons\\BTNAdvancedStrengthOfTheMoon.blp")
                call SaveStr(initData__ht, initData__keyName, 'I24E', "月之弯刀")
            
                set id=S2I("25")
                set udg_itemList[id * 100 + 5]='I25E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I25E', 25)
                call SaveStr(initData__ht, initData__keyClass, 'I25E', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I25E', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I25E', "ReplaceableTextures\\CommandButtons\\BTNHornOfFog.blp")
                call SaveStr(initData__ht, initData__keyName, 'I25E', "瘟疫号角")
            
                set id=S2I("26")
                set udg_itemList[id * 100 + 5]='I26E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I26E', 26)
                call SaveStr(initData__ht, initData__keyClass, 'I26E', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I26E', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I26E', "ReplaceableTextures\\CommandButtons\\BTNHeartOfAszune.blp")
                call SaveStr(initData__ht, initData__keyName, 'I26E', "炎魔心脏")
            
                set id=S2I("27")
                set udg_itemList[id * 100 + 5]='I27E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I27E', 27)
                call SaveStr(initData__ht, initData__keyClass, 'I27E', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I27E', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I27E', "ReplaceableTextures\\CommandButtons\\BTNCrystalBall.blp")
                call SaveStr(initData__ht, initData__keyName, 'I27E', "极地水晶")
            
                set id=S2I("28")
                set udg_itemList[id * 100 + 5]='I28E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I28E', 28)
                call SaveStr(initData__ht, initData__keyClass, 'I28E', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I28E', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I28E', "ReplaceableTextures\\CommandButtons\\BTNPotionOfRestoration.blp")
                call SaveStr(initData__ht, initData__keyName, 'I28E', "神圣明灯")
            
                set id=S2I("29")
                set udg_itemList[id * 100 + 5]='I29E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I29E', 29)
                call SaveStr(initData__ht, initData__keyClass, 'I29E', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I29E', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I29E', "ReplaceableTextures\\CommandButtons\\BTNGem.blp")
                call SaveStr(initData__ht, initData__keyName, 'I29E', "翡翠晶石")
            
                set id=S2I("30")
                set udg_itemList[id * 100 + 5]='I30E'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I30E', 30)
                call SaveStr(initData__ht, initData__keyClass, 'I30E', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I30E', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I30E', "ReplaceableTextures\\CommandButtons\\BTNStaffOfSilence.blp")
                call SaveStr(initData__ht, initData__keyName, 'I30E', "裁决之杖")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I01F', 1)
                call SaveStr(initData__ht, initData__keyClass, 'I01F', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I01F', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I01F', "ReplaceableTextures\\CommandButtons\\BTNPendantOfMana.blp")
                call SaveStr(initData__ht, initData__keyName, 'I01F', "魔法垂饰")
            
                set id=S2I("02")
                set udg_itemList[id * 100 + 6]='I02F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I02F', 2)
                call SaveStr(initData__ht, initData__keyClass, 'I02F', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I02F', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I02F', "ReplaceableTextures\\CommandButtons\\BTNClawsOfAttack.blp")
                call SaveStr(initData__ht, initData__keyName, 'I02F', "三相血刃")
            
                set id=S2I("03")
                set udg_itemList[id * 100 + 6]='I03F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I03F', 3)
                call SaveStr(initData__ht, initData__keyClass, 'I03F', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I03F', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I03F', "ReplaceableTextures\\CommandButtons\\BTNManaFlareOff.blp")
                call SaveStr(initData__ht, initData__keyName, 'I03F', "雷电花芯")
            
                set id=S2I("04")
                set udg_itemList[id * 100 + 6]='I04F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I04F', 4)
                call SaveStr(initData__ht, initData__keyClass, 'I04F', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I04F', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I04F', "ReplaceableTextures\\CommandButtons\\BTNCloakOfFlames.blp")
                call SaveStr(initData__ht, initData__keyName, 'I04F', "火焰风衣")
            
                set id=S2I("05")
                set udg_itemList[id * 100 + 6]='I05F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I05F', 5)
                call SaveStr(initData__ht, initData__keyClass, 'I05F', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I05F', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I05F', "ReplaceableTextures\\CommandButtons\\BTNBoneChimes.blp")
                call SaveStr(initData__ht, initData__keyName, 'I05F', "天灾骨钟")
            
                set id=S2I("06")
                set udg_itemList[id * 100 + 6]='I06F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I06F', 6)
                call SaveStr(initData__ht, initData__keyClass, 'I06F', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I06F', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I06F', "ReplaceableTextures\\CommandButtons\\BTNPotionOfOmniscience.blp")
                call SaveStr(initData__ht, initData__keyName, 'I06F', "酸性药剂")
            
                set id=S2I("07")
                set udg_itemList[id * 100 + 6]='I07F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I07F', 7)
                call SaveStr(initData__ht, initData__keyClass, 'I07F', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I07F', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I07F', "ReplaceableTextures\\CommandButtons\\BTNIceShard.blp")
                call SaveStr(initData__ht, initData__keyName, 'I07F', "冰冻碎片")
            
                set id=S2I("08")
                set udg_itemList[id * 100 + 6]='I08F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I08F', 8)
                call SaveStr(initData__ht, initData__keyClass, 'I08F', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I08F', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I08F', "ReplaceableTextures\\CommandButtons\\BTNInfernal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I08F', "毁灭魔球")
            
                set id=S2I("09")
                set udg_itemList[id * 100 + 6]='I09F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I09F', 9)
                call SaveStr(initData__ht, initData__keyClass, 'I09F', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I09F', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I09F', "ReplaceableTextures\\CommandButtons\\BTNMaskOfDeath.blp")
                call SaveStr(initData__ht, initData__keyName, 'I09F', "死亡面罩")
            
                set id=S2I("10")
                set udg_itemList[id * 100 + 6]='I10F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I10F', 10)
                call SaveStr(initData__ht, initData__keyClass, 'I10F', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I10F', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I10F', "ReplaceableTextures\\CommandButtons\\BTNStormHammer.blp")
                call SaveStr(initData__ht, initData__keyName, 'I10F', "风暴战锤")
            
                set id=S2I("11")
                set udg_itemList[id * 100 + 6]='I11F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I11F', 11)
                call SaveStr(initData__ht, initData__keyClass, 'I11F', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I11F', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I11F', "ReplaceableTextures\\CommandButtons\\BTNOrbOfCorruption.blp")
                call SaveStr(initData__ht, initData__keyName, 'I11F', "鬼魂容器")
            
                set id=S2I("12")
                set udg_itemList[id * 100 + 6]='I12F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I12F', 12)
                call SaveStr(initData__ht, initData__keyClass, 'I12F', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I12F', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I12F', "ReplaceableTextures\\CommandButtons\\BTNSpellSteal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I12F', "恶魔手套")
            
                set id=S2I("13")
                set udg_itemList[id * 100 + 6]='I13F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I13F', 13)
                call SaveStr(initData__ht, initData__keyClass, 'I13F', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I13F', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I13F', "ReplaceableTextures\\CommandButtons\\BTNGoblinLandMine.blp")
                call SaveStr(initData__ht, initData__keyName, 'I13F', "工匠地雷")
            
                set id=S2I("14")
                set udg_itemList[id * 100 + 6]='I14F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I14F', 14)
                call SaveStr(initData__ht, initData__keyClass, 'I14F', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I14F', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I14F', "ReplaceableTextures\\CommandButtons\\BTNGhoulFrenzy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I14F', "屠夫锯刃")
            
                set id=S2I("15")
                set udg_itemList[id * 100 + 6]='I15F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I15F', 15)
                call SaveStr(initData__ht, initData__keyClass, 'I15F', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I15F', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I15F', "ReplaceableTextures\\CommandButtons\\BTNNecromancerMaster.blp")
                call SaveStr(initData__ht, initData__keyName, 'I15F', "恶灵之书")
            
                set id=S2I("16")
                set udg_itemList[id * 100 + 6]='I16F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I16F', 16)
                call SaveStr(initData__ht, initData__keyClass, 'I16F', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I16F', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I16F', "ReplaceableTextures\\CommandButtons\\BTNOrbOfLightning.blp")
                call SaveStr(initData__ht, initData__keyName, 'I16F', "双子雷鸣")
            
                set id=S2I("17")
                set udg_itemList[id * 100 + 6]='I17F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I17F', 17)
                call SaveStr(initData__ht, initData__keyClass, 'I17F', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I17F', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I17F', "ReplaceableTextures\\CommandButtons\\BTNRevenant.blp")
                call SaveStr(initData__ht, initData__keyName, 'I17F', "深海意志")
            
                set id=S2I("18")
                set udg_itemList[id * 100 + 6]='I18F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I18F', 18)
                call SaveStr(initData__ht, initData__keyClass, 'I18F', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I18F', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I18F', "ReplaceableTextures\\CommandButtons\\BTNAdvancedUnholyStrength.blp")
                call SaveStr(initData__ht, initData__keyName, 'I18F', "灰烬利爪")
            
                set id=S2I("19")
                set udg_itemList[id * 100 + 6]='I19F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I19F', 19)
                call SaveStr(initData__ht, initData__keyClass, 'I19F', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I19F', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I19F', "ReplaceableTextures\\CommandButtons\\BTNImprovedBows.blp")
                call SaveStr(initData__ht, initData__keyName, 'I19F', "月光大弓")
            
                set id=S2I("20")
                set udg_itemList[id * 100 + 6]='I20F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I20F', 20)
                call SaveStr(initData__ht, initData__keyClass, 'I20F', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I20F', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I20F', "ReplaceableTextures\\CommandButtons\\BTNOrbOfFire.blp")
                call SaveStr(initData__ht, initData__keyName, 'I20F', "血焰核心")
            
                set id=S2I("21")
                set udg_itemList[id * 100 + 6]='I21F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I21F', 21)
                call SaveStr(initData__ht, initData__keyClass, 'I21F', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I21F', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I21F', "ReplaceableTextures\\CommandButtons\\BTNHeartOfSearinox.blp")
                call SaveStr(initData__ht, initData__keyName, 'I21F', "灵魂炸弹")
            
                set id=S2I("22")
                set udg_itemList[id * 100 + 6]='I22F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I22F', 22)
                call SaveStr(initData__ht, initData__keyClass, 'I22F', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I22F', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I22F', "ReplaceableTextures\\CommandButtons\\BTNRodOfNecromancy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I22F', "墓穴枯骨")
            
                set id=S2I("23")
                set udg_itemList[id * 100 + 6]='I23F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I23F', 23)
                call SaveStr(initData__ht, initData__keyClass, 'I23F', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I23F', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I23F', "ReplaceableTextures\\CommandButtons\\BTNUrnOfKelThuzad.blp")
                call SaveStr(initData__ht, initData__keyName, 'I23F', "旧日灵壶")
            
                set id=S2I("24")
                set udg_itemList[id * 100 + 6]='I24F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I24F', 24)
                call SaveStr(initData__ht, initData__keyClass, 'I24F', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I24F', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I24F', "ReplaceableTextures\\CommandButtons\\BTNAdvancedStrengthOfTheMoon.blp")
                call SaveStr(initData__ht, initData__keyName, 'I24F', "月之弯刀")
            
                set id=S2I("25")
                set udg_itemList[id * 100 + 6]='I25F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I25F', 25)
                call SaveStr(initData__ht, initData__keyClass, 'I25F', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I25F', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I25F', "ReplaceableTextures\\CommandButtons\\BTNHornOfFog.blp")
                call SaveStr(initData__ht, initData__keyName, 'I25F', "瘟疫号角")
            
                set id=S2I("26")
                set udg_itemList[id * 100 + 6]='I26F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I26F', 26)
                call SaveStr(initData__ht, initData__keyClass, 'I26F', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I26F', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I26F', "ReplaceableTextures\\CommandButtons\\BTNHeartOfAszune.blp")
                call SaveStr(initData__ht, initData__keyName, 'I26F', "炎魔心脏")
            
                set id=S2I("27")
                set udg_itemList[id * 100 + 6]='I27F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I27F', 27)
                call SaveStr(initData__ht, initData__keyClass, 'I27F', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I27F', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I27F', "ReplaceableTextures\\CommandButtons\\BTNCrystalBall.blp")
                call SaveStr(initData__ht, initData__keyName, 'I27F', "极地水晶")
            
                set id=S2I("28")
                set udg_itemList[id * 100 + 6]='I28F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I28F', 28)
                call SaveStr(initData__ht, initData__keyClass, 'I28F', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I28F', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I28F', "ReplaceableTextures\\CommandButtons\\BTNPotionOfRestoration.blp")
                call SaveStr(initData__ht, initData__keyName, 'I28F', "神圣明灯")
            
                set id=S2I("29")
                set udg_itemList[id * 100 + 6]='I29F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I29F', 29)
                call SaveStr(initData__ht, initData__keyClass, 'I29F', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I29F', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I29F', "ReplaceableTextures\\CommandButtons\\BTNGem.blp")
                call SaveStr(initData__ht, initData__keyName, 'I29F', "翡翠晶石")
            
                set id=S2I("30")
                set udg_itemList[id * 100 + 6]='I30F'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I30F', 30)
                call SaveStr(initData__ht, initData__keyClass, 'I30F', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I30F', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I30F', "ReplaceableTextures\\CommandButtons\\BTNStaffOfSilence.blp")
                call SaveStr(initData__ht, initData__keyName, 'I30F', "裁决之杖")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I01G', 1)
                call SaveStr(initData__ht, initData__keyClass, 'I01G', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I01G', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I01G', "ReplaceableTextures\\CommandButtons\\BTNPendantOfMana.blp")
                call SaveStr(initData__ht, initData__keyName, 'I01G', "魔法垂饰")
            
                set id=S2I("02")
                set udg_itemList[id * 100 + 7]='I02G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I02G', 2)
                call SaveStr(initData__ht, initData__keyClass, 'I02G', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I02G', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I02G', "ReplaceableTextures\\CommandButtons\\BTNClawsOfAttack.blp")
                call SaveStr(initData__ht, initData__keyName, 'I02G', "三相血刃")
            
                set id=S2I("03")
                set udg_itemList[id * 100 + 7]='I03G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I03G', 3)
                call SaveStr(initData__ht, initData__keyClass, 'I03G', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I03G', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I03G', "ReplaceableTextures\\CommandButtons\\BTNManaFlareOff.blp")
                call SaveStr(initData__ht, initData__keyName, 'I03G', "雷电花芯")
            
                set id=S2I("04")
                set udg_itemList[id * 100 + 7]='I04G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I04G', 4)
                call SaveStr(initData__ht, initData__keyClass, 'I04G', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I04G', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I04G', "ReplaceableTextures\\CommandButtons\\BTNCloakOfFlames.blp")
                call SaveStr(initData__ht, initData__keyName, 'I04G', "火焰风衣")
            
                set id=S2I("05")
                set udg_itemList[id * 100 + 7]='I05G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I05G', 5)
                call SaveStr(initData__ht, initData__keyClass, 'I05G', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I05G', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I05G', "ReplaceableTextures\\CommandButtons\\BTNBoneChimes.blp")
                call SaveStr(initData__ht, initData__keyName, 'I05G', "天灾骨钟")
            
                set id=S2I("06")
                set udg_itemList[id * 100 + 7]='I06G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I06G', 6)
                call SaveStr(initData__ht, initData__keyClass, 'I06G', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I06G', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I06G', "ReplaceableTextures\\CommandButtons\\BTNPotionOfOmniscience.blp")
                call SaveStr(initData__ht, initData__keyName, 'I06G', "酸性药剂")
            
                set id=S2I("07")
                set udg_itemList[id * 100 + 7]='I07G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I07G', 7)
                call SaveStr(initData__ht, initData__keyClass, 'I07G', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I07G', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I07G', "ReplaceableTextures\\CommandButtons\\BTNIceShard.blp")
                call SaveStr(initData__ht, initData__keyName, 'I07G', "冰冻碎片")
            
                set id=S2I("08")
                set udg_itemList[id * 100 + 7]='I08G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I08G', 8)
                call SaveStr(initData__ht, initData__keyClass, 'I08G', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I08G', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I08G', "ReplaceableTextures\\CommandButtons\\BTNInfernal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I08G', "毁灭魔球")
            
                set id=S2I("09")
                set udg_itemList[id * 100 + 7]='I09G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I09G', 9)
                call SaveStr(initData__ht, initData__keyClass, 'I09G', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I09G', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I09G', "ReplaceableTextures\\CommandButtons\\BTNMaskOfDeath.blp")
                call SaveStr(initData__ht, initData__keyName, 'I09G', "死亡面罩")
            
                set id=S2I("10")
                set udg_itemList[id * 100 + 7]='I10G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I10G', 10)
                call SaveStr(initData__ht, initData__keyClass, 'I10G', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I10G', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I10G', "ReplaceableTextures\\CommandButtons\\BTNStormHammer.blp")
                call SaveStr(initData__ht, initData__keyName, 'I10G', "风暴战锤")
            
                set id=S2I("11")
                set udg_itemList[id * 100 + 7]='I11G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I11G', 11)
                call SaveStr(initData__ht, initData__keyClass, 'I11G', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I11G', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I11G', "ReplaceableTextures\\CommandButtons\\BTNOrbOfCorruption.blp")
                call SaveStr(initData__ht, initData__keyName, 'I11G', "鬼魂容器")
            
                set id=S2I("12")
                set udg_itemList[id * 100 + 7]='I12G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I12G', 12)
                call SaveStr(initData__ht, initData__keyClass, 'I12G', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I12G', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I12G', "ReplaceableTextures\\CommandButtons\\BTNSpellSteal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I12G', "恶魔手套")
            
                set id=S2I("13")
                set udg_itemList[id * 100 + 7]='I13G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I13G', 13)
                call SaveStr(initData__ht, initData__keyClass, 'I13G', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I13G', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I13G', "ReplaceableTextures\\CommandButtons\\BTNGoblinLandMine.blp")
                call SaveStr(initData__ht, initData__keyName, 'I13G', "工匠地雷")
            
                set id=S2I("14")
                set udg_itemList[id * 100 + 7]='I14G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I14G', 14)
                call SaveStr(initData__ht, initData__keyClass, 'I14G', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I14G', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I14G', "ReplaceableTextures\\CommandButtons\\BTNGhoulFrenzy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I14G', "屠夫锯刃")
            
                set id=S2I("15")
                set udg_itemList[id * 100 + 7]='I15G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I15G', 15)
                call SaveStr(initData__ht, initData__keyClass, 'I15G', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I15G', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I15G', "ReplaceableTextures\\CommandButtons\\BTNNecromancerMaster.blp")
                call SaveStr(initData__ht, initData__keyName, 'I15G', "恶灵之书")
            
                set id=S2I("16")
                set udg_itemList[id * 100 + 7]='I16G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I16G', 16)
                call SaveStr(initData__ht, initData__keyClass, 'I16G', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I16G', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I16G', "ReplaceableTextures\\CommandButtons\\BTNOrbOfLightning.blp")
                call SaveStr(initData__ht, initData__keyName, 'I16G', "双子雷鸣")
            
                set id=S2I("17")
                set udg_itemList[id * 100 + 7]='I17G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I17G', 17)
                call SaveStr(initData__ht, initData__keyClass, 'I17G', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I17G', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I17G', "ReplaceableTextures\\CommandButtons\\BTNRevenant.blp")
                call SaveStr(initData__ht, initData__keyName, 'I17G', "深海意志")
            
                set id=S2I("18")
                set udg_itemList[id * 100 + 7]='I18G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I18G', 18)
                call SaveStr(initData__ht, initData__keyClass, 'I18G', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I18G', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I18G', "ReplaceableTextures\\CommandButtons\\BTNAdvancedUnholyStrength.blp")
                call SaveStr(initData__ht, initData__keyName, 'I18G', "灰烬利爪")
            
                set id=S2I("19")
                set udg_itemList[id * 100 + 7]='I19G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I19G', 19)
                call SaveStr(initData__ht, initData__keyClass, 'I19G', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I19G', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I19G', "ReplaceableTextures\\CommandButtons\\BTNImprovedBows.blp")
                call SaveStr(initData__ht, initData__keyName, 'I19G', "月光大弓")
            
                set id=S2I("20")
                set udg_itemList[id * 100 + 7]='I20G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I20G', 20)
                call SaveStr(initData__ht, initData__keyClass, 'I20G', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I20G', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I20G', "ReplaceableTextures\\CommandButtons\\BTNOrbOfFire.blp")
                call SaveStr(initData__ht, initData__keyName, 'I20G', "血焰核心")
            
                set id=S2I("21")
                set udg_itemList[id * 100 + 7]='I21G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I21G', 21)
                call SaveStr(initData__ht, initData__keyClass, 'I21G', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I21G', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I21G', "ReplaceableTextures\\CommandButtons\\BTNHeartOfSearinox.blp")
                call SaveStr(initData__ht, initData__keyName, 'I21G', "灵魂炸弹")
            
                set id=S2I("22")
                set udg_itemList[id * 100 + 7]='I22G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I22G', 22)
                call SaveStr(initData__ht, initData__keyClass, 'I22G', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I22G', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I22G', "ReplaceableTextures\\CommandButtons\\BTNRodOfNecromancy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I22G', "墓穴枯骨")
            
                set id=S2I("23")
                set udg_itemList[id * 100 + 7]='I23G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I23G', 23)
                call SaveStr(initData__ht, initData__keyClass, 'I23G', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I23G', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I23G', "ReplaceableTextures\\CommandButtons\\BTNUrnOfKelThuzad.blp")
                call SaveStr(initData__ht, initData__keyName, 'I23G', "旧日灵壶")
            
                set id=S2I("24")
                set udg_itemList[id * 100 + 7]='I24G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I24G', 24)
                call SaveStr(initData__ht, initData__keyClass, 'I24G', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I24G', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I24G', "ReplaceableTextures\\CommandButtons\\BTNAdvancedStrengthOfTheMoon.blp")
                call SaveStr(initData__ht, initData__keyName, 'I24G', "月之弯刀")
            
                set id=S2I("25")
                set udg_itemList[id * 100 + 7]='I25G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I25G', 25)
                call SaveStr(initData__ht, initData__keyClass, 'I25G', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I25G', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I25G', "ReplaceableTextures\\CommandButtons\\BTNHornOfFog.blp")
                call SaveStr(initData__ht, initData__keyName, 'I25G', "瘟疫号角")
            
                set id=S2I("26")
                set udg_itemList[id * 100 + 7]='I26G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I26G', 26)
                call SaveStr(initData__ht, initData__keyClass, 'I26G', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I26G', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I26G', "ReplaceableTextures\\CommandButtons\\BTNHeartOfAszune.blp")
                call SaveStr(initData__ht, initData__keyName, 'I26G', "炎魔心脏")
            
                set id=S2I("27")
                set udg_itemList[id * 100 + 7]='I27G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I27G', 27)
                call SaveStr(initData__ht, initData__keyClass, 'I27G', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I27G', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I27G', "ReplaceableTextures\\CommandButtons\\BTNCrystalBall.blp")
                call SaveStr(initData__ht, initData__keyName, 'I27G', "极地水晶")
            
                set id=S2I("28")
                set udg_itemList[id * 100 + 7]='I28G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I28G', 28)
                call SaveStr(initData__ht, initData__keyClass, 'I28G', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I28G', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I28G', "ReplaceableTextures\\CommandButtons\\BTNPotionOfRestoration.blp")
                call SaveStr(initData__ht, initData__keyName, 'I28G', "神圣明灯")
            
                set id=S2I("29")
                set udg_itemList[id * 100 + 7]='I29G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I29G', 29)
                call SaveStr(initData__ht, initData__keyClass, 'I29G', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I29G', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I29G', "ReplaceableTextures\\CommandButtons\\BTNGem.blp")
                call SaveStr(initData__ht, initData__keyName, 'I29G', "翡翠晶石")
            
                set id=S2I("30")
                set udg_itemList[id * 100 + 7]='I30G'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I30G', 30)
                call SaveStr(initData__ht, initData__keyClass, 'I30G', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I30G', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I30G', "ReplaceableTextures\\CommandButtons\\BTNStaffOfSilence.blp")
                call SaveStr(initData__ht, initData__keyName, 'I30G', "裁决之杖")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I01H', 1)
                call SaveStr(initData__ht, initData__keyClass, 'I01H', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I01H', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I01H', "ReplaceableTextures\\CommandButtons\\BTNPendantOfMana.blp")
                call SaveStr(initData__ht, initData__keyName, 'I01H', "魔法垂饰")
            
                set id=S2I("02")
                set udg_itemList[id * 100 + 8]='I02H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I02H', 2)
                call SaveStr(initData__ht, initData__keyClass, 'I02H', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I02H', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I02H', "ReplaceableTextures\\CommandButtons\\BTNClawsOfAttack.blp")
                call SaveStr(initData__ht, initData__keyName, 'I02H', "三相血刃")
            
                set id=S2I("03")
                set udg_itemList[id * 100 + 8]='I03H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I03H', 3)
                call SaveStr(initData__ht, initData__keyClass, 'I03H', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I03H', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I03H', "ReplaceableTextures\\CommandButtons\\BTNManaFlareOff.blp")
                call SaveStr(initData__ht, initData__keyName, 'I03H', "雷电花芯")
            
                set id=S2I("04")
                set udg_itemList[id * 100 + 8]='I04H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I04H', 4)
                call SaveStr(initData__ht, initData__keyClass, 'I04H', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I04H', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I04H', "ReplaceableTextures\\CommandButtons\\BTNCloakOfFlames.blp")
                call SaveStr(initData__ht, initData__keyName, 'I04H', "火焰风衣")
            
                set id=S2I("05")
                set udg_itemList[id * 100 + 8]='I05H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I05H', 5)
                call SaveStr(initData__ht, initData__keyClass, 'I05H', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I05H', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I05H', "ReplaceableTextures\\CommandButtons\\BTNBoneChimes.blp")
                call SaveStr(initData__ht, initData__keyName, 'I05H', "天灾骨钟")
            
                set id=S2I("06")
                set udg_itemList[id * 100 + 8]='I06H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I06H', 6)
                call SaveStr(initData__ht, initData__keyClass, 'I06H', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I06H', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I06H', "ReplaceableTextures\\CommandButtons\\BTNPotionOfOmniscience.blp")
                call SaveStr(initData__ht, initData__keyName, 'I06H', "酸性药剂")
            
                set id=S2I("07")
                set udg_itemList[id * 100 + 8]='I07H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I07H', 7)
                call SaveStr(initData__ht, initData__keyClass, 'I07H', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I07H', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I07H', "ReplaceableTextures\\CommandButtons\\BTNIceShard.blp")
                call SaveStr(initData__ht, initData__keyName, 'I07H', "冰冻碎片")
            
                set id=S2I("08")
                set udg_itemList[id * 100 + 8]='I08H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I08H', 8)
                call SaveStr(initData__ht, initData__keyClass, 'I08H', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I08H', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I08H', "ReplaceableTextures\\CommandButtons\\BTNInfernal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I08H', "毁灭魔球")
            
                set id=S2I("09")
                set udg_itemList[id * 100 + 8]='I09H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I09H', 9)
                call SaveStr(initData__ht, initData__keyClass, 'I09H', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I09H', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I09H', "ReplaceableTextures\\CommandButtons\\BTNMaskOfDeath.blp")
                call SaveStr(initData__ht, initData__keyName, 'I09H', "死亡面罩")
            
                set id=S2I("10")
                set udg_itemList[id * 100 + 8]='I10H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I10H', 10)
                call SaveStr(initData__ht, initData__keyClass, 'I10H', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I10H', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I10H', "ReplaceableTextures\\CommandButtons\\BTNStormHammer.blp")
                call SaveStr(initData__ht, initData__keyName, 'I10H', "风暴战锤")
            
                set id=S2I("11")
                set udg_itemList[id * 100 + 8]='I11H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I11H', 11)
                call SaveStr(initData__ht, initData__keyClass, 'I11H', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I11H', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I11H', "ReplaceableTextures\\CommandButtons\\BTNOrbOfCorruption.blp")
                call SaveStr(initData__ht, initData__keyName, 'I11H', "鬼魂容器")
            
                set id=S2I("12")
                set udg_itemList[id * 100 + 8]='I12H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I12H', 12)
                call SaveStr(initData__ht, initData__keyClass, 'I12H', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I12H', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I12H', "ReplaceableTextures\\CommandButtons\\BTNSpellSteal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I12H', "恶魔手套")
            
                set id=S2I("13")
                set udg_itemList[id * 100 + 8]='I13H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I13H', 13)
                call SaveStr(initData__ht, initData__keyClass, 'I13H', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I13H', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I13H', "ReplaceableTextures\\CommandButtons\\BTNGoblinLandMine.blp")
                call SaveStr(initData__ht, initData__keyName, 'I13H', "工匠地雷")
            
                set id=S2I("14")
                set udg_itemList[id * 100 + 8]='I14H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I14H', 14)
                call SaveStr(initData__ht, initData__keyClass, 'I14H', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I14H', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I14H', "ReplaceableTextures\\CommandButtons\\BTNGhoulFrenzy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I14H', "屠夫锯刃")
            
                set id=S2I("15")
                set udg_itemList[id * 100 + 8]='I15H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I15H', 15)
                call SaveStr(initData__ht, initData__keyClass, 'I15H', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I15H', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I15H', "ReplaceableTextures\\CommandButtons\\BTNNecromancerMaster.blp")
                call SaveStr(initData__ht, initData__keyName, 'I15H', "恶灵之书")
            
                set id=S2I("16")
                set udg_itemList[id * 100 + 8]='I16H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I16H', 16)
                call SaveStr(initData__ht, initData__keyClass, 'I16H', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I16H', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I16H', "ReplaceableTextures\\CommandButtons\\BTNOrbOfLightning.blp")
                call SaveStr(initData__ht, initData__keyName, 'I16H', "双子雷鸣")
            
                set id=S2I("17")
                set udg_itemList[id * 100 + 8]='I17H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I17H', 17)
                call SaveStr(initData__ht, initData__keyClass, 'I17H', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I17H', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I17H', "ReplaceableTextures\\CommandButtons\\BTNRevenant.blp")
                call SaveStr(initData__ht, initData__keyName, 'I17H', "深海意志")
            
                set id=S2I("18")
                set udg_itemList[id * 100 + 8]='I18H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I18H', 18)
                call SaveStr(initData__ht, initData__keyClass, 'I18H', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I18H', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I18H', "ReplaceableTextures\\CommandButtons\\BTNAdvancedUnholyStrength.blp")
                call SaveStr(initData__ht, initData__keyName, 'I18H', "灰烬利爪")
            
                set id=S2I("19")
                set udg_itemList[id * 100 + 8]='I19H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I19H', 19)
                call SaveStr(initData__ht, initData__keyClass, 'I19H', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I19H', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I19H', "ReplaceableTextures\\CommandButtons\\BTNImprovedBows.blp")
                call SaveStr(initData__ht, initData__keyName, 'I19H', "月光大弓")
            
                set id=S2I("20")
                set udg_itemList[id * 100 + 8]='I20H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I20H', 20)
                call SaveStr(initData__ht, initData__keyClass, 'I20H', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I20H', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I20H', "ReplaceableTextures\\CommandButtons\\BTNOrbOfFire.blp")
                call SaveStr(initData__ht, initData__keyName, 'I20H', "血焰核心")
            
                set id=S2I("21")
                set udg_itemList[id * 100 + 8]='I21H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I21H', 21)
                call SaveStr(initData__ht, initData__keyClass, 'I21H', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I21H', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I21H', "ReplaceableTextures\\CommandButtons\\BTNHeartOfSearinox.blp")
                call SaveStr(initData__ht, initData__keyName, 'I21H', "灵魂炸弹")
            
                set id=S2I("22")
                set udg_itemList[id * 100 + 8]='I22H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I22H', 22)
                call SaveStr(initData__ht, initData__keyClass, 'I22H', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I22H', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I22H', "ReplaceableTextures\\CommandButtons\\BTNRodOfNecromancy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I22H', "墓穴枯骨")
            
                set id=S2I("23")
                set udg_itemList[id * 100 + 8]='I23H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I23H', 23)
                call SaveStr(initData__ht, initData__keyClass, 'I23H', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I23H', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I23H', "ReplaceableTextures\\CommandButtons\\BTNUrnOfKelThuzad.blp")
                call SaveStr(initData__ht, initData__keyName, 'I23H', "旧日灵壶")
            
                set id=S2I("24")
                set udg_itemList[id * 100 + 8]='I24H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I24H', 24)
                call SaveStr(initData__ht, initData__keyClass, 'I24H', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I24H', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I24H', "ReplaceableTextures\\CommandButtons\\BTNAdvancedStrengthOfTheMoon.blp")
                call SaveStr(initData__ht, initData__keyName, 'I24H', "月之弯刀")
            
                set id=S2I("25")
                set udg_itemList[id * 100 + 8]='I25H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I25H', 25)
                call SaveStr(initData__ht, initData__keyClass, 'I25H', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I25H', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I25H', "ReplaceableTextures\\CommandButtons\\BTNHornOfFog.blp")
                call SaveStr(initData__ht, initData__keyName, 'I25H', "瘟疫号角")
            
                set id=S2I("26")
                set udg_itemList[id * 100 + 8]='I26H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I26H', 26)
                call SaveStr(initData__ht, initData__keyClass, 'I26H', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I26H', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I26H', "ReplaceableTextures\\CommandButtons\\BTNHeartOfAszune.blp")
                call SaveStr(initData__ht, initData__keyName, 'I26H', "炎魔心脏")
            
                set id=S2I("27")
                set udg_itemList[id * 100 + 8]='I27H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I27H', 27)
                call SaveStr(initData__ht, initData__keyClass, 'I27H', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I27H', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I27H', "ReplaceableTextures\\CommandButtons\\BTNCrystalBall.blp")
                call SaveStr(initData__ht, initData__keyName, 'I27H', "极地水晶")
            
                set id=S2I("28")
                set udg_itemList[id * 100 + 8]='I28H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I28H', 28)
                call SaveStr(initData__ht, initData__keyClass, 'I28H', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I28H', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I28H', "ReplaceableTextures\\CommandButtons\\BTNPotionOfRestoration.blp")
                call SaveStr(initData__ht, initData__keyName, 'I28H', "神圣明灯")
            
                set id=S2I("29")
                set udg_itemList[id * 100 + 8]='I29H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I29H', 29)
                call SaveStr(initData__ht, initData__keyClass, 'I29H', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I29H', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I29H', "ReplaceableTextures\\CommandButtons\\BTNGem.blp")
                call SaveStr(initData__ht, initData__keyName, 'I29H', "翡翠晶石")
            
                set id=S2I("30")
                set udg_itemList[id * 100 + 8]='I30H'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I30H', 30)
                call SaveStr(initData__ht, initData__keyClass, 'I30H', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I30H', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I30H', "ReplaceableTextures\\CommandButtons\\BTNStaffOfSilence.blp")
                call SaveStr(initData__ht, initData__keyName, 'I30H', "裁决之杖")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I01I', 1)
                call SaveStr(initData__ht, initData__keyClass, 'I01I', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I01I', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I01I', "ReplaceableTextures\\CommandButtons\\BTNPendantOfMana.blp")
                call SaveStr(initData__ht, initData__keyName, 'I01I', "魔法垂饰")
            
                set id=S2I("02")
                set udg_itemList[id * 100 + 9]='I02I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I02I', 2)
                call SaveStr(initData__ht, initData__keyClass, 'I02I', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I02I', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I02I', "ReplaceableTextures\\CommandButtons\\BTNClawsOfAttack.blp")
                call SaveStr(initData__ht, initData__keyName, 'I02I', "三相血刃")
            
                set id=S2I("03")
                set udg_itemList[id * 100 + 9]='I03I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I03I', 3)
                call SaveStr(initData__ht, initData__keyClass, 'I03I', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I03I', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I03I', "ReplaceableTextures\\CommandButtons\\BTNManaFlareOff.blp")
                call SaveStr(initData__ht, initData__keyName, 'I03I', "雷电花芯")
            
                set id=S2I("04")
                set udg_itemList[id * 100 + 9]='I04I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I04I', 4)
                call SaveStr(initData__ht, initData__keyClass, 'I04I', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I04I', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I04I', "ReplaceableTextures\\CommandButtons\\BTNCloakOfFlames.blp")
                call SaveStr(initData__ht, initData__keyName, 'I04I', "火焰风衣")
            
                set id=S2I("05")
                set udg_itemList[id * 100 + 9]='I05I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I05I', 5)
                call SaveStr(initData__ht, initData__keyClass, 'I05I', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I05I', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I05I', "ReplaceableTextures\\CommandButtons\\BTNBoneChimes.blp")
                call SaveStr(initData__ht, initData__keyName, 'I05I', "天灾骨钟")
            
                set id=S2I("06")
                set udg_itemList[id * 100 + 9]='I06I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I06I', 6)
                call SaveStr(initData__ht, initData__keyClass, 'I06I', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I06I', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I06I', "ReplaceableTextures\\CommandButtons\\BTNPotionOfOmniscience.blp")
                call SaveStr(initData__ht, initData__keyName, 'I06I', "酸性药剂")
            
                set id=S2I("07")
                set udg_itemList[id * 100 + 9]='I07I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I07I', 7)
                call SaveStr(initData__ht, initData__keyClass, 'I07I', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I07I', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I07I', "ReplaceableTextures\\CommandButtons\\BTNIceShard.blp")
                call SaveStr(initData__ht, initData__keyName, 'I07I', "冰冻碎片")
            
                set id=S2I("08")
                set udg_itemList[id * 100 + 9]='I08I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I08I', 8)
                call SaveStr(initData__ht, initData__keyClass, 'I08I', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I08I', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I08I', "ReplaceableTextures\\CommandButtons\\BTNInfernal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I08I', "毁灭魔球")
            
                set id=S2I("09")
                set udg_itemList[id * 100 + 9]='I09I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I09I', 9)
                call SaveStr(initData__ht, initData__keyClass, 'I09I', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I09I', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I09I', "ReplaceableTextures\\CommandButtons\\BTNMaskOfDeath.blp")
                call SaveStr(initData__ht, initData__keyName, 'I09I', "死亡面罩")
            
                set id=S2I("10")
                set udg_itemList[id * 100 + 9]='I10I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I10I', 10)
                call SaveStr(initData__ht, initData__keyClass, 'I10I', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I10I', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I10I', "ReplaceableTextures\\CommandButtons\\BTNStormHammer.blp")
                call SaveStr(initData__ht, initData__keyName, 'I10I', "风暴战锤")
            
                set id=S2I("11")
                set udg_itemList[id * 100 + 9]='I11I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I11I', 11)
                call SaveStr(initData__ht, initData__keyClass, 'I11I', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I11I', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I11I', "ReplaceableTextures\\CommandButtons\\BTNOrbOfCorruption.blp")
                call SaveStr(initData__ht, initData__keyName, 'I11I', "鬼魂容器")
            
                set id=S2I("12")
                set udg_itemList[id * 100 + 9]='I12I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I12I', 12)
                call SaveStr(initData__ht, initData__keyClass, 'I12I', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I12I', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I12I', "ReplaceableTextures\\CommandButtons\\BTNSpellSteal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I12I', "恶魔手套")
            
                set id=S2I("13")
                set udg_itemList[id * 100 + 9]='I13I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I13I', 13)
                call SaveStr(initData__ht, initData__keyClass, 'I13I', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I13I', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I13I', "ReplaceableTextures\\CommandButtons\\BTNGoblinLandMine.blp")
                call SaveStr(initData__ht, initData__keyName, 'I13I', "工匠地雷")
            
                set id=S2I("14")
                set udg_itemList[id * 100 + 9]='I14I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I14I', 14)
                call SaveStr(initData__ht, initData__keyClass, 'I14I', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I14I', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I14I', "ReplaceableTextures\\CommandButtons\\BTNGhoulFrenzy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I14I', "屠夫锯刃")
            
                set id=S2I("15")
                set udg_itemList[id * 100 + 9]='I15I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I15I', 15)
                call SaveStr(initData__ht, initData__keyClass, 'I15I', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I15I', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I15I', "ReplaceableTextures\\CommandButtons\\BTNNecromancerMaster.blp")
                call SaveStr(initData__ht, initData__keyName, 'I15I', "恶灵之书")
            
                set id=S2I("16")
                set udg_itemList[id * 100 + 9]='I16I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I16I', 16)
                call SaveStr(initData__ht, initData__keyClass, 'I16I', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I16I', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I16I', "ReplaceableTextures\\CommandButtons\\BTNOrbOfLightning.blp")
                call SaveStr(initData__ht, initData__keyName, 'I16I', "双子雷鸣")
            
                set id=S2I("17")
                set udg_itemList[id * 100 + 9]='I17I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I17I', 17)
                call SaveStr(initData__ht, initData__keyClass, 'I17I', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I17I', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I17I', "ReplaceableTextures\\CommandButtons\\BTNRevenant.blp")
                call SaveStr(initData__ht, initData__keyName, 'I17I', "深海意志")
            
                set id=S2I("18")
                set udg_itemList[id * 100 + 9]='I18I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I18I', 18)
                call SaveStr(initData__ht, initData__keyClass, 'I18I', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I18I', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I18I', "ReplaceableTextures\\CommandButtons\\BTNAdvancedUnholyStrength.blp")
                call SaveStr(initData__ht, initData__keyName, 'I18I', "灰烬利爪")
            
                set id=S2I("19")
                set udg_itemList[id * 100 + 9]='I19I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I19I', 19)
                call SaveStr(initData__ht, initData__keyClass, 'I19I', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I19I', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I19I', "ReplaceableTextures\\CommandButtons\\BTNImprovedBows.blp")
                call SaveStr(initData__ht, initData__keyName, 'I19I', "月光大弓")
            
                set id=S2I("20")
                set udg_itemList[id * 100 + 9]='I20I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I20I', 20)
                call SaveStr(initData__ht, initData__keyClass, 'I20I', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I20I', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I20I', "ReplaceableTextures\\CommandButtons\\BTNOrbOfFire.blp")
                call SaveStr(initData__ht, initData__keyName, 'I20I', "血焰核心")
            
                set id=S2I("21")
                set udg_itemList[id * 100 + 9]='I21I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I21I', 21)
                call SaveStr(initData__ht, initData__keyClass, 'I21I', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I21I', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I21I', "ReplaceableTextures\\CommandButtons\\BTNHeartOfSearinox.blp")
                call SaveStr(initData__ht, initData__keyName, 'I21I', "灵魂炸弹")
            
                set id=S2I("22")
                set udg_itemList[id * 100 + 9]='I22I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I22I', 22)
                call SaveStr(initData__ht, initData__keyClass, 'I22I', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I22I', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I22I', "ReplaceableTextures\\CommandButtons\\BTNRodOfNecromancy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I22I', "墓穴枯骨")
            
                set id=S2I("23")
                set udg_itemList[id * 100 + 9]='I23I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I23I', 23)
                call SaveStr(initData__ht, initData__keyClass, 'I23I', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I23I', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I23I', "ReplaceableTextures\\CommandButtons\\BTNUrnOfKelThuzad.blp")
                call SaveStr(initData__ht, initData__keyName, 'I23I', "旧日灵壶")
            
                set id=S2I("24")
                set udg_itemList[id * 100 + 9]='I24I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I24I', 24)
                call SaveStr(initData__ht, initData__keyClass, 'I24I', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I24I', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I24I', "ReplaceableTextures\\CommandButtons\\BTNAdvancedStrengthOfTheMoon.blp")
                call SaveStr(initData__ht, initData__keyName, 'I24I', "月之弯刀")
            
                set id=S2I("25")
                set udg_itemList[id * 100 + 9]='I25I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I25I', 25)
                call SaveStr(initData__ht, initData__keyClass, 'I25I', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I25I', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I25I', "ReplaceableTextures\\CommandButtons\\BTNHornOfFog.blp")
                call SaveStr(initData__ht, initData__keyName, 'I25I', "瘟疫号角")
            
                set id=S2I("26")
                set udg_itemList[id * 100 + 9]='I26I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I26I', 26)
                call SaveStr(initData__ht, initData__keyClass, 'I26I', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I26I', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I26I', "ReplaceableTextures\\CommandButtons\\BTNHeartOfAszune.blp")
                call SaveStr(initData__ht, initData__keyName, 'I26I', "炎魔心脏")
            
                set id=S2I("27")
                set udg_itemList[id * 100 + 9]='I27I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I27I', 27)
                call SaveStr(initData__ht, initData__keyClass, 'I27I', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I27I', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I27I', "ReplaceableTextures\\CommandButtons\\BTNCrystalBall.blp")
                call SaveStr(initData__ht, initData__keyName, 'I27I', "极地水晶")
            
                set id=S2I("28")
                set udg_itemList[id * 100 + 9]='I28I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I28I', 28)
                call SaveStr(initData__ht, initData__keyClass, 'I28I', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I28I', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I28I', "ReplaceableTextures\\CommandButtons\\BTNPotionOfRestoration.blp")
                call SaveStr(initData__ht, initData__keyName, 'I28I', "神圣明灯")
            
                set id=S2I("29")
                set udg_itemList[id * 100 + 9]='I29I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I29I', 29)
                call SaveStr(initData__ht, initData__keyClass, 'I29I', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I29I', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I29I', "ReplaceableTextures\\CommandButtons\\BTNGem.blp")
                call SaveStr(initData__ht, initData__keyName, 'I29I', "翡翠晶石")
            
                set id=S2I("30")
                set udg_itemList[id * 100 + 9]='I30I'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I30I', 30)
                call SaveStr(initData__ht, initData__keyClass, 'I30I', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I30I', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I30I', "ReplaceableTextures\\CommandButtons\\BTNStaffOfSilence.blp")
                call SaveStr(initData__ht, initData__keyName, 'I30I', "裁决之杖")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I01J', 1)
                call SaveStr(initData__ht, initData__keyClass, 'I01J', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I01J', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I01J', "ReplaceableTextures\\CommandButtons\\BTNPendantOfMana.blp")
                call SaveStr(initData__ht, initData__keyName, 'I01J', "魔法垂饰")
            
                set id=S2I("02")
                set udg_itemList[id * 100 + 10]='I02J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I02J', 2)
                call SaveStr(initData__ht, initData__keyClass, 'I02J', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I02J', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I02J', "ReplaceableTextures\\CommandButtons\\BTNClawsOfAttack.blp")
                call SaveStr(initData__ht, initData__keyName, 'I02J', "三相血刃")
            
                set id=S2I("03")
                set udg_itemList[id * 100 + 10]='I03J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I03J', 3)
                call SaveStr(initData__ht, initData__keyClass, 'I03J', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I03J', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I03J', "ReplaceableTextures\\CommandButtons\\BTNManaFlareOff.blp")
                call SaveStr(initData__ht, initData__keyName, 'I03J', "雷电花芯")
            
                set id=S2I("04")
                set udg_itemList[id * 100 + 10]='I04J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I04J', 4)
                call SaveStr(initData__ht, initData__keyClass, 'I04J', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I04J', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I04J', "ReplaceableTextures\\CommandButtons\\BTNCloakOfFlames.blp")
                call SaveStr(initData__ht, initData__keyName, 'I04J', "火焰风衣")
            
                set id=S2I("05")
                set udg_itemList[id * 100 + 10]='I05J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I05J', 5)
                call SaveStr(initData__ht, initData__keyClass, 'I05J', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I05J', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I05J', "ReplaceableTextures\\CommandButtons\\BTNBoneChimes.blp")
                call SaveStr(initData__ht, initData__keyName, 'I05J', "天灾骨钟")
            
                set id=S2I("06")
                set udg_itemList[id * 100 + 10]='I06J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I06J', 6)
                call SaveStr(initData__ht, initData__keyClass, 'I06J', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I06J', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I06J', "ReplaceableTextures\\CommandButtons\\BTNPotionOfOmniscience.blp")
                call SaveStr(initData__ht, initData__keyName, 'I06J', "酸性药剂")
            
                set id=S2I("07")
                set udg_itemList[id * 100 + 10]='I07J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I07J', 7)
                call SaveStr(initData__ht, initData__keyClass, 'I07J', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I07J', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I07J', "ReplaceableTextures\\CommandButtons\\BTNIceShard.blp")
                call SaveStr(initData__ht, initData__keyName, 'I07J', "冰冻碎片")
            
                set id=S2I("08")
                set udg_itemList[id * 100 + 10]='I08J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I08J', 8)
                call SaveStr(initData__ht, initData__keyClass, 'I08J', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I08J', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I08J', "ReplaceableTextures\\CommandButtons\\BTNInfernal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I08J', "毁灭魔球")
            
                set id=S2I("09")
                set udg_itemList[id * 100 + 10]='I09J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I09J', 9)
                call SaveStr(initData__ht, initData__keyClass, 'I09J', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I09J', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I09J', "ReplaceableTextures\\CommandButtons\\BTNMaskOfDeath.blp")
                call SaveStr(initData__ht, initData__keyName, 'I09J', "死亡面罩")
            
                set id=S2I("10")
                set udg_itemList[id * 100 + 10]='I10J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I10J', 10)
                call SaveStr(initData__ht, initData__keyClass, 'I10J', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I10J', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I10J', "ReplaceableTextures\\CommandButtons\\BTNStormHammer.blp")
                call SaveStr(initData__ht, initData__keyName, 'I10J', "风暴战锤")
            
                set id=S2I("11")
                set udg_itemList[id * 100 + 10]='I11J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I11J', 11)
                call SaveStr(initData__ht, initData__keyClass, 'I11J', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I11J', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I11J', "ReplaceableTextures\\CommandButtons\\BTNOrbOfCorruption.blp")
                call SaveStr(initData__ht, initData__keyName, 'I11J', "鬼魂容器")
            
                set id=S2I("12")
                set udg_itemList[id * 100 + 10]='I12J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I12J', 12)
                call SaveStr(initData__ht, initData__keyClass, 'I12J', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I12J', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I12J', "ReplaceableTextures\\CommandButtons\\BTNSpellSteal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I12J', "恶魔手套")
            
                set id=S2I("13")
                set udg_itemList[id * 100 + 10]='I13J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I13J', 13)
                call SaveStr(initData__ht, initData__keyClass, 'I13J', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I13J', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I13J', "ReplaceableTextures\\CommandButtons\\BTNGoblinLandMine.blp")
                call SaveStr(initData__ht, initData__keyName, 'I13J', "工匠地雷")
            
                set id=S2I("14")
                set udg_itemList[id * 100 + 10]='I14J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I14J', 14)
                call SaveStr(initData__ht, initData__keyClass, 'I14J', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I14J', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I14J', "ReplaceableTextures\\CommandButtons\\BTNGhoulFrenzy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I14J', "屠夫锯刃")
            
                set id=S2I("15")
                set udg_itemList[id * 100 + 10]='I15J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I15J', 15)
                call SaveStr(initData__ht, initData__keyClass, 'I15J', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I15J', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I15J', "ReplaceableTextures\\CommandButtons\\BTNNecromancerMaster.blp")
                call SaveStr(initData__ht, initData__keyName, 'I15J', "恶灵之书")
            
                set id=S2I("16")
                set udg_itemList[id * 100 + 10]='I16J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I16J', 16)
                call SaveStr(initData__ht, initData__keyClass, 'I16J', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I16J', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I16J', "ReplaceableTextures\\CommandButtons\\BTNOrbOfLightning.blp")
                call SaveStr(initData__ht, initData__keyName, 'I16J', "双子雷鸣")
            
                set id=S2I("17")
                set udg_itemList[id * 100 + 10]='I17J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I17J', 17)
                call SaveStr(initData__ht, initData__keyClass, 'I17J', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I17J', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I17J', "ReplaceableTextures\\CommandButtons\\BTNRevenant.blp")
                call SaveStr(initData__ht, initData__keyName, 'I17J', "深海意志")
            
                set id=S2I("18")
                set udg_itemList[id * 100 + 10]='I18J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I18J', 18)
                call SaveStr(initData__ht, initData__keyClass, 'I18J', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I18J', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I18J', "ReplaceableTextures\\CommandButtons\\BTNAdvancedUnholyStrength.blp")
                call SaveStr(initData__ht, initData__keyName, 'I18J', "灰烬利爪")
            
                set id=S2I("19")
                set udg_itemList[id * 100 + 10]='I19J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I19J', 19)
                call SaveStr(initData__ht, initData__keyClass, 'I19J', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I19J', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I19J', "ReplaceableTextures\\CommandButtons\\BTNImprovedBows.blp")
                call SaveStr(initData__ht, initData__keyName, 'I19J', "月光大弓")
            
                set id=S2I("20")
                set udg_itemList[id * 100 + 10]='I20J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I20J', 20)
                call SaveStr(initData__ht, initData__keyClass, 'I20J', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I20J', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I20J', "ReplaceableTextures\\CommandButtons\\BTNOrbOfFire.blp")
                call SaveStr(initData__ht, initData__keyName, 'I20J', "血焰核心")
            
                set id=S2I("21")
                set udg_itemList[id * 100 + 10]='I21J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I21J', 21)
                call SaveStr(initData__ht, initData__keyClass, 'I21J', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I21J', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I21J', "ReplaceableTextures\\CommandButtons\\BTNHeartOfSearinox.blp")
                call SaveStr(initData__ht, initData__keyName, 'I21J', "灵魂炸弹")
            
                set id=S2I("22")
                set udg_itemList[id * 100 + 10]='I22J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I22J', 22)
                call SaveStr(initData__ht, initData__keyClass, 'I22J', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I22J', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I22J', "ReplaceableTextures\\CommandButtons\\BTNRodOfNecromancy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I22J', "墓穴枯骨")
            
                set id=S2I("23")
                set udg_itemList[id * 100 + 10]='I23J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I23J', 23)
                call SaveStr(initData__ht, initData__keyClass, 'I23J', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I23J', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I23J', "ReplaceableTextures\\CommandButtons\\BTNUrnOfKelThuzad.blp")
                call SaveStr(initData__ht, initData__keyName, 'I23J', "旧日灵壶")
            
                set id=S2I("24")
                set udg_itemList[id * 100 + 10]='I24J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I24J', 24)
                call SaveStr(initData__ht, initData__keyClass, 'I24J', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I24J', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I24J', "ReplaceableTextures\\CommandButtons\\BTNAdvancedStrengthOfTheMoon.blp")
                call SaveStr(initData__ht, initData__keyName, 'I24J', "月之弯刀")
            
                set id=S2I("25")
                set udg_itemList[id * 100 + 10]='I25J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I25J', 25)
                call SaveStr(initData__ht, initData__keyClass, 'I25J', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I25J', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I25J', "ReplaceableTextures\\CommandButtons\\BTNHornOfFog.blp")
                call SaveStr(initData__ht, initData__keyName, 'I25J', "瘟疫号角")
            
                set id=S2I("26")
                set udg_itemList[id * 100 + 10]='I26J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I26J', 26)
                call SaveStr(initData__ht, initData__keyClass, 'I26J', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I26J', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I26J', "ReplaceableTextures\\CommandButtons\\BTNHeartOfAszune.blp")
                call SaveStr(initData__ht, initData__keyName, 'I26J', "炎魔心脏")
            
                set id=S2I("27")
                set udg_itemList[id * 100 + 10]='I27J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I27J', 27)
                call SaveStr(initData__ht, initData__keyClass, 'I27J', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I27J', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I27J', "ReplaceableTextures\\CommandButtons\\BTNCrystalBall.blp")
                call SaveStr(initData__ht, initData__keyName, 'I27J', "极地水晶")
            
                set id=S2I("28")
                set udg_itemList[id * 100 + 10]='I28J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I28J', 28)
                call SaveStr(initData__ht, initData__keyClass, 'I28J', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I28J', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I28J', "ReplaceableTextures\\CommandButtons\\BTNPotionOfRestoration.blp")
                call SaveStr(initData__ht, initData__keyName, 'I28J', "神圣明灯")
            
                set id=S2I("29")
                set udg_itemList[id * 100 + 10]='I29J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I29J', 29)
                call SaveStr(initData__ht, initData__keyClass, 'I29J', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I29J', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I29J', "ReplaceableTextures\\CommandButtons\\BTNGem.blp")
                call SaveStr(initData__ht, initData__keyName, 'I29J', "翡翠晶石")
            
                set id=S2I("30")
                set udg_itemList[id * 100 + 10]='I30J'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I30J', 30)
                call SaveStr(initData__ht, initData__keyClass, 'I30J', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I30J', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I30J', "ReplaceableTextures\\CommandButtons\\BTNStaffOfSilence.blp")
                call SaveStr(initData__ht, initData__keyName, 'I30J', "裁决之杖")
                ...
                call SaveInteger(initData__ht, initData__keyId, 'I01K', 1)
                call SaveStr(initData__ht, initData__keyClass, 'I01K', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I01K', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I01K', "ReplaceableTextures\\CommandButtons\\BTNPendantOfMana.blp")
                call SaveStr(initData__ht, initData__keyName, 'I01K', "魔法垂饰")
            
                set id=S2I("02")
                set udg_itemList[id * 100 + 11]='I02K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I02K', 2)
                call SaveStr(initData__ht, initData__keyClass, 'I02K', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I02K', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I02K', "ReplaceableTextures\\CommandButtons\\BTNClawsOfAttack.blp")
                call SaveStr(initData__ht, initData__keyName, 'I02K', "三相血刃")
            
                set id=S2I("03")
                set udg_itemList[id * 100 + 11]='I03K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I03K', 3)
                call SaveStr(initData__ht, initData__keyClass, 'I03K', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I03K', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I03K', "ReplaceableTextures\\CommandButtons\\BTNManaFlareOff.blp")
                call SaveStr(initData__ht, initData__keyName, 'I03K', "雷电花芯")
            
                set id=S2I("04")
                set udg_itemList[id * 100 + 11]='I04K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I04K', 4)
                call SaveStr(initData__ht, initData__keyClass, 'I04K', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I04K', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I04K', "ReplaceableTextures\\CommandButtons\\BTNCloakOfFlames.blp")
                call SaveStr(initData__ht, initData__keyName, 'I04K', "火焰风衣")
            
                set id=S2I("05")
                set udg_itemList[id * 100 + 11]='I05K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I05K', 5)
                call SaveStr(initData__ht, initData__keyClass, 'I05K', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I05K', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I05K', "ReplaceableTextures\\CommandButtons\\BTNBoneChimes.blp")
                call SaveStr(initData__ht, initData__keyName, 'I05K', "天灾骨钟")
            
                set id=S2I("06")
                set udg_itemList[id * 100 + 11]='I06K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I06K', 6)
                call SaveStr(initData__ht, initData__keyClass, 'I06K', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I06K', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I06K', "ReplaceableTextures\\CommandButtons\\BTNPotionOfOmniscience.blp")
                call SaveStr(initData__ht, initData__keyName, 'I06K', "酸性药剂")
            
                set id=S2I("07")
                set udg_itemList[id * 100 + 11]='I07K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I07K', 7)
                call SaveStr(initData__ht, initData__keyClass, 'I07K', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I07K', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I07K', "ReplaceableTextures\\CommandButtons\\BTNIceShard.blp")
                call SaveStr(initData__ht, initData__keyName, 'I07K', "冰冻碎片")
            
                set id=S2I("08")
                set udg_itemList[id * 100 + 11]='I08K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I08K', 8)
                call SaveStr(initData__ht, initData__keyClass, 'I08K', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I08K', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I08K', "ReplaceableTextures\\CommandButtons\\BTNInfernal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I08K', "毁灭魔球")
            
                set id=S2I("09")
                set udg_itemList[id * 100 + 11]='I09K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I09K', 9)
                call SaveStr(initData__ht, initData__keyClass, 'I09K', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I09K', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I09K', "ReplaceableTextures\\CommandButtons\\BTNMaskOfDeath.blp")
                call SaveStr(initData__ht, initData__keyName, 'I09K', "死亡面罩")
            
                set id=S2I("10")
                set udg_itemList[id * 100 + 11]='I10K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I10K', 10)
                call SaveStr(initData__ht, initData__keyClass, 'I10K', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I10K', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I10K', "ReplaceableTextures\\CommandButtons\\BTNStormHammer.blp")
                call SaveStr(initData__ht, initData__keyName, 'I10K', "风暴战锤")
            
                set id=S2I("11")
                set udg_itemList[id * 100 + 11]='I11K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I11K', 11)
                call SaveStr(initData__ht, initData__keyClass, 'I11K', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I11K', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I11K', "ReplaceableTextures\\CommandButtons\\BTNOrbOfCorruption.blp")
                call SaveStr(initData__ht, initData__keyName, 'I11K', "鬼魂容器")
            
                set id=S2I("12")
                set udg_itemList[id * 100 + 11]='I12K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I12K', 12)
                call SaveStr(initData__ht, initData__keyClass, 'I12K', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I12K', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I12K', "ReplaceableTextures\\CommandButtons\\BTNSpellSteal.blp")
                call SaveStr(initData__ht, initData__keyName, 'I12K', "恶魔手套")
            
                set id=S2I("13")
                set udg_itemList[id * 100 + 11]='I13K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I13K', 13)
                call SaveStr(initData__ht, initData__keyClass, 'I13K', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I13K', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I13K', "ReplaceableTextures\\CommandButtons\\BTNGoblinLandMine.blp")
                call SaveStr(initData__ht, initData__keyName, 'I13K', "工匠地雷")
            
                set id=S2I("14")
                set udg_itemList[id * 100 + 11]='I14K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I14K', 14)
                call SaveStr(initData__ht, initData__keyClass, 'I14K', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I14K', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I14K', "ReplaceableTextures\\CommandButtons\\BTNGhoulFrenzy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I14K', "屠夫锯刃")
            
                set id=S2I("15")
                set udg_itemList[id * 100 + 11]='I15K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I15K', 15)
                call SaveStr(initData__ht, initData__keyClass, 'I15K', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I15K', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I15K', "ReplaceableTextures\\CommandButtons\\BTNNecromancerMaster.blp")
                call SaveStr(initData__ht, initData__keyName, 'I15K', "恶灵之书")
            
                set id=S2I("16")
                set udg_itemList[id * 100 + 11]='I16K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I16K', 16)
                call SaveStr(initData__ht, initData__keyClass, 'I16K', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I16K', "闪电")
                call SaveStr(initData__ht, initData__keyIcon, 'I16K', "ReplaceableTextures\\CommandButtons\\BTNOrbOfLightning.blp")
                call SaveStr(initData__ht, initData__keyName, 'I16K', "双子雷鸣")
            
                set id=S2I("17")
                set udg_itemList[id * 100 + 11]='I17K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I17K', 17)
                call SaveStr(initData__ht, initData__keyClass, 'I17K', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I17K', "打击")
                call SaveStr(initData__ht, initData__keyIcon, 'I17K', "ReplaceableTextures\\CommandButtons\\BTNRevenant.blp")
                call SaveStr(initData__ht, initData__keyName, 'I17K', "深海意志")
            
                set id=S2I("18")
                set udg_itemList[id * 100 + 11]='I18K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I18K', 18)
                call SaveStr(initData__ht, initData__keyClass, 'I18K', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I18K', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I18K', "ReplaceableTextures\\CommandButtons\\BTNAdvancedUnholyStrength.blp")
                call SaveStr(initData__ht, initData__keyName, 'I18K', "灰烬利爪")
            
                set id=S2I("19")
                set udg_itemList[id * 100 + 11]='I19K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I19K', 19)
                call SaveStr(initData__ht, initData__keyClass, 'I19K', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I19K', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I19K', "ReplaceableTextures\\CommandButtons\\BTNImprovedBows.blp")
                call SaveStr(initData__ht, initData__keyName, 'I19K', "月光大弓")
            
                set id=S2I("20")
                set udg_itemList[id * 100 + 11]='I20K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I20K', 20)
                call SaveStr(initData__ht, initData__keyClass, 'I20K', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I20K', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I20K', "ReplaceableTextures\\CommandButtons\\BTNOrbOfFire.blp")
                call SaveStr(initData__ht, initData__keyName, 'I20K', "血焰核心")
            
                set id=S2I("21")
                set udg_itemList[id * 100 + 11]='I21K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I21K', 21)
                call SaveStr(initData__ht, initData__keyClass, 'I21K', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I21K', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I21K', "ReplaceableTextures\\CommandButtons\\BTNHeartOfSearinox.blp")
                call SaveStr(initData__ht, initData__keyName, 'I21K', "灵魂炸弹")
            
                set id=S2I("22")
                set udg_itemList[id * 100 + 11]='I22K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I22K', 22)
                call SaveStr(initData__ht, initData__keyClass, 'I22K', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I22K', "精神")
                call SaveStr(initData__ht, initData__keyIcon, 'I22K', "ReplaceableTextures\\CommandButtons\\BTNRodOfNecromancy.blp")
                call SaveStr(initData__ht, initData__keyName, 'I22K', "墓穴枯骨")
            
                set id=S2I("23")
                set udg_itemList[id * 100 + 11]='I23K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I23K', 23)
                call SaveStr(initData__ht, initData__keyClass, 'I23K', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I23K', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I23K', "ReplaceableTextures\\CommandButtons\\BTNUrnOfKelThuzad.blp")
                call SaveStr(initData__ht, initData__keyName, 'I23K', "旧日灵壶")
            
                set id=S2I("24")
                set udg_itemList[id * 100 + 11]='I24K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I24K', 24)
                call SaveStr(initData__ht, initData__keyClass, 'I24K', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I24K', "切割")
                call SaveStr(initData__ht, initData__keyIcon, 'I24K', "ReplaceableTextures\\CommandButtons\\BTNAdvancedStrengthOfTheMoon.blp")
                call SaveStr(initData__ht, initData__keyName, 'I24K', "月之弯刀")
            
                set id=S2I("25")
                set udg_itemList[id * 100 + 11]='I25K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I25K', 25)
                call SaveStr(initData__ht, initData__keyClass, 'I25K', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I25K', "毒素")
                call SaveStr(initData__ht, initData__keyIcon, 'I25K', "ReplaceableTextures\\CommandButtons\\BTNHornOfFog.blp")
                call SaveStr(initData__ht, initData__keyName, 'I25K', "瘟疫号角")
            
                set id=S2I("26")
                set udg_itemList[id * 100 + 11]='I26K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I26K', 26)
                call SaveStr(initData__ht, initData__keyClass, 'I26K', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I26K', "火焰")
                call SaveStr(initData__ht, initData__keyIcon, 'I26K', "ReplaceableTextures\\CommandButtons\\BTNHeartOfAszune.blp")
                call SaveStr(initData__ht, initData__keyName, 'I26K', "炎魔心脏")
            
                set id=S2I("27")
                set udg_itemList[id * 100 + 11]='I27K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I27K', 27)
                call SaveStr(initData__ht, initData__keyClass, 'I27K', "场地类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I27K', "冰冻")
                call SaveStr(initData__ht, initData__keyIcon, 'I27K', "ReplaceableTextures\\CommandButtons\\BTNCrystalBall.blp")
                call SaveStr(initData__ht, initData__keyName, 'I27K', "极地水晶")
            
                set id=S2I("28")
                set udg_itemList[id * 100 + 11]='I28K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I28K', 28)
                call SaveStr(initData__ht, initData__keyClass, 'I28K', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I28K', "诅咒")
                call SaveStr(initData__ht, initData__keyIcon, 'I28K', "ReplaceableTextures\\CommandButtons\\BTNPotionOfRestoration.blp")
                call SaveStr(initData__ht, initData__keyName, 'I28K', "神圣明灯")
            
                set id=S2I("29")
                set udg_itemList[id * 100 + 11]='I29K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I29K', 29)
                call SaveStr(initData__ht, initData__keyClass, 'I29K', "召唤类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I29K', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I29K', "ReplaceableTextures\\CommandButtons\\BTNGem.blp")
                call SaveStr(initData__ht, initData__keyName, 'I29K', "翡翠晶石")
            
                set id=S2I("30")
                set udg_itemList[id * 100 + 11]='I30K'
                set udg_itemListNum=udg_itemListNum + 1
                
                call SaveInteger(initData__ht, initData__keyId, 'I30K', 30)
                call SaveStr(initData__ht, initData__keyClass, 'I30K', "发射类")
                call SaveStr(initData__ht, initData__keyDamageType, 'I30K', "魔法")
                call SaveStr(initData__ht, initData__keyIcon, 'I30K', "ReplaceableTextures\\CommandButtons\\BTNStaffOfSilence.blp")
                call SaveStr(initData__ht, initData__keyName, 'I30K', "裁决之杖")
            
        
        set itemAbiList[0]=0
    endfunction
    function getItemId takes integer id returns integer
        return LoadInteger(initData__ht, initData__keyId, id)
    endfunction
    function getItemClass takes integer id returns string
        return LoadStr(initData__ht, initData__keyClass, id)
    endfunction
    function getItemDamageType takes integer id returns string
        return LoadStr(initData__ht, initData__keyDamageType, id)
    endfunction
    function getItemIcon takes integer id returns string
        return LoadStr(initData__ht, initData__keyIcon, id)
    endfunction
    function getItemAbi takes item it returns integer
        local integer tid= (LoadInteger(initData__ht, initData__keyId, (GetItemTypeId(it)))) // INLINED!!
        if tid > 0 then
    ...
    function getItemName takes integer id returns string
        local string s= LoadStr(initData__ht, initData__keyName, id)
    ...
    function getItemColor takes integer id returns string
        local string dmgtype= (LoadStr(initData__ht, initData__keyDamageType, (id))) // INLINED!!
        if dmgtype == "魔法" then
            return "|cff1eb1cf"
    ...
    function createItemDummy takes integer uid,location point returns unit
        ...
        set initData__dummy=CreateUnit(udg_player, uid, GetLocationX(point), GetLocationY(point), 270)
        if abi > 0 then
            call UnitAddAbility(initData__dummy, abi)
            call SetUnitAbilityLevel(initData__dummy, abi, udg_itemSpellLevel)
        endif
        if udg_flagShow[id] == false then
            call ShowUnit(initData__dummy, false)
        endif
        call bindingDummyItem(initData__dummy , udg_item)
        //call Debug("cid| unit="+U2S(dummy)+"| abi="+YDWEId2S(abi)+"| lv="+I2S(GetUnitAbilityLevel(dummy, abi)))
        return initData__dummy
    endfunction
    ...
    function itemLevelUp takes unit hero,item tarItem returns nothing
        ...
        loop
            ...
            if itemTemp != null and itemTemp != tarItem then
                ...
                set n=(LoadInteger(initData__ht, initData__keyId, (ownid))) // INLINED!!
...
//library keyBoardMove:
    ...
    function keyBoardMove__DOWN_DEPRESS takes nothing returns nothing
        local integer id= GetPlayerId(( GetTriggerPlayer() )) + 1
        call Debug("_DEPRESS_DOWN")
        set keyBoardMove__DOWNAngle[id]=270
        set keyBoardMove__isMove[id]=keyBoardMove__isMove[id] + 1
        set keyBoardMove__movePulse[id]=10
        call TriggerExecute(keyBoardMove__keyMove)
    endfunction
    function keyBoardMove__DOWN_RELEASE takes nothing returns nothing
        local integer id= GetPlayerId(( GetTriggerPlayer() )) + 1
        call Debug("_RELEASE_DOWN")
        set keyBoardMove__DOWNAngle[id]=- 1
        set keyBoardMove__isMove[id]=keyBoardMove__isMove[id] - 1
        if keyBoardMove__isMove[id] == 0 then
    ...
    function keyBoardMove__LEFT_DEPRESS takes nothing returns nothing
        local integer id= GetPlayerId(( GetTriggerPlayer() )) + 1
        call Debug("_DEPRESS_LEFT")
        set keyBoardMove__LEFTAngle[id]=180
        set keyBoardMove__isMove[id]=keyBoardMove__isMove[id] + 1
        set keyBoardMove__movePulse[id]=10
        call TriggerExecute(keyBoardMove__keyMove)
    endfunction
    function keyBoardMove__LEFT_RELEASE takes nothing returns nothing
        local integer id= GetPlayerId(( GetTriggerPlayer() )) + 1
        call Debug("_RELEASE_LEFT")
        set keyBoardMove__LEFTAngle[id]=- 1
        set keyBoardMove__isMove[id]=keyBoardMove__isMove[id] - 1
        if keyBoardMove__isMove[id] == 0 then
            call IssueImmediateOrder(udg_Heros[id], "stop")
            call MoveLocation(udg_posNextMove[id], GetUnitX(udg_Heros[id]), GetUnitY(udg_Heros[id]))
    ...
    function keyBoardMove__UP_DEPRESS takes nothing returns nothing
        local integer id= GetPlayerId(( GetTriggerPlayer() )) + 1
        call Debug("_DEPRESS_UP")
        set keyBoardMove__UPAngle[id]=90
        set keyBoardMove__isMove[id]=keyBoardMove__isMove[id] + 1
        set keyBoardMove__movePulse[id]=10
        call TriggerExecute(keyBoardMove__keyMove)
    endfunction
    function keyBoardMove__UP_RELEASE takes nothing returns nothing
        local integer id= GetPlayerId(( GetTriggerPlayer() )) + 1
        call Debug("_RELEASE_UP")
        set keyBoardMove__UPAngle[id]=- 1
        set keyBoardMove__isMove[id]=keyBoardMove__isMove[id] - 1
        if keyBoardMove__isMove[id] == 0 then
            call IssueImmediateOrder(udg_Heros[id], "stop")
            call MoveLocation(udg_posNextMove[id], GetUnitX(udg_Heros[id]), GetUnitY(udg_Heros[id]))
    ...
    function keyBoardMove__RIGHT_DEPRESS takes nothing returns nothing
        local integer id= GetPlayerId(( GetTriggerPlayer() )) + 1
        call Debug("_DEPRESS_RIGHT")
        set keyBoardMove__RIGHTAngle[id]=0
        set keyBoardMove__isMove[id]=keyBoardMove__isMove[id] + 1
        set keyBoardMove__movePulse[id]=10
        call TriggerExecute(keyBoardMove__keyMove)
    endfunction
    function keyBoardMove__RIGHT_RELEASE takes nothing returns nothing
        local integer id= GetPlayerId(( GetTriggerPlayer() )) + 1
        call Debug("_RELEASE_RIGHT")
        set keyBoardMove__RIGHTAngle[id]=- 1
        set keyBoardMove__isMove[id]=keyBoardMove__isMove[id] - 1
        if keyBoardMove__isMove[id] == 0 then
            call IssueImmediateOrder(udg_Heros[id], "stop")
            call MoveLocation(udg_posNextMove[id], GetUnitX(udg_Heros[id]), GetUnitY(udg_Heros[id]))
    ...
    function keyBoardMove__catchFilter takes nothing returns boolean
        return keyBoardMove__pick == null and GetWidgetLife(GetFilterItem()) > 0
    endfunction
    function keyBoardMove__catch takes nothing returns nothing
        set keyBoardMove__pick=GetEnumItem()
    endfunction
    function keyBoardMove__move takes nothing returns nothing
        local integer n= 1
        local real sp= 0
        local real x= 0
        local real y= 0
        ...
        loop
            ...
            if keyBoardMove__isMove[n] > 0 then
                set x=GetUnitX(udg_Heros[n])
                set y=GetUnitY(udg_Heros[n])
                call MoveRectTo(r, x, y)
                call EnumItemsInRect(r, Condition(function keyBoardMove__catchFilter), function keyBoardMove__catch)
                if keyBoardMove__pick != null then
                    call IssueTargetOrder(udg_Heros[n], "smart", keyBoardMove__pick)
                    set keyBoardMove__pick=null
                elseif keyBoardMove__movePulse[n] >= 10 then
                    set keyBoardMove__movePulse[n]=0
                    set sp=GetUnitMoveSpeed(udg_Heros[n]) * 1.05
                    
                        if keyBoardMove__LEFTAngle[n] >= 0 then
                            set x=x + sp * CosBJ(keyBoardMove__LEFTAngle[n])
                            set y=y + sp * SinBJ(keyBoardMove__LEFTAngle[n])
                        endif
                        call Debug("LEFT|=" + R2S(keyBoardMove__LEFTAngle[n]))
                    
                        if keyBoardMove__RIGHTAngle[n] >= 0 then
                            set x=x + sp * CosBJ(keyBoardMove__RIGHTAngle[n])
                            set y=y + sp * SinBJ(keyBoardMove__RIGHTAngle[n])
                        endif
                        call Debug("RIGHT|=" + R2S(keyBoardMove__RIGHTAngle[n]))
                    
                        if keyBoardMove__DOWNAngle[n] >= 0 then
                            set x=x + sp * CosBJ(keyBoardMove__DOWNAngle[n])
                            set y=y + sp * SinBJ(keyBoardMove__DOWNAngle[n])
                        endif
                        call Debug("DOWN|=" + R2S(keyBoardMove__DOWNAngle[n]))
                    
                        if keyBoardMove__UPAngle[n] >= 0 then
                            set x=x + sp * CosBJ(keyBoardMove__UPAngle[n])
                            set y=y + sp * SinBJ(keyBoardMove__UPAngle[n])
                        endif
                        call Debug("UP|=" + R2S(keyBoardMove__UPAngle[n]))
                    
                    call IssuePointOrder(udg_Heros[n], "move", x, y)
                endif
                set keyBoardMove__movePulse[n]=keyBoardMove__movePulse[n] + 1
            endif
            set n=n + 1
        endloop
        call RemoveRect(r)
    ...
    function keyBoardMove__init takes nothing returns nothing
        local trigger t
        ...
        call TriggerAddAction(t, function keyBoardMove__LEFT_DEPRESS)
        set t=CreateTrigger()
        ...
        call TriggerAddAction(t, function keyBoardMove__LEFT_RELEASE)
        
            set keyBoardMove__LEFTAngle[1]=- 1
        
            set keyBoardMove__LEFTAngle[2]=- 1
        
            set keyBoardMove__LEFTAngle[3]=- 1
        
            set keyBoardMove__LEFTAngle[4]=- 1
        
            set keyBoardMove__LEFTAngle[5]=- 1
        ...
        call TriggerAddAction(t, function keyBoardMove__RIGHT_DEPRESS)
        set t=CreateTrigger()
        ...
        call TriggerAddAction(t, function keyBoardMove__RIGHT_RELEASE)
        
            set keyBoardMove__RIGHTAngle[1]=- 1
        
            set keyBoardMove__RIGHTAngle[2]=- 1
        
            set keyBoardMove__RIGHTAngle[3]=- 1
        
            set keyBoardMove__RIGHTAngle[4]=- 1
        
            set keyBoardMove__RIGHTAngle[5]=- 1
        ...
        call TriggerAddAction(t, function keyBoardMove__DOWN_DEPRESS)
        set t=CreateTrigger()
        ...
        call TriggerAddAction(t, function keyBoardMove__DOWN_RELEASE)
        
            set keyBoardMove__DOWNAngle[1]=- 1
        
            set keyBoardMove__DOWNAngle[2]=- 1
        
            set keyBoardMove__DOWNAngle[3]=- 1
        
            set keyBoardMove__DOWNAngle[4]=- 1
        
            set keyBoardMove__DOWNAngle[5]=- 1
        ...
        call TriggerAddAction(t, function keyBoardMove__UP_DEPRESS)
        set t=CreateTrigger()
        ...
        call TriggerAddAction(t, function keyBoardMove__UP_RELEASE)
        
            set keyBoardMove__UPAngle[1]=- 1
        
            set keyBoardMove__UPAngle[2]=- 1
        
            set keyBoardMove__UPAngle[3]=- 1
        
            set keyBoardMove__UPAngle[4]=- 1
        
            set keyBoardMove__UPAngle[5]=- 1
        
    
        set keyBoardMove__keyMove=CreateTrigger()
        call TriggerRegisterTimerEventPeriodic(keyBoardMove__keyMove, 0.1)
        call TriggerAddAction(keyBoardMove__keyMove, function keyBoardMove__move)
        set t=null
    endfunction
...
//library rectChange:
        ...
        function rectChange__actions_1 takes nothing returns nothing
        ...
        function rectChange__actions_2 takes nothing returns nothing
            local integer id= GetPlayerId(GetOwningPlayer(GetTriggerUnit())) + 1
            local unit u= GetTriggerUnit()
            if udg_Heros[id] == GetTriggerUnit() and udg_gameTime > 0 then
        ...
        function rectChange__actions_3 takes nothing returns nothing
            local integer id= GetPlayerId(GetOwningPlayer(GetTriggerUnit())) + 1
            local unit u= GetTriggerUnit()
            if udg_Heros[id] == GetTriggerUnit() and udg_gameTime > 0 then
        ...
        function rectChange__actions_4 takes nothing returns nothing
            local integer id= GetPlayerId(GetOwningPlayer(GetTriggerUnit())) + 1
            local unit u= GetTriggerUnit()
            if udg_Heros[id] == GetTriggerUnit() and udg_gameTime > 0 then
        ...
        function rectChange__actions_5 takes nothing returns nothing
            local integer id= GetPlayerId(GetOwningPlayer(GetTriggerUnit())) + 1
            local unit u= GetTriggerUnit()
            if udg_Heros[id] == GetTriggerUnit() and udg_gameTime > 0 then
        ...
        function rectChange__actions_6 takes nothing returns nothing
            local integer id= GetPlayerId(GetOwningPlayer(GetTriggerUnit())) + 1
            local unit u= GetTriggerUnit()
            if udg_Heros[id] == GetTriggerUnit() and udg_gameTime > 0 then
    ...
    function rectChange__rectFix takes nothing returns nothing
        local integer n= 1
        local integer pid= 1
        loop
    ...
    function rectChange__init takes nothing returns nothing
        local trigger new
        local region area
            ...
            call TriggerAddAction(new, function rectChange__actions_1)
            ...
            call TriggerRegisterEnterRegion(new, area, null)
            call TriggerAddAction(new, function rectChange__actions_2)
            //call RemoveRegion(area)
            ...
            call TriggerRegisterEnterRegion(new, area, null)
            call TriggerAddAction(new, function rectChange__actions_3)
            //call RemoveRegion(area)
            ...
            call TriggerRegisterEnterRegion(new, area, null)
            call TriggerAddAction(new, function rectChange__actions_4)
            //call RemoveRegion(area)
            ...
            call TriggerRegisterEnterRegion(new, area, null)
            call TriggerAddAction(new, function rectChange__actions_5)
            //call RemoveRegion(area)
            ...
            call TriggerRegisterEnterRegion(new, area, null)
            call TriggerAddAction(new, function rectChange__actions_6)
            //call RemoveRegion(area)
        
        call TimerStart(rectChange__mtimer, 1, true, function rectChange__rectFix)
        set new=null
        set area=null
    endfunction
...
//library userState:
    function userState__find takes string k returns integer
    ...
    function userState__someEffect takes unit hero,string k,real v returns nothing
        local integer i
        local integer m
        if k == "生命上限" then
        ...
        elseif k == "诅咒反哺" then
            set i=userState__find("伤害增加")
            set m=GetHandleId(hero)
            call SaveReal(userState__ht, m, i, LoadReal(userState__ht, m, i) - v * 5)
        endif
    endfunction
    function getState takes unit u,string k returns real
        
        local integer uid= GetHandleId(u)
        local integer kid= userState__find(k)
        local real v= LoadReal(userState__ht, uid, kid)
    ...
    function addState takes unit u,string k,real v returns nothing
        local integer uid= GetHandleId(u)
        local integer kid= userState__find(k)
        local real ov= LoadReal(userState__ht, uid, kid)
        //call YDUserDataSet(unit, u, k, real, ov + v)
        call userState__someEffect(u , k , v)
        call SaveReal(userState__ht, uid, kid, ov + v)
    ...
    function setState takes unit u,string k,real v returns nothing
        ...
        local integer kid= userState__find(k)
        //call YDUserDataSet(unit, u, k, real, ov + v)
        call SaveReal(userState__ht, uid, kid, v)
...
//library Shock ends
//library YDWEAdvancedUnitDataSystem:
...
function YDWEAdvancedUnitDataSystem__Log takes real x returns real
    local real min= - 88.0
    local real max= 88.0
    local real mid
    local integer i= 20
...
function YDWEGetUnitArmor takes unit u,integer aid returns real
    ...
    if u != null and life >= 0.405 then
        if GetUnitState(u, UNIT_STATE_MAX_LIFE) <= YDWEAdvancedUnitDataSystem__DAMAGE_LIFE then
            call UnitAddAbility(u, aid)
        endif
        if life <= YDWEAdvancedUnitDataSystem__DAMAGE_LIFE then
            call SetWidgetLife(u, YDWEAdvancedUnitDataSystem__DAMAGE_LIFE)
        ...
        call UnitDamageTarget(u, u, YDWEAdvancedUnitDataSystem__DAMAGE_TEST, true, false, ATTACK_TYPE_CHAOS, DAMAGE_TYPE_NORMAL, null)
		call EnableTrigger(yd_DamageEventTrigger)
        set redc=( YDWEAdvancedUnitDataSystem__DAMAGE_TEST - test + GetWidgetLife(u) ) / YDWEAdvancedUnitDataSystem__DAMAGE_TEST
        if enab then
...
//library YDWEAdvancedUnitDataSystem ends
...
//library dotBuff:
    function dotBuff__remove takes integer id returns nothing
        set dotBuff__source[id]=dotBuff__source[dotBuff__max]
        set dotBuff__target[id]=dotBuff__target[dotBuff__max]
        set dotBuff__time[id]=dotBuff__time[dotBuff__max]
        set dotBuff__pass[id]=dotBuff__pass[dotBuff__max]
        set dotBuff__pulse[id]=dotBuff__pulse[dotBuff__max]
        set dotBuff__pulsePass[id]=dotBuff__pulsePass[dotBuff__max]
        set dotBuff__damage[id]=dotBuff__damage[dotBuff__max]
        set dotBuff__damageCast[id]=dotBuff__damageCast[dotBuff__max]
        set dotBuff__damageIcon[id]=dotBuff__damageIcon[dotBuff__max]
        call DestroyEffect(dotBuff__show[id])
        set dotBuff__show[id]=dotBuff__show[dotBuff__max]
        set dotBuff__max=dotBuff__max - 1
    endfunction
    function dotBuff__action takes integer id returns nothing
        set dotBuff__pulsePass[id]=dotBuff__pulsePass[id] + 0.02
        set dotBuff__pass[id]=dotBuff__pass[id] + 0.02
        if GetUnitState(dotBuff__source[id], UNIT_STATE_LIFE) <= 0.5 then
            call dotBuff__remove(id)
            return
        endif
        if GetUnitState(dotBuff__target[id], UNIT_STATE_LIFE) <= 0.5 then
            call dotBuff__remove(id)
            return
        endif
        if dotBuff__pulsePass[id] >= dotBuff__pulse[id] then
            if dotBuff__damageCast[id] != null then
                call SaveStr(YDHT, GetHandleId(dotBuff__source[id]), 0xD5EE3E9B, dotBuff__damageCast[id])
                call SaveStr(YDHT, GetHandleId(dotBuff__source[id]), 0xF4AF2106, dotBuff__damageIcon[id])
            endif
            call UnitDamageTarget((dotBuff__source[id] ), ( dotBuff__target[id] ), (( dotBuff__damage[id] * dotBuff__pulse[id])*1.0), false, false, ATTACK_TYPE_NORMAL, DAMAGE_TYPE_MAGIC, WEAPON_TYPE_WHOKNOWS) // INLINED!!
            set dotBuff__pulsePass[id]=dotBuff__pulsePass[id] - dotBuff__pulse[id]
        endif
        if dotBuff__pass[id] >= dotBuff__time[id] then
            call dotBuff__remove(id)
        endif
    endfunction
    function dotBuff__timed takes nothing returns nothing
        local integer n= 1
        if dotBuff__max > 0 then
            loop
                call dotBuff__action(n)
                exitwhen n >= dotBuff__max
                set n=n + 1
            endloop
        endif
    endfunction
    function dotBuff__init takes nothing returns nothing
        call TimerStart(dotBuff__mtimer, 0.02, true, function dotBuff__timed)
        //call PauseTimer(mtimer)
    endfunction
    function setDotBuffPulse takes integer id,real Cpulse returns nothing
        set dotBuff__pulse[id]=Cpulse
    endfunction
    function setDotBuffEffect takes integer id,string effname,string socket returns nothing
        set dotBuff__show[id]=createEffectTarget(effname , dotBuff__target[id] , socket)
    endfunction
    function setDotBuffDmgTips takes integer id,string cast,string icon returns nothing
        set dotBuff__damageCast[id]=cast
        set dotBuff__damageIcon[id]=icon
    endfunction
    function addDotBuff takes unit Csource,unit Ctarget,real Ctime,real Cdamage returns integer
        set dotBuff__max=dotBuff__max + 1
        set dotBuff__source[dotBuff__max]=Csource
        set dotBuff__target[dotBuff__max]=Ctarget
        set dotBuff__time[dotBuff__max]=Ctime
        set dotBuff__pass[dotBuff__max]=0
        set dotBuff__pulse[dotBuff__max]=1
        set dotBuff__pulsePass[dotBuff__max]=0
        set dotBuff__show[dotBuff__max]=null
        set dotBuff__damage[dotBuff__max]=Cdamage
        set dotBuff__damageCast[dotBuff__max]=null
        set dotBuff__damageIcon[dotBuff__max]=null
        return dotBuff__max
    endfunction
...
//library item:
    ...
    function itemTrgSpell takes integer tarItem returns integer
        local integer id= (LoadInteger(initData__ht, initData__keyId, (tarItem))) // INLINED!!
        //call Debug("itemTrgSpell| item="+YDWEId2S(tarItem)+"| id="+I2S(id))
        return id
    endfunction
    function item__psCount takes unit hero returns real
        local real ps= 0
    ...
    function item__cdCount takes unit hero returns real
        local real cd= 0
        local integer id= ( GetPlayerId(GetOwningPlayer(hero)) + 1 ) * 100
    ...
    function item__abiCount takes unit hero,real cd returns real
        local integer tid= GetItemTypeId(udg_item)
        local integer lv= GetUnitAbilityLevel(hero, 'AB0L')
        if lv > 0 then
            if (LoadStr(initData__ht, initData__keyClass, (tid))) == "发射类" and calculateLuck(hero , lv * 2 + 8) then // INLINED!!
    ...
    function item__spell takes real cd returns nothing
        local trigger func
        ...
        if ( ( udg_int2 > 0 ) ) then
            ...
            set func=item__spellTrigger[udg_int2]
    ...
    function itemCD takes unit hero returns nothing
        ...
        set cd=cd - item__cdCount(hero)
        set ps=ps + item__psCount(hero)
        loop
            ...
            if pause > 0 then
                ...
                if ( ( udg_item != null ) and ( GetWidgetLife(udg_item) < 999.00 ) ) then
                    if nowcd > 0 then
                        ...
                        set nowcd=item__abiCount(hero , GetWidgetLife(udg_item) * cd)
                        set udg_player=GetOwningPlayer(hero)
                        call item__spell(nowcd)
                    endif
    ...
    function item__initTimed takes nothing returns nothing
        call DestroyTimer(GetExpiredTimer())
        
            set item__spellTrigger[1]=gg_trg_ItemSpell_1
            call Debug("initSpellTrigger-[1]-id=" + I2S(GetHandleId(item__spellTrigger[1])))
        
            set item__spellTrigger[2]=gg_trg_ItemSpell_2
            call Debug("initSpellTrigger-[2]-id=" + I2S(GetHandleId(item__spellTrigger[2])))
        
            set item__spellTrigger[3]=gg_trg_ItemSpell_3
            call Debug("initSpellTrigger-[3]-id=" + I2S(GetHandleId(item__spellTrigger[3])))
        
            set item__spellTrigger[4]=gg_trg_ItemSpell_4
            call Debug("initSpellTrigger-[4]-id=" + I2S(GetHandleId(item__spellTrigger[4])))
        
            set item__spellTrigger[5]=gg_trg_ItemSpell_5
            call Debug("initSpellTrigger-[5]-id=" + I2S(GetHandleId(item__spellTrigger[5])))
        
            set item__spellTrigger[6]=gg_trg_ItemSpell_6
            call Debug("initSpellTrigger-[6]-id=" + I2S(GetHandleId(item__spellTrigger[6])))
        
            set item__spellTrigger[7]=gg_trg_ItemSpell_7
            call Debug("initSpellTrigger-[7]-id=" + I2S(GetHandleId(item__spellTrigger[7])))
        
            set item__spellTrigger[8]=gg_trg_ItemSpell_8
            call Debug("initSpellTrigger-[8]-id=" + I2S(GetHandleId(item__spellTrigger[8])))
        
            set item__spellTrigger[9]=gg_trg_ItemSpell_9
            call Debug("initSpellTrigger-[9]-id=" + I2S(GetHandleId(item__spellTrigger[9])))
        
            set item__spellTrigger[10]=gg_trg_ItemSpell_10
            call Debug("initSpellTrigger-[10]-id=" + I2S(GetHandleId(item__spellTrigger[10])))
        
            set item__spellTrigger[11]=gg_trg_ItemSpell_11
            call Debug("initSpellTrigger-[11]-id=" + I2S(GetHandleId(item__spellTrigger[11])))
        
            set item__spellTrigger[12]=gg_trg_ItemSpell_12
            call Debug("initSpellTrigger-[12]-id=" + I2S(GetHandleId(item__spellTrigger[12])))
        
            set item__spellTrigger[13]=gg_trg_ItemSpell_13
            call Debug("initSpellTrigger-[13]-id=" + I2S(GetHandleId(item__spellTrigger[13])))
        
            set item__spellTrigger[14]=gg_trg_ItemSpell_14
            call Debug("initSpellTrigger-[14]-id=" + I2S(GetHandleId(item__spellTrigger[14])))
        
            set item__spellTrigger[15]=gg_trg_ItemSpell_15
            call Debug("initSpellTrigger-[15]-id=" + I2S(GetHandleId(item__spellTrigger[15])))
        
            set item__spellTrigger[16]=gg_trg_ItemSpell_16
            call Debug("initSpellTrigger-[16]-id=" + I2S(GetHandleId(item__spellTrigger[16])))
        
            set item__spellTrigger[17]=gg_trg_ItemSpell_17
            call Debug("initSpellTrigger-[17]-id=" + I2S(GetHandleId(item__spellTrigger[17])))
        
            set item__spellTrigger[18]=gg_trg_ItemSpell_18
            call Debug("initSpellTrigger-[18]-id=" + I2S(GetHandleId(item__spellTrigger[18])))
        
            set item__spellTrigger[19]=gg_trg_ItemSpell_19
            call Debug("initSpellTrigger-[19]-id=" + I2S(GetHandleId(item__spellTrigger[19])))
        
            set item__spellTrigger[20]=gg_trg_ItemSpell_20
            call Debug("initSpellTrigger-[20]-id=" + I2S(GetHandleId(item__spellTrigger[20])))
        
            set item__spellTrigger[21]=gg_trg_ItemSpell_21
            call Debug("initSpellTrigger-[21]-id=" + I2S(GetHandleId(item__spellTrigger[21])))
        
            set item__spellTrigger[22]=gg_trg_ItemSpell_22
            call Debug("initSpellTrigger-[22]-id=" + I2S(GetHandleId(item__spellTrigger[22])))
        
            set item__spellTrigger[23]=gg_trg_ItemSpell_23
            call Debug("initSpellTrigger-[23]-id=" + I2S(GetHandleId(item__spellTrigger[23])))
        
            set item__spellTrigger[24]=gg_trg_ItemSpell_24
            call Debug("initSpellTrigger-[24]-id=" + I2S(GetHandleId(item__spellTrigger[24])))
        
            set item__spellTrigger[25]=gg_trg_ItemSpell_25
            call Debug("initSpellTrigger-[25]-id=" + I2S(GetHandleId(item__spellTrigger[25])))
        
            set item__spellTrigger[26]=gg_trg_ItemSpell_26
            call Debug("initSpellTrigger-[26]-id=" + I2S(GetHandleId(item__spellTrigger[26])))
        
            set item__spellTrigger[27]=gg_trg_ItemSpell_27
            call Debug("initSpellTrigger-[27]-id=" + I2S(GetHandleId(item__spellTrigger[27])))
        
            set item__spellTrigger[28]=gg_trg_ItemSpell_28
            call Debug("initSpellTrigger-[28]-id=" + I2S(GetHandleId(item__spellTrigger[28])))
        
            set item__spellTrigger[29]=gg_trg_ItemSpell_29
            call Debug("initSpellTrigger-[29]-id=" + I2S(GetHandleId(item__spellTrigger[29])))
        
            set item__spellTrigger[30]=gg_trg_ItemSpell_30
            call Debug("initSpellTrigger-[30]-id=" + I2S(GetHandleId(item__spellTrigger[30])))
        
    endfunction
    function item__init takes nothing returns nothing
        local timer t= CreateTimer()
        call TimerStart(t, 1, false, function item__initTimed)
        set t=null
    endfunction

//library item ends
//library reward:
    function reward__roll takes unit hero returns integer
    ...
    function reward__limit takes item it returns nothing
        call SaveBoolean(reward__ht, 'mark', GetHandleId(it), true)
        call Debug("pickLimit = " + T2S(it))
    endfunction
    function reward__isLimit takes item it returns boolean
        return LoadBoolean(reward__ht, 'mark', GetHandleId(it))
    endfunction
    
    function clearRewardLimit takes nothing returns nothing
        call FlushChildHashtable(reward__ht, 'mark')
    endfunction
        ...
        if rarity == "3" then
            loop
                ...
                if pickItem[pick + 1] != null then
                    if (LoadBoolean(reward__ht, 'mark', GetHandleId((pickItem[pick + 1])))) == false then //Max物品位于人造分类 // INLINED!!
if GetItemType(pickItem[pick + 1]) != ITEM_TYPE_ARTIFACT then
                    ...
                    call Debug("pickItem|item=" + T2S(pickItem[pick]) + "|lv=" + I2S(GetItemLevel(pickItem[pick])) + "|limit=" + B2S((LoadBoolean(reward__ht, 'mark', GetHandleId((pickItem[pick])))))) // INLINED!!
                endif
                exitwhen n >= 5
                set n=n + 1
            endloop
            if canUP > 0 then
                set pickId=baseItemList[(LoadInteger(initData__ht, initData__keyId, (GetItemTypeId(pickItem[canUP]))))] // INLINED!!
                call reward__limit(pickItem[canUP])
            elseif pick == 0 then
                set rarity="2"
            else
                set pickId=baseItemList[(LoadInteger(initData__ht, initData__keyId, (GetItemTypeId(pickItem[GetRandomInt(1, pick)]))))] // INLINED!!
            endif
...
//library select:
    ...
    function select__insert takes integer target returns nothing
        set select__pickId=select__pickId + 1
        set select__pickList[select__pickId]=target
        if select__pickId > select__pickMax then
            set select__pickMax=select__pickId
        endif
        //call Debug("add|"+I2S(pickId)+"|="+YDWEId2S(target))
    endfunction
    function select__init takes nothing returns nothing
        
            set select__baseAbiListNum[0]=0
        
            set select__baseAbiListNum[1]=0
        
            set select__baseAbiListNum[2]=0
        
            set select__baseAbiListNum[3]=0
    ...
    function selectPickClear takes unit hero returns nothing
        ...
        local integer n= 1
        loop
            exitwhen n > select__pickMax
            set select__pickList[n]=0
            set n=n + 1
        endloop
        set select__pickMax=0
        
            set uid=LoadInteger(select__ht, GetHandleId(hero), 'oas0' + 1)
            if uid > 0 then
                call RemoveUnitFromStock(hero, uid)
            endif
            call Debug("Load || hero=" + U2S(hero) + " || result=" + YDWEId2S(uid))
        
            set uid=LoadInteger(select__ht, GetHandleId(hero), 'oas0' + 2)
            if uid > 0 then
                call RemoveUnitFromStock(hero, uid)
            endif
            call Debug("Load || hero=" + U2S(hero) + " || result=" + YDWEId2S(uid))
        
            set uid=LoadInteger(select__ht, GetHandleId(hero), 'oas0' + 3)
            if uid > 0 then
                call RemoveUnitFromStock(hero, uid)
            endif
            call Debug("Load || hero=" + U2S(hero) + " || result=" + YDWEId2S(uid))
        
            set uid=LoadInteger(select__ht, GetHandleId(hero), 'oas0' + 4)
            if uid > 0 then
                call RemoveUnitFromStock(hero, uid)
            endif
            call Debug("Load || hero=" + U2S(hero) + " || result=" + YDWEId2S(uid))
    ...
    function oneAbilitySelect takes unit hero,boolean skip returns nothing
        ...
        //选装备升级，没得升就升固有能力，还没得升就治疗
            set select__pickId=0
            set has=0
            
                set l__itemTemp=UnitItemInSlot(hero, 0)
                if l__itemTemp != null then
                    set has=has + 1
                    set hasList[has]=(LoadInteger(initData__ht, initData__keyId, (GetItemTypeId(l__itemTemp)))) // INLINED!!
                    if GetItemLevel(l__itemTemp) < 10 then
                        call select__insert(baseItemList[hasList[has]] + itemDetal)
                    endif
...
set check=true
                        ...
                        endloop
                        if not check then
                            call select__insert(baseItemList[n] + itemDetal)
                        endif
                    else
                        call select__insert(baseItemList[n] + itemDetal)
                    endif
                ...
                loop
                    ...
                    if GetUnitAbilityLevel(hero, abiTemp) > 0 then
                        ...
                        if GetUnitAbilityLevel(hero, abiTemp) < 10 then
                            call select__insert(abiTemp + abiDetal)
                        endif
                    endif
        ...
        if select__pickId > 0 then
             // 'oas0'+id保存添加的购买马甲
set n=GetRandomInt(1, select__pickId) //mathRandom(1, pickId)
                set result[1]=select__pickList[n]
                if result[1] >= ABIUNIT_FRISTID and result[1] <= ABIUNIT_ENDID then
                    set resultLevel[1]=GetUnitAbilityLevel(hero, result[1] - ABIUNIT_FRISTID + ABI_FRISTID) + 1
                        ...
                        if result[1] >= 'p26A' and result[1] < 'p26K' then
                            set resultLevel[1]=result[1] - 'p26A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[1] - itemDetal) != true then
                                set resultLevel[1]=1
                            endif
                        endif
                    
                        if result[1] >= 'p27A' and result[1] < 'p27K' then
                            set resultLevel[1]=result[1] - 'p27A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[1] - itemDetal) != true then
                                set resultLevel[1]=1
                            endif
                        endif
                    
                        if result[1] >= 'p28A' and result[1] < 'p28K' then
                            set resultLevel[1]=result[1] - 'p28A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[1] - itemDetal) != true then
                                set resultLevel[1]=1
                            endif
                        endif
                    
                        if result[1] >= 'p29A' and result[1] < 'p29K' then
                            set resultLevel[1]=result[1] - 'p29A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[1] - itemDetal) != true then
                                set resultLevel[1]=1
                            endif
                        endif
                    
                        if result[1] >= 'p30A' and result[1] < 'p30K' then
                            set resultLevel[1]=result[1] - 'p30A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[1] - itemDetal) != true then
                                set resultLevel[1]=1
                            endif
                        endif
                ...
                set select__pickList[n]=select__pickList[select__pickId]
                set select__pickId=select__pickId - 1
                call SaveInteger(select__ht, GetHandleId(hero), 'oas0' + 1, result[1])
             ...
             // 'oas0'+id保存添加的购买马甲
set n=GetRandomInt(1, select__pickId) //mathRandom(1, pickId)
                set result[2]=select__pickList[n]
                if result[2] >= ABIUNIT_FRISTID and result[2] <= ABIUNIT_ENDID then
                    set resultLevel[2]=GetUnitAbilityLevel(hero, result[2] - ABIUNIT_FRISTID + ABI_FRISTID) + 1
                        ...
                        if result[2] >= 'p26A' and result[2] < 'p26K' then
                            set resultLevel[2]=result[2] - 'p26A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[2] - itemDetal) != true then
                                set resultLevel[2]=1
                            endif
                        endif
                    
                        if result[2] >= 'p27A' and result[2] < 'p27K' then
                            set resultLevel[2]=result[2] - 'p27A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[2] - itemDetal) != true then
                                set resultLevel[2]=1
                            endif
                        endif
                    
                        if result[2] >= 'p28A' and result[2] < 'p28K' then
                            set resultLevel[2]=result[2] - 'p28A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[2] - itemDetal) != true then
                                set resultLevel[2]=1
                            endif
                        endif
                    
                        if result[2] >= 'p29A' and result[2] < 'p29K' then
                            set resultLevel[2]=result[2] - 'p29A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[2] - itemDetal) != true then
                                set resultLevel[2]=1
                            endif
                        endif
                    
                        if result[2] >= 'p30A' and result[2] < 'p30K' then
                            set resultLevel[2]=result[2] - 'p30A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[2] - itemDetal) != true then
                                set resultLevel[2]=1
                            endif
                        endif
                ...
                set select__pickList[n]=select__pickList[select__pickId]
                set select__pickId=select__pickId - 1
                call SaveInteger(select__ht, GetHandleId(hero), 'oas0' + 2, result[2])
             ...
             // 'oas0'+id保存添加的购买马甲
set n=GetRandomInt(1, select__pickId) //mathRandom(1, pickId)
                set result[3]=select__pickList[n]
                if result[3] >= ABIUNIT_FRISTID and result[3] <= ABIUNIT_ENDID then
                    set resultLevel[3]=GetUnitAbilityLevel(hero, result[3] - ABIUNIT_FRISTID + ABI_FRISTID) + 1
                        ...
                        if result[3] >= 'p26A' and result[3] < 'p26K' then
                            set resultLevel[3]=result[3] - 'p26A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[3] - itemDetal) != true then
                                set resultLevel[3]=1
                            endif
                        endif
                    
                        if result[3] >= 'p27A' and result[3] < 'p27K' then
                            set resultLevel[3]=result[3] - 'p27A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[3] - itemDetal) != true then
                                set resultLevel[3]=1
                            endif
                        endif
                    
                        if result[3] >= 'p28A' and result[3] < 'p28K' then
                            set resultLevel[3]=result[3] - 'p28A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[3] - itemDetal) != true then
                                set resultLevel[3]=1
                            endif
                        endif
                    
                        if result[3] >= 'p29A' and result[3] < 'p29K' then
                            set resultLevel[3]=result[3] - 'p29A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[3] - itemDetal) != true then
                                set resultLevel[3]=1
                            endif
                        endif
                    
                        if result[3] >= 'p30A' and result[3] < 'p30K' then
                            set resultLevel[3]=result[3] - 'p30A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[3] - itemDetal) != true then
                                set resultLevel[3]=1
                            endif
                        endif
                ...
                set select__pickList[n]=select__pickList[select__pickId]
                set select__pickId=select__pickId - 1
                call SaveInteger(select__ht, GetHandleId(hero), 'oas0' + 3, result[3])
             ...
             // 'oas0'+id保存添加的购买马甲
set n=GetRandomInt(1, select__pickId) //mathRandom(1, pickId)
                set result[4]=select__pickList[n]
                if result[4] >= ABIUNIT_FRISTID and result[4] <= ABIUNIT_ENDID then
                    set resultLevel[4]=GetUnitAbilityLevel(hero, result[4] - ABIUNIT_FRISTID + ABI_FRISTID) + 1
                        ...
                        if result[4] >= 'p26A' and result[4] < 'p26K' then
                            set resultLevel[4]=result[4] - 'p26A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[4] - itemDetal) != true then
                                set resultLevel[4]=1
                            endif
                        endif
                    
                        if result[4] >= 'p27A' and result[4] < 'p27K' then
                            set resultLevel[4]=result[4] - 'p27A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[4] - itemDetal) != true then
                                set resultLevel[4]=1
                            endif
                        endif
                    
                        if result[4] >= 'p28A' and result[4] < 'p28K' then
                            set resultLevel[4]=result[4] - 'p28A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[4] - itemDetal) != true then
                                set resultLevel[4]=1
                            endif
                        endif
                    
                        if result[4] >= 'p29A' and result[4] < 'p29K' then
                            set resultLevel[4]=result[4] - 'p29A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[4] - itemDetal) != true then
                                set resultLevel[4]=1
                            endif
                        endif
                    
                        if result[4] >= 'p30A' and result[4] < 'p30K' then
                            set resultLevel[4]=result[4] - 'p30A' + 2
                            if YDWEUnitHasItemOfTypeBJNull(hero , result[4] - itemDetal) != true then
                                set resultLevel[4]=1
                            endif
                        endif
                ...
                set select__pickList[n]=select__pickList[select__pickId]
                set select__pickId=select__pickId - 1
                call SaveInteger(select__ht, GetHandleId(hero), 'oas0' + 4, result[4])
    ...
    function oneBloodSelect takes unit hero returns nothing
        ...
        local integer id= GetUnitUserData(hero)
            ...
            call SaveInteger(select__ht, GetHandleId(hero), 'oas0' + 1, result)
            call AddUnitToStock(hero, result, 1, 1)
        
            set result='uk00' + id * ( '0010' - '0000' ) + 2
            call SaveInteger(select__ht, GetHandleId(hero), 'oas0' + 2, result)
            call AddUnitToStock(hero, result, 1, 1)
        
            set result='uk00' + id * ( '0010' - '0000' ) + 3
            call SaveInteger(select__ht, GetHandleId(hero), 'oas0' + 3, result)
            call AddUnitToStock(hero, result, 1, 1)
    ...
    function addBlood takes unit hero,integer id returns nothing
        ...
        call SetUnitUserData(hero, 0)
            ...
            if 'bk71' == addabi then
                set mark=pid * 100 + 71
                set bloodAbilities[pid * 100 + 71]=true
            endif
            
            if 'bk72' == addabi then
                set mark=pid * 100 + 72
                set bloodAbilities[pid * 100 + 72]=true
            endif
            
            if 'bk73' == addabi then
                set mark=pid * 100 + 73
                set bloodAbilities[pid * 100 + 73]=true
            endif
            ...
            if 'bk81' == addabi then
                set mark=pid * 100 + 81
                set bloodAbilities[pid * 100 + 81]=true
            endif
            
            if 'bk82' == addabi then
                set mark=pid * 100 + 82
                set bloodAbilities[pid * 100 + 82]=true
            endif
            
            if 'bk83' == addabi then
                set mark=pid * 100 + 83
                set bloodAbilities[pid * 100 + 83]=true
            endif
...
call addState(hero , "经验倍率" , - 9999)
    ...
    function addBaseAbi takes unit hero,integer id returns nothing
        ...
        if alv == 0 then
            ...
            set select__baseAbiListNum[pid]=select__baseAbiListNum[pid] + 1
            set baseAbiList[pid * 100 + select__baseAbiListNum[pid]]=id
        elseif alv < 10 then
            call SetUnitAbilityLevel(hero, id, alv + 1)
        endif
        call Debug("addBaseAbi| pid=" + I2S(pid) + "| slot=" + I2S(pid * 100 + select__baseAbiListNum[pid]) + "| id=" + YDWEId2S(id))
    endfunction
    function removeBaseAbi takes unit hero,integer slot,integer id returns nothing
        ...
        set baseAbiList[pid * 100 + slot]=baseAbiList[pid * 100 + select__baseAbiListNum[pid]]
        set select__baseAbiListNum[pid]=select__baseAbiListNum[pid] - 1
    endfunction
    function getBaseAbi takes unit hero,integer slot returns integer
        local integer pid= GetPlayerId(GetOwningPlayer(hero))
        local integer aid= 0
        if slot <= select__baseAbiListNum[pid] then
...
//library damage:
    function damageCount takes unit hero,unit target,real dmg,integer itemid returns real
        ...
        local string dmgtype= (LoadStr(initData__ht, initData__keyDamageType, (itemid))) // INLINED!!
        local string lastdmgtype= LoadStr(YDHT, GetHandleId(target), 0x047DB055)
        local integer id= ( GetPlayerId(GetOwningPlayer(hero)) + 1 ) * 100
        local real add= 0
        ...
        call SaveStr(YDHT, GetHandleId(target), 0x047DB055, dmgtype)
        if dmgtype == "精神" then
        ...
        if magicLv > 0 then
            set int=LoadInteger(YDHT, GetHandleId(target), 0x30F1F0FA)
            if dmgtype == "魔法" then
                if int < 10 then
                    call SaveInteger(YDHT, GetHandleId(target), 0x30F1F0FA, int + 1)
                endif
            else
        ...
        if bloodAbilities[id + 71] then
            if LoadInteger(YDHT, GetHandleId(target), 0x46A7DEA0) > 20 then
                set rate=rate + 50
            elseif LoadInteger(YDHT, GetHandleId(target), 0x46A7DEA0) == 20 then
                call createEffectTarget("Abilities\\Spells\\Undead\\Curse\\CurseTarget.mdl" , target , "overhead")
                call SaveInteger(YDHT, GetHandleId(target), 0x46A7DEA0, LoadInteger(YDHT, GetHandleId(target), 0x46A7DEA0) + 1)
            else
                call SaveInteger(YDHT, GetHandleId(target), 0x46A7DEA0, LoadInteger(YDHT, GetHandleId(target), 0x46A7DEA0) + 1)
            endif
        endif
        ...
        if bloodAbilities[id + 73] then
            if dmgtype != lastdmgtype then
                set add=add + IMaxBJ(LoadInteger(YDHT, GetHandleId(target), 0x9FD75675) * 60, 0)
                call SaveInteger(YDHT, GetHandleId(target), 0x9FD75675, LoadInteger(YDHT, GetHandleId(target), 0x9FD75675) + 1)
            else
                call SaveInteger(YDHT, GetHandleId(target), 0x9FD75675, LoadInteger(YDHT, GetHandleId(target), 0x9FD75675) - 2)
            endif
        endif
        if critLv > 0 then
...
//library talent:
    function talentSet takes player p,integer abi,integer lv returns nothing
        ...
        call SaveInteger(talent__ht, pid, abi, lv)
    endfunction
    function talentGet takes player p,integer abi returns integer
        local integer pid= GetPlayerId(p) + 1
        return LoadInteger(talent__ht, pid, abi)
    endfunction
    function talent__add takes integer pid,unit shop returns nothing
        local integer lv= 0
            ...
            if LoadBoolean(talent__ht, pid, 'ta08') == false then
                set lv=LoadInteger(talent__ht, pid, 'ta08')
                call AddUnitToStock(shop, 'ta08', lv + 1, lv + 1)
            endif
        
            if LoadBoolean(talent__ht, pid, 'ta07') == false then
                set lv=LoadInteger(talent__ht, pid, 'ta07')
                call AddUnitToStock(shop, 'ta07', lv + 1, lv + 1)
            endif
        
            if LoadBoolean(talent__ht, pid, 'ta03') == false then
                set lv=LoadInteger(talent__ht, pid, 'ta03')
                call AddUnitToStock(shop, 'ta03', lv + 1, lv + 1)
            endif
        
            if LoadBoolean(talent__ht, pid, 'ta04') == false then
                set lv=LoadInteger(talent__ht, pid, 'ta04')
                call AddUnitToStock(shop, 'ta04', lv + 1, lv + 1)
            endif
        
            if LoadBoolean(talent__ht, pid, 'ta05') == false then
                set lv=LoadInteger(talent__ht, pid, 'ta05')
                call AddUnitToStock(shop, 'ta05', lv + 1, lv + 1)
            endif
        
            if LoadBoolean(talent__ht, pid, 'ta01') == false then
                set lv=LoadInteger(talent__ht, pid, 'ta01')
                call AddUnitToStock(shop, 'ta01', lv + 1, lv + 1)
            endif
        
            if LoadBoolean(talent__ht, pid, 'ta11') == false then
                set lv=LoadInteger(talent__ht, pid, 'ta11')
                call AddUnitToStock(shop, 'ta11', lv + 1, lv + 1)
            endif
        
            if LoadBoolean(talent__ht, pid, 'ta02') == false then
                set lv=LoadInteger(talent__ht, pid, 'ta02')
                call AddUnitToStock(shop, 'ta02', lv + 1, lv + 1)
            endif
        
            if LoadBoolean(talent__ht, pid, 'ta06') == false then
                set lv=LoadInteger(talent__ht, pid, 'ta06')
                call AddUnitToStock(shop, 'ta06', lv + 1, lv + 1)
            endif
        
            if LoadBoolean(talent__ht, pid, 'ta10') == false then
                set lv=LoadInteger(talent__ht, pid, 'ta10')
                call AddUnitToStock(shop, 'ta10', lv + 1, lv + 1)
            endif
        
            if LoadBoolean(talent__ht, pid, 'ta09') == false then
                set lv=LoadInteger(talent__ht, pid, 'ta09')
    ...
    function clearSave takes player p,integer pid returns nothing
        ...
        local integer now= GetPlayerState(p, PLAYER_STATE_RESOURCE_LUMBER)
            ...
            set cost=YDWEGetUnitWoodCost('ta08')
            set lv=talentGet(p , 'ta08')
            set total=total + cost * lv
            call addState(udg_Heros[pid] , LoadStr(talent__ht, pid, 'ta08') , - LoadReal(talent__ht, pid, 'ta08') * lv)
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta08" ) , ( 0)) // INLINED!!
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta08Max" ) , ( 0)) // INLINED!!
            call talentSet(p , 'ta08' , 0)
        
            set cost=YDWEGetUnitWoodCost('ta07')
            set lv=talentGet(p , 'ta07')
            set total=total + cost * lv
            call addState(udg_Heros[pid] , LoadStr(talent__ht, pid, 'ta07') , - LoadReal(talent__ht, pid, 'ta07') * lv)
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta07" ) , ( 0)) // INLINED!!
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta07Max" ) , ( 0)) // INLINED!!
            call talentSet(p , 'ta07' , 0)
        
            set cost=YDWEGetUnitWoodCost('ta03')
            set lv=talentGet(p , 'ta03')
            set total=total + cost * lv
            call addState(udg_Heros[pid] , LoadStr(talent__ht, pid, 'ta03') , - LoadReal(talent__ht, pid, 'ta03') * lv)
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta03" ) , ( 0)) // INLINED!!
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta03Max" ) , ( 0)) // INLINED!!
            call talentSet(p , 'ta03' , 0)
        
            set cost=YDWEGetUnitWoodCost('ta04')
            set lv=talentGet(p , 'ta04')
            set total=total + cost * lv
            call addState(udg_Heros[pid] , LoadStr(talent__ht, pid, 'ta04') , - LoadReal(talent__ht, pid, 'ta04') * lv)
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta04" ) , ( 0)) // INLINED!!
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta04Max" ) , ( 0)) // INLINED!!
            call talentSet(p , 'ta04' , 0)
        
            set cost=YDWEGetUnitWoodCost('ta05')
            set lv=talentGet(p , 'ta05')
            set total=total + cost * lv
            call addState(udg_Heros[pid] , LoadStr(talent__ht, pid, 'ta05') , - LoadReal(talent__ht, pid, 'ta05') * lv)
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta05" ) , ( 0)) // INLINED!!
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta05Max" ) , ( 0)) // INLINED!!
            call talentSet(p , 'ta05' , 0)
        
            set cost=YDWEGetUnitWoodCost('ta01')
            set lv=talentGet(p , 'ta01')
            set total=total + cost * lv
            call addState(udg_Heros[pid] , LoadStr(talent__ht, pid, 'ta01') , - LoadReal(talent__ht, pid, 'ta01') * lv)
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta01" ) , ( 0)) // INLINED!!
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta01Max" ) , ( 0)) // INLINED!!
            call talentSet(p , 'ta01' , 0)
        
            set cost=YDWEGetUnitWoodCost('ta11')
            set lv=talentGet(p , 'ta11')
            set total=total + cost * lv
            call addState(udg_Heros[pid] , LoadStr(talent__ht, pid, 'ta11') , - LoadReal(talent__ht, pid, 'ta11') * lv)
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta11" ) , ( 0)) // INLINED!!
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta11Max" ) , ( 0)) // INLINED!!
            call talentSet(p , 'ta11' , 0)
        
            set cost=YDWEGetUnitWoodCost('ta02')
            set lv=talentGet(p , 'ta02')
            set total=total + cost * lv
            call addState(udg_Heros[pid] , LoadStr(talent__ht, pid, 'ta02') , - LoadReal(talent__ht, pid, 'ta02') * lv)
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta02" ) , ( 0)) // INLINED!!
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta02Max" ) , ( 0)) // INLINED!!
            call talentSet(p , 'ta02' , 0)
        
            set cost=YDWEGetUnitWoodCost('ta06')
            set lv=talentGet(p , 'ta06')
            set total=total + cost * lv
            call addState(udg_Heros[pid] , LoadStr(talent__ht, pid, 'ta06') , - LoadReal(talent__ht, pid, 'ta06') * lv)
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta06" ) , ( 0)) // INLINED!!
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta06Max" ) , ( 0)) // INLINED!!
            call talentSet(p , 'ta06' , 0)
        
            set cost=YDWEGetUnitWoodCost('ta10')
            set lv=talentGet(p , 'ta10')
            set total=total + cost * lv
            call addState(udg_Heros[pid] , LoadStr(talent__ht, pid, 'ta10') , - LoadReal(talent__ht, pid, 'ta10') * lv)
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta10" ) , ( 0)) // INLINED!!
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta10Max" ) , ( 0)) // INLINED!!
            call talentSet(p , 'ta10' , 0)
        
            set cost=YDWEGetUnitWoodCost('ta09')
            set lv=talentGet(p , 'ta09')
            set total=total + cost * lv
            call addState(udg_Heros[pid] , LoadStr(talent__ht, pid, 'ta09') , - LoadReal(talent__ht, pid, 'ta09') * lv)
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta09" ) , ( 0)) // INLINED!!
            call DzAPI_Map_StoreInteger((p ) , "t" + ( "ta09Max" ) , ( 0)) // INLINED!!
            call talentSet(p , 'ta09' , 0)
        
        call SetPlayerState(p, PLAYER_STATE_RESOURCE_LUMBER, now + total)
        call DzAPI_Map_StoreInteger((p ) , "t" + ( "尊贵之血" ) , ( GetPlayerState(p, PLAYER_STATE_RESOURCE_LUMBER))) // INLINED!!
    endfunction
    function talent__clear takes nothing returns nothing
        ...
        if GetSpellAbilityId() == 'ACr1' then
            call clearSave(p , pid)
                ...
                call SaveInteger(talent__ht, pid, 'ta08', 0)
                call SaveStr(talent__ht, pid, 'ta08', null)
                call SaveReal(talent__ht, pid, 'ta08', 0)
                call SaveBoolean(talent__ht, pid, 'ta08', false)
            
                call SaveInteger(talent__ht, pid, 'ta07', 0)
                call SaveStr(talent__ht, pid, 'ta07', null)
                call SaveReal(talent__ht, pid, 'ta07', 0)
                call SaveBoolean(talent__ht, pid, 'ta07', false)
            
                call SaveInteger(talent__ht, pid, 'ta03', 0)
                call SaveStr(talent__ht, pid, 'ta03', null)
                call SaveReal(talent__ht, pid, 'ta03', 0)
                call SaveBoolean(talent__ht, pid, 'ta03', false)
            
                call SaveInteger(talent__ht, pid, 'ta04', 0)
                call SaveStr(talent__ht, pid, 'ta04', null)
                call SaveReal(talent__ht, pid, 'ta04', 0)
                call SaveBoolean(talent__ht, pid, 'ta04', false)
            
                call SaveInteger(talent__ht, pid, 'ta05', 0)
                call SaveStr(talent__ht, pid, 'ta05', null)
                call SaveReal(talent__ht, pid, 'ta05', 0)
                call SaveBoolean(talent__ht, pid, 'ta05', false)
            
                call SaveInteger(talent__ht, pid, 'ta01', 0)
                call SaveStr(talent__ht, pid, 'ta01', null)
                call SaveReal(talent__ht, pid, 'ta01', 0)
                call SaveBoolean(talent__ht, pid, 'ta01', false)
            
                call SaveInteger(talent__ht, pid, 'ta11', 0)
                call SaveStr(talent__ht, pid, 'ta11', null)
                call SaveReal(talent__ht, pid, 'ta11', 0)
                call SaveBoolean(talent__ht, pid, 'ta11', false)
            
                call SaveInteger(talent__ht, pid, 'ta02', 0)
                call SaveStr(talent__ht, pid, 'ta02', null)
                call SaveReal(talent__ht, pid, 'ta02', 0)
                call SaveBoolean(talent__ht, pid, 'ta02', false)
            
                call SaveInteger(talent__ht, pid, 'ta06', 0)
                call SaveStr(talent__ht, pid, 'ta06', null)
                call SaveReal(talent__ht, pid, 'ta06', 0)
                call SaveBoolean(talent__ht, pid, 'ta06', false)
            
                call SaveInteger(talent__ht, pid, 'ta10', 0)
                call SaveStr(talent__ht, pid, 'ta10', null)
                call SaveReal(talent__ht, pid, 'ta10', 0)
                call SaveBoolean(talent__ht, pid, 'ta10', false)
            
                call SaveInteger(talent__ht, pid, 'ta09', 0)
                call SaveStr(talent__ht, pid, 'ta09', null)
                call SaveReal(talent__ht, pid, 'ta09', 0)
                call SaveBoolean(talent__ht, pid, 'ta09', false)
            
            call talent__add(pid , GetTriggerUnit())
        endif
        set p=null
    endfunction
    function talent__pick takes nothing returns nothing
        ...
        local integer level= LoadInteger(talent__ht, pid, pickId) + 1
        local integer max= GetUnitLevel(sell)
        local string userState= LoadStr(talent__ht, pid, pickId)
        local real value= LoadReal(talent__ht, pid, pickId)
        ...
        if level >= max then
            //如果已经满级，则记录一下
            call DzAPI_Map_StoreInteger((Player(pid - 1) ) , "t" + ( YDWEId2S(pickId) + "Max" ) , ( max)) // INLINED!!
            call SaveBoolean(talent__ht, pid, pickId, true)
        endif
        call addState(udg_Heros[pid] , userState , value)
        call SaveInteger(talent__ht, pid, pickId, level)
        ...
        call talent__add(pid , shop)
        set sell=null
        set shop=null
    endfunction
    function talent__init takes nothing returns nothing
        local integer lv= 0
        local integer blood
            ...
            if GetPlayerSlotState(Player(0)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 1, 'ta08', lv)
                call SaveStr(talent__ht, 1, 'ta08', "CD速度")
                call SaveReal(talent__ht, 1, 'ta08', 1.5)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "ta08Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 1, 'ta08', true)
                endif
            ...
            if GetPlayerSlotState(Player(1)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 2, 'ta08', lv)
                call SaveStr(talent__ht, 2, 'ta08', "CD速度")
                call SaveReal(talent__ht, 2, 'ta08', 1.5)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "ta08Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 2, 'ta08', true)
                endif
            ...
            if GetPlayerSlotState(Player(2)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 3, 'ta08', lv)
                call SaveStr(talent__ht, 3, 'ta08', "CD速度")
                call SaveReal(talent__ht, 3, 'ta08', 1.5)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "ta08Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 3, 'ta08', true)
                endif
            ...
            if GetPlayerSlotState(Player(3)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 4, 'ta08', lv)
                call SaveStr(talent__ht, 4, 'ta08', "CD速度")
                call SaveReal(talent__ht, 4, 'ta08', 1.5)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "ta08Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 4, 'ta08', true)
                endif
            ...
            if GetPlayerSlotState(Player(0)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 1, 'ta07', lv)
                call SaveStr(talent__ht, 1, 'ta07', "CD减少")
                call SaveReal(talent__ht, 1, 'ta07', 0.5)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "ta07Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 1, 'ta07', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(0), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(1)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 2, 'ta07', lv)
                call SaveStr(talent__ht, 2, 'ta07', "CD减少")
                call SaveReal(talent__ht, 2, 'ta07', 0.5)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "ta07Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 2, 'ta07', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(2)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 3, 'ta07', lv)
                call SaveStr(talent__ht, 3, 'ta07', "CD减少")
                call SaveReal(talent__ht, 3, 'ta07', 0.5)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "ta07Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 3, 'ta07', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(3)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 4, 'ta07', lv)
                call SaveStr(talent__ht, 4, 'ta07', "CD减少")
                call SaveReal(talent__ht, 4, 'ta07', 0.5)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "ta07Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 4, 'ta07', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(4), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(0)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 1, 'ta03', lv)
                call SaveStr(talent__ht, 1, 'ta03', "拾取范围")
                call SaveReal(talent__ht, 1, 'ta03', 10)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "ta03Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 1, 'ta03', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(0), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(1)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 2, 'ta03', lv)
                call SaveStr(talent__ht, 2, 'ta03', "拾取范围")
                call SaveReal(talent__ht, 2, 'ta03', 10)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "ta03Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 2, 'ta03', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(2)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 3, 'ta03', lv)
                call SaveStr(talent__ht, 3, 'ta03', "拾取范围")
                call SaveReal(talent__ht, 3, 'ta03', 10)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "ta03Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 3, 'ta03', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(3)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 4, 'ta03', lv)
                call SaveStr(talent__ht, 4, 'ta03', "拾取范围")
                call SaveReal(talent__ht, 4, 'ta03', 10)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "ta03Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 4, 'ta03', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(4), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(0)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 1, 'ta04', lv)
                call SaveStr(talent__ht, 1, 'ta04', "经验倍率")
                call SaveReal(talent__ht, 1, 'ta04', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "ta04Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 1, 'ta04', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(0), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(1)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 2, 'ta04', lv)
                call SaveStr(talent__ht, 2, 'ta04', "经验倍率")
                call SaveReal(talent__ht, 2, 'ta04', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "ta04Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 2, 'ta04', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(2)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 3, 'ta04', lv)
                call SaveStr(talent__ht, 3, 'ta04', "经验倍率")
                call SaveReal(talent__ht, 3, 'ta04', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "ta04Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 3, 'ta04', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(3)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 4, 'ta04', lv)
                call SaveStr(talent__ht, 4, 'ta04', "经验倍率")
                call SaveReal(talent__ht, 4, 'ta04', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "ta04Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 4, 'ta04', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(4), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(0)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 1, 'ta05', lv)
                call SaveStr(talent__ht, 1, 'ta05', "伤害增加")
                call SaveReal(talent__ht, 1, 'ta05', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "ta05Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 1, 'ta05', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(0), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(1)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 2, 'ta05', lv)
                call SaveStr(talent__ht, 2, 'ta05', "伤害增加")
                call SaveReal(talent__ht, 2, 'ta05', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "ta05Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 2, 'ta05', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(2)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 3, 'ta05', lv)
                call SaveStr(talent__ht, 3, 'ta05', "伤害增加")
                call SaveReal(talent__ht, 3, 'ta05', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "ta05Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 3, 'ta05', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(3)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 4, 'ta05', lv)
                call SaveStr(talent__ht, 4, 'ta05', "伤害增加")
                call SaveReal(talent__ht, 4, 'ta05', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "ta05Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 4, 'ta05', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(4), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(0)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 1, 'ta01', lv)
                call SaveStr(talent__ht, 1, 'ta01', "生命上限")
                call SaveReal(talent__ht, 1, 'ta01', 25)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "ta01Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 1, 'ta01', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(0), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(1)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 2, 'ta01', lv)
                call SaveStr(talent__ht, 2, 'ta01', "生命上限")
                call SaveReal(talent__ht, 2, 'ta01', 25)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "ta01Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 2, 'ta01', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(2)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 3, 'ta01', lv)
                call SaveStr(talent__ht, 3, 'ta01', "生命上限")
                call SaveReal(talent__ht, 3, 'ta01', 25)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "ta01Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 3, 'ta01', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(3)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 4, 'ta01', lv)
                call SaveStr(talent__ht, 4, 'ta01', "生命上限")
                call SaveReal(talent__ht, 4, 'ta01', 25)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "ta01Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 4, 'ta01', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(4), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(0)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 1, 'ta11', lv)
                call SaveStr(talent__ht, 1, 'ta11', "诅咒反哺")
                call SaveReal(talent__ht, 1, 'ta11', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "ta11Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 1, 'ta11', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(0), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(1)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 2, 'ta11', lv)
                call SaveStr(talent__ht, 2, 'ta11', "诅咒反哺")
                call SaveReal(talent__ht, 2, 'ta11', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "ta11Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 2, 'ta11', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(2)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 3, 'ta11', lv)
                call SaveStr(talent__ht, 3, 'ta11', "诅咒反哺")
                call SaveReal(talent__ht, 3, 'ta11', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "ta11Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 3, 'ta11', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(3)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 4, 'ta11', lv)
                call SaveStr(talent__ht, 4, 'ta11', "诅咒反哺")
                call SaveReal(talent__ht, 4, 'ta11', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "ta11Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 4, 'ta11', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(4), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(0)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 1, 'ta02', lv)
                call SaveStr(talent__ht, 1, 'ta02', "移动速度")
                call SaveReal(talent__ht, 1, 'ta02', 4)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "ta02Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 1, 'ta02', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(0), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(1)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 2, 'ta02', lv)
                call SaveStr(talent__ht, 2, 'ta02', "移动速度")
                call SaveReal(talent__ht, 2, 'ta02', 4)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "ta02Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 2, 'ta02', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(2)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 3, 'ta02', lv)
                call SaveStr(talent__ht, 3, 'ta02', "移动速度")
                call SaveReal(talent__ht, 3, 'ta02', 4)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "ta02Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 3, 'ta02', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(3)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 4, 'ta02', lv)
                call SaveStr(talent__ht, 4, 'ta02', "移动速度")
                call SaveReal(talent__ht, 4, 'ta02', 4)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "ta02Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 4, 'ta02', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(4), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(0)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 1, 'ta06', lv)
                call SaveStr(talent__ht, 1, 'ta06', "暴击几率")
                call SaveReal(talent__ht, 1, 'ta06', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "ta06Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 1, 'ta06', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(0), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(1)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 2, 'ta06', lv)
                call SaveStr(talent__ht, 2, 'ta06', "暴击几率")
                call SaveReal(talent__ht, 2, 'ta06', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "ta06Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 2, 'ta06', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(2)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 3, 'ta06', lv)
                call SaveStr(talent__ht, 3, 'ta06', "暴击几率")
                call SaveReal(talent__ht, 3, 'ta06', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "ta06Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 3, 'ta06', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(3)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 4, 'ta06', lv)
                call SaveStr(talent__ht, 4, 'ta06', "暴击几率")
                call SaveReal(talent__ht, 4, 'ta06', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "ta06Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 4, 'ta06', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(4), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(0)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 1, 'ta10', lv)
                call SaveStr(talent__ht, 1, 'ta10', "吸血鬼领域")
                call SaveReal(talent__ht, 1, 'ta10', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "ta10Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 1, 'ta10', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(0), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(1)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 2, 'ta10', lv)
                call SaveStr(talent__ht, 2, 'ta10', "吸血鬼领域")
                call SaveReal(talent__ht, 2, 'ta10', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "ta10Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 2, 'ta10', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(2)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 3, 'ta10', lv)
                call SaveStr(talent__ht, 3, 'ta10', "吸血鬼领域")
                call SaveReal(talent__ht, 3, 'ta10', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "ta10Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 3, 'ta10', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(3)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 4, 'ta10', lv)
                call SaveStr(talent__ht, 4, 'ta10', "吸血鬼领域")
                call SaveReal(talent__ht, 4, 'ta10', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "ta10Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 4, 'ta10', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(4), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(0)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 1, 'ta09', lv)
                call SaveStr(talent__ht, 1, 'ta09', "重生次数")
                call SaveReal(talent__ht, 1, 'ta09', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "ta09Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 1, 'ta09', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(0) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(0), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(1)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 2, 'ta09', lv)
                call SaveStr(talent__ht, 2, 'ta09', "重生次数")
                call SaveReal(talent__ht, 2, 'ta09', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "ta09Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 2, 'ta09', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(1) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(1), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(2)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 3, 'ta09', lv)
                call SaveStr(talent__ht, 3, 'ta09', "重生次数")
                call SaveReal(talent__ht, 3, 'ta09', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "ta09Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 3, 'ta09', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(2) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(2), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
            ...
            if GetPlayerSlotState(Player(3)) == PLAYER_SLOT_STATE_PLAYING then
                ...
                call SaveInteger(talent__ht, 4, 'ta09', lv)
                call SaveStr(talent__ht, 4, 'ta09', "重生次数")
                call SaveReal(talent__ht, 4, 'ta09', 1)
                //如果已经满级
                if lv > 0 and lv >= (DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "ta09Max"))) then // INLINED!!
                    call SaveBoolean(talent__ht, 4, 'ta09', true)
                endif
                set blood=(DzAPI_Map_GetStoredInteger((Player(3) ) , "t" + ( "尊贵之血"))) // INLINED!!
                call SetPlayerState(Player(3), PLAYER_STATE_RESOURCE_LUMBER, GetPlayerState(Player(4), PLAYER_STATE_RESOURCE_LUMBER) + blood)
            endif
    ...
    function talentCreate takes nothing returns nothing
        ...
        call TriggerAddAction(trg, function talent__clear)
        
        call TriggerAddAction(talent__pickTrg, function talent__pick)
        
            if GetPlayerSlotState(Player(1 - 1)) == PLAYER_SLOT_STATE_PLAYING then
                call talent__add(1 , udg_HerosAltar[1])
                
                    set lv=LoadInteger(talent__ht, 1, 'ta08')
                    call Debug("createTalent| name = ta08| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[1]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 1, 'ta08') + "| level = " + R2S(LoadReal(talent__ht, 1, 'ta08') * lv))
                        call addState(udg_Heros[1] , LoadStr(talent__ht, 1, 'ta08') , LoadReal(talent__ht, 1, 'ta08') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 1, 'ta07')
                    call Debug("createTalent| name = ta07| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[1]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 1, 'ta07') + "| level = " + R2S(LoadReal(talent__ht, 1, 'ta07') * lv))
                        call addState(udg_Heros[1] , LoadStr(talent__ht, 1, 'ta07') , LoadReal(talent__ht, 1, 'ta07') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 1, 'ta03')
                    call Debug("createTalent| name = ta03| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[1]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 1, 'ta03') + "| level = " + R2S(LoadReal(talent__ht, 1, 'ta03') * lv))
                        call addState(udg_Heros[1] , LoadStr(talent__ht, 1, 'ta03') , LoadReal(talent__ht, 1, 'ta03') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 1, 'ta04')
                    call Debug("createTalent| name = ta04| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[1]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 1, 'ta04') + "| level = " + R2S(LoadReal(talent__ht, 1, 'ta04') * lv))
                        call addState(udg_Heros[1] , LoadStr(talent__ht, 1, 'ta04') , LoadReal(talent__ht, 1, 'ta04') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 1, 'ta05')
                    call Debug("createTalent| name = ta05| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[1]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 1, 'ta05') + "| level = " + R2S(LoadReal(talent__ht, 1, 'ta05') * lv))
                        call addState(udg_Heros[1] , LoadStr(talent__ht, 1, 'ta05') , LoadReal(talent__ht, 1, 'ta05') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 1, 'ta01')
                    call Debug("createTalent| name = ta01| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[1]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 1, 'ta01') + "| level = " + R2S(LoadReal(talent__ht, 1, 'ta01') * lv))
                        call addState(udg_Heros[1] , LoadStr(talent__ht, 1, 'ta01') , LoadReal(talent__ht, 1, 'ta01') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 1, 'ta11')
                    call Debug("createTalent| name = ta11| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[1]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 1, 'ta11') + "| level = " + R2S(LoadReal(talent__ht, 1, 'ta11') * lv))
                        call addState(udg_Heros[1] , LoadStr(talent__ht, 1, 'ta11') , LoadReal(talent__ht, 1, 'ta11') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 1, 'ta02')
                    call Debug("createTalent| name = ta02| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[1]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 1, 'ta02') + "| level = " + R2S(LoadReal(talent__ht, 1, 'ta02') * lv))
                        call addState(udg_Heros[1] , LoadStr(talent__ht, 1, 'ta02') , LoadReal(talent__ht, 1, 'ta02') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 1, 'ta06')
                    call Debug("createTalent| name = ta06| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[1]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 1, 'ta06') + "| level = " + R2S(LoadReal(talent__ht, 1, 'ta06') * lv))
                        call addState(udg_Heros[1] , LoadStr(talent__ht, 1, 'ta06') , LoadReal(talent__ht, 1, 'ta06') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 1, 'ta10')
                    call Debug("createTalent| name = ta10| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[1]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 1, 'ta10') + "| level = " + R2S(LoadReal(talent__ht, 1, 'ta10') * lv))
                        call addState(udg_Heros[1] , LoadStr(talent__ht, 1, 'ta10') , LoadReal(talent__ht, 1, 'ta10') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 1, 'ta09')
                    call Debug("createTalent| name = ta09| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[1]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 1, 'ta09') + "| level = " + R2S(LoadReal(talent__ht, 1, 'ta09') * lv))
                        call addState(udg_Heros[1] , LoadStr(talent__ht, 1, 'ta09') , LoadReal(talent__ht, 1, 'ta09') * lv)
                    endif
                
                call TriggerRegisterUnitEvent(talent__pickTrg, udg_HerosAltar[1], EVENT_UNIT_SELL)
                call TriggerRegisterUnitEvent(trg, udg_HerosAltar[1], EVENT_UNIT_SPELL_EFFECT)
            endif
        
            if GetPlayerSlotState(Player(2 - 1)) == PLAYER_SLOT_STATE_PLAYING then
                call talent__add(2 , udg_HerosAltar[2])
                
                    set lv=LoadInteger(talent__ht, 2, 'ta08')
                    call Debug("createTalent| name = ta08| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[2]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 2, 'ta08') + "| level = " + R2S(LoadReal(talent__ht, 2, 'ta08') * lv))
                        call addState(udg_Heros[2] , LoadStr(talent__ht, 2, 'ta08') , LoadReal(talent__ht, 2, 'ta08') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 2, 'ta07')
                    call Debug("createTalent| name = ta07| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[2]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 2, 'ta07') + "| level = " + R2S(LoadReal(talent__ht, 2, 'ta07') * lv))
                        call addState(udg_Heros[2] , LoadStr(talent__ht, 2, 'ta07') , LoadReal(talent__ht, 2, 'ta07') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 2, 'ta03')
                    call Debug("createTalent| name = ta03| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[2]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 2, 'ta03') + "| level = " + R2S(LoadReal(talent__ht, 2, 'ta03') * lv))
                        call addState(udg_Heros[2] , LoadStr(talent__ht, 2, 'ta03') , LoadReal(talent__ht, 2, 'ta03') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 2, 'ta04')
                    call Debug("createTalent| name = ta04| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[2]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 2, 'ta04') + "| level = " + R2S(LoadReal(talent__ht, 2, 'ta04') * lv))
                        call addState(udg_Heros[2] , LoadStr(talent__ht, 2, 'ta04') , LoadReal(talent__ht, 2, 'ta04') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 2, 'ta05')
                    call Debug("createTalent| name = ta05| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[2]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 2, 'ta05') + "| level = " + R2S(LoadReal(talent__ht, 2, 'ta05') * lv))
                        call addState(udg_Heros[2] , LoadStr(talent__ht, 2, 'ta05') , LoadReal(talent__ht, 2, 'ta05') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 2, 'ta01')
                    call Debug("createTalent| name = ta01| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[2]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 2, 'ta01') + "| level = " + R2S(LoadReal(talent__ht, 2, 'ta01') * lv))
                        call addState(udg_Heros[2] , LoadStr(talent__ht, 2, 'ta01') , LoadReal(talent__ht, 2, 'ta01') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 2, 'ta11')
                    call Debug("createTalent| name = ta11| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[2]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 2, 'ta11') + "| level = " + R2S(LoadReal(talent__ht, 2, 'ta11') * lv))
                        call addState(udg_Heros[2] , LoadStr(talent__ht, 2, 'ta11') , LoadReal(talent__ht, 2, 'ta11') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 2, 'ta02')
                    call Debug("createTalent| name = ta02| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[2]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 2, 'ta02') + "| level = " + R2S(LoadReal(talent__ht, 2, 'ta02') * lv))
                        call addState(udg_Heros[2] , LoadStr(talent__ht, 2, 'ta02') , LoadReal(talent__ht, 2, 'ta02') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 2, 'ta06')
                    call Debug("createTalent| name = ta06| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[2]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 2, 'ta06') + "| level = " + R2S(LoadReal(talent__ht, 2, 'ta06') * lv))
                        call addState(udg_Heros[2] , LoadStr(talent__ht, 2, 'ta06') , LoadReal(talent__ht, 2, 'ta06') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 2, 'ta10')
                    call Debug("createTalent| name = ta10| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[2]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 2, 'ta10') + "| level = " + R2S(LoadReal(talent__ht, 2, 'ta10') * lv))
                        call addState(udg_Heros[2] , LoadStr(talent__ht, 2, 'ta10') , LoadReal(talent__ht, 2, 'ta10') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 2, 'ta09')
                    call Debug("createTalent| name = ta09| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[2]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 2, 'ta09') + "| level = " + R2S(LoadReal(talent__ht, 2, 'ta09') * lv))
                        call addState(udg_Heros[2] , LoadStr(talent__ht, 2, 'ta09') , LoadReal(talent__ht, 2, 'ta09') * lv)
                    endif
                
                call TriggerRegisterUnitEvent(talent__pickTrg, udg_HerosAltar[2], EVENT_UNIT_SELL)
                call TriggerRegisterUnitEvent(trg, udg_HerosAltar[2], EVENT_UNIT_SPELL_EFFECT)
            endif
        
            if GetPlayerSlotState(Player(3 - 1)) == PLAYER_SLOT_STATE_PLAYING then
                call talent__add(3 , udg_HerosAltar[3])
                
                    set lv=LoadInteger(talent__ht, 3, 'ta08')
                    call Debug("createTalent| name = ta08| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[3]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 3, 'ta08') + "| level = " + R2S(LoadReal(talent__ht, 3, 'ta08') * lv))
                        call addState(udg_Heros[3] , LoadStr(talent__ht, 3, 'ta08') , LoadReal(talent__ht, 3, 'ta08') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 3, 'ta07')
                    call Debug("createTalent| name = ta07| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[3]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 3, 'ta07') + "| level = " + R2S(LoadReal(talent__ht, 3, 'ta07') * lv))
                        call addState(udg_Heros[3] , LoadStr(talent__ht, 3, 'ta07') , LoadReal(talent__ht, 3, 'ta07') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 3, 'ta03')
                    call Debug("createTalent| name = ta03| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[3]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 3, 'ta03') + "| level = " + R2S(LoadReal(talent__ht, 3, 'ta03') * lv))
                        call addState(udg_Heros[3] , LoadStr(talent__ht, 3, 'ta03') , LoadReal(talent__ht, 3, 'ta03') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 3, 'ta04')
                    call Debug("createTalent| name = ta04| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[3]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 3, 'ta04') + "| level = " + R2S(LoadReal(talent__ht, 3, 'ta04') * lv))
                        call addState(udg_Heros[3] , LoadStr(talent__ht, 3, 'ta04') , LoadReal(talent__ht, 3, 'ta04') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 3, 'ta05')
                    call Debug("createTalent| name = ta05| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[3]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 3, 'ta05') + "| level = " + R2S(LoadReal(talent__ht, 3, 'ta05') * lv))
                        call addState(udg_Heros[3] , LoadStr(talent__ht, 3, 'ta05') , LoadReal(talent__ht, 3, 'ta05') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 3, 'ta01')
                    call Debug("createTalent| name = ta01| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[3]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 3, 'ta01') + "| level = " + R2S(LoadReal(talent__ht, 3, 'ta01') * lv))
                        call addState(udg_Heros[3] , LoadStr(talent__ht, 3, 'ta01') , LoadReal(talent__ht, 3, 'ta01') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 3, 'ta11')
                    call Debug("createTalent| name = ta11| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[3]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 3, 'ta11') + "| level = " + R2S(LoadReal(talent__ht, 3, 'ta11') * lv))
                        call addState(udg_Heros[3] , LoadStr(talent__ht, 3, 'ta11') , LoadReal(talent__ht, 3, 'ta11') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 3, 'ta02')
                    call Debug("createTalent| name = ta02| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[3]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 3, 'ta02') + "| level = " + R2S(LoadReal(talent__ht, 3, 'ta02') * lv))
                        call addState(udg_Heros[3] , LoadStr(talent__ht, 3, 'ta02') , LoadReal(talent__ht, 3, 'ta02') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 3, 'ta06')
                    call Debug("createTalent| name = ta06| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[3]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 3, 'ta06') + "| level = " + R2S(LoadReal(talent__ht, 3, 'ta06') * lv))
                        call addState(udg_Heros[3] , LoadStr(talent__ht, 3, 'ta06') , LoadReal(talent__ht, 3, 'ta06') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 3, 'ta10')
                    call Debug("createTalent| name = ta10| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[3]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 3, 'ta10') + "| level = " + R2S(LoadReal(talent__ht, 3, 'ta10') * lv))
                        call addState(udg_Heros[3] , LoadStr(talent__ht, 3, 'ta10') , LoadReal(talent__ht, 3, 'ta10') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 3, 'ta09')
                    call Debug("createTalent| name = ta09| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[3]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 3, 'ta09') + "| level = " + R2S(LoadReal(talent__ht, 3, 'ta09') * lv))
                        call addState(udg_Heros[3] , LoadStr(talent__ht, 3, 'ta09') , LoadReal(talent__ht, 3, 'ta09') * lv)
                    endif
                
                call TriggerRegisterUnitEvent(talent__pickTrg, udg_HerosAltar[3], EVENT_UNIT_SELL)
                call TriggerRegisterUnitEvent(trg, udg_HerosAltar[3], EVENT_UNIT_SPELL_EFFECT)
            endif
        
            if GetPlayerSlotState(Player(4 - 1)) == PLAYER_SLOT_STATE_PLAYING then
                call talent__add(4 , udg_HerosAltar[4])
                
                    set lv=LoadInteger(talent__ht, 4, 'ta08')
                    call Debug("createTalent| name = ta08| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[4]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 4, 'ta08') + "| level = " + R2S(LoadReal(talent__ht, 4, 'ta08') * lv))
                        call addState(udg_Heros[4] , LoadStr(talent__ht, 4, 'ta08') , LoadReal(talent__ht, 4, 'ta08') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 4, 'ta07')
                    call Debug("createTalent| name = ta07| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[4]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 4, 'ta07') + "| level = " + R2S(LoadReal(talent__ht, 4, 'ta07') * lv))
                        call addState(udg_Heros[4] , LoadStr(talent__ht, 4, 'ta07') , LoadReal(talent__ht, 4, 'ta07') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 4, 'ta03')
                    call Debug("createTalent| name = ta03| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[4]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 4, 'ta03') + "| level = " + R2S(LoadReal(talent__ht, 4, 'ta03') * lv))
                        call addState(udg_Heros[4] , LoadStr(talent__ht, 4, 'ta03') , LoadReal(talent__ht, 4, 'ta03') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 4, 'ta04')
                    call Debug("createTalent| name = ta04| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[4]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 4, 'ta04') + "| level = " + R2S(LoadReal(talent__ht, 4, 'ta04') * lv))
                        call addState(udg_Heros[4] , LoadStr(talent__ht, 4, 'ta04') , LoadReal(talent__ht, 4, 'ta04') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 4, 'ta05')
                    call Debug("createTalent| name = ta05| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[4]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 4, 'ta05') + "| level = " + R2S(LoadReal(talent__ht, 4, 'ta05') * lv))
                        call addState(udg_Heros[4] , LoadStr(talent__ht, 4, 'ta05') , LoadReal(talent__ht, 4, 'ta05') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 4, 'ta01')
                    call Debug("createTalent| name = ta01| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[4]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 4, 'ta01') + "| level = " + R2S(LoadReal(talent__ht, 4, 'ta01') * lv))
                        call addState(udg_Heros[4] , LoadStr(talent__ht, 4, 'ta01') , LoadReal(talent__ht, 4, 'ta01') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 4, 'ta11')
                    call Debug("createTalent| name = ta11| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[4]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 4, 'ta11') + "| level = " + R2S(LoadReal(talent__ht, 4, 'ta11') * lv))
                        call addState(udg_Heros[4] , LoadStr(talent__ht, 4, 'ta11') , LoadReal(talent__ht, 4, 'ta11') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 4, 'ta02')
                    call Debug("createTalent| name = ta02| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[4]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 4, 'ta02') + "| level = " + R2S(LoadReal(talent__ht, 4, 'ta02') * lv))
                        call addState(udg_Heros[4] , LoadStr(talent__ht, 4, 'ta02') , LoadReal(talent__ht, 4, 'ta02') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 4, 'ta06')
                    call Debug("createTalent| name = ta06| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[4]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 4, 'ta06') + "| level = " + R2S(LoadReal(talent__ht, 4, 'ta06') * lv))
                        call addState(udg_Heros[4] , LoadStr(talent__ht, 4, 'ta06') , LoadReal(talent__ht, 4, 'ta06') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 4, 'ta10')
                    call Debug("createTalent| name = ta10| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[4]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 4, 'ta10') + "| level = " + R2S(LoadReal(talent__ht, 4, 'ta10') * lv))
                        call addState(udg_Heros[4] , LoadStr(talent__ht, 4, 'ta10') , LoadReal(talent__ht, 4, 'ta10') * lv)
                    endif
                
                    set lv=LoadInteger(talent__ht, 4, 'ta09')
                    call Debug("createTalent| name = ta09| level = " + I2S(lv) + "| hero = " + U2S(udg_Heros[4]))
                    if lv > 0 then
                        call Debug("getTalent| name = " + LoadStr(talent__ht, 4, 'ta09') + "| level = " + R2S(LoadReal(talent__ht, 4, 'ta09') * lv))
                        call addState(udg_Heros[4] , LoadStr(talent__ht, 4, 'ta09') , LoadReal(talent__ht, 4, 'ta09') * lv)
                    endif
                
                call TriggerRegisterUnitEvent(talent__pickTrg, udg_HerosAltar[4], EVENT_UNIT_SELL)
                call TriggerRegisterUnitEvent(trg, udg_HerosAltar[4], EVENT_UNIT_SPELL_EFFECT)
            endif
...
function CreateNeutralPassiveBuildings takes nothing returns nothing
    ...
    set gg_unit_nech_0026=CreateUnit(p, 'nech', 2304.0, - 3968.0, 270.000)
    set gg_unit_ugrv_0027=CreateUnit(p, 'ugrv', 448.0, 512.0, 270.000)
    set u=CreateUnit(p, 'nbse', 96.0, 736.0, 270.000)
    set u=CreateUnit(p, 'nech', - 11328.0, - 11456.0, 270.000)
    set u=CreateUnit(p, 'nech', - 11392.0, - 11520.0, 270.000)
    set u=CreateUnit(p, 'nech', - 11264.0, - 11584.0, 270.000)
    ...
    set u=CreateUnit(p, 'n000', - 8960.0, - 10752.0, 270.000)
    ...
    set u=CreateUnit(p, 'n000', 8256.0, - 5504.0, 270.000)
    set gg_unit_nech_0063=CreateUnit(p, 'nech', - 1728.0, 7680.0, 270.000)
    set gg_unit_nech_0064=CreateUnit(p, 'nech', - 6784.0, 10496.0, 270.000)
    set gg_unit_nech_0065=CreateUnit(p, 'nech', - 10304.0, - 5888.0, 270.000)
    set gg_unit_nech_0066=CreateUnit(p, 'nech', - 3968.0, - 13952.0, 270.000)
    set gg_unit_nech_0067=CreateUnit(p, 'nech', 6272.0, 6080.0, 270.000)
    set gg_unit_nech_0068=CreateUnit(p, 'nech', 11264.0, 12992.0, 270.000)
    set gg_unit_nech_0069=CreateUnit(p, 'nech', - 2560.0, - 8192.0, 270.000)
    set gg_unit_nech_0070=CreateUnit(p, 'nech', 4800.0, - 9856.0, 270.000)
    set gg_unit_nech_0071=CreateUnit(p, 'nech', - 4096.0, - 3712.0, 270.000)
    set gg_unit_nech_0072=CreateUnit(p, 'nech', - 8832.0, - 1472.0, 270.000)
    ...
    set gg_unit_nech_0096=CreateUnit(p, 'nech', - 11136.0, 6464.0, 270.000)
    set u=CreateUnit(p, 'nbse', - 11808.0, 5536.0, 270.000)
    set u=CreateUnit(p, 'nbse', 928.0, - 11488.0, 270.000)
    set u=CreateUnit(p, 'n000', - 9856.0, - 832.0, 270.000)
    set gg_unit_nech_0101=CreateUnit(p, 'nech', 448.0, - 12480.0, 270.000)
endfunction
//===========================================================================
function CreateNeutralPassive takes nothing returns nothing
    ...
    set gg_unit_nwgt_0050=CreateUnit(p, 'nwgt', - 341.3, 523.6, 313.120)
    ...
    set gg_unit_nwgt_0100=CreateUnit(p, 'nwgt', 444.6, - 314.3, 136.560)
endfunction
//===========================================================================
...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_allMap=Rect(- 15360.0, - 15936.0, 16704.0, 15264.0)
    set gg_rct_BarMap_1=Rect(- 15712.0, 4832.0, 2656.0, 15264.0)
    ...
    call EnableWeatherEffect(we, true)
    set gg_rct_BarMap_6=Rect(256.0, - 16384.0, 16896.0, - 6336.0)
    ...
    set gg_rct_Boss_1=Rect(- 5568.0, 11552.0, - 2656.0, 14784.0)
    ...
    set gg_rct_Boss_7=Rect(- 14880.0, 5152.0, - 12288.0, 7360.0)
    set gg_rct_Boss_8=Rect(2080.0, - 15488.0, 4032.0, - 13728.0)
endfunction
//***************************************************************************
//*
//*  Cameras
...
function addExp takes unit target,real value returns nothing
    ...
    if bloodAbilities[blood_id + 82] then
        if LoadInteger(YDHT, GetHandleId(target), 0xB165EA11) > 20 then
            call addBloodNumber(target , 1)
            call SaveInteger(YDHT, GetHandleId(target), 0xB165EA11, 0)
            call Debug("trg-万物积累==============================")
        else
            call SaveInteger(YDHT, GetHandleId(target), 0xB165EA11, LoadInteger(YDHT, GetHandleId(target), 0xB165EA11) + 1)
        endif
    endif
    if value < 0 then
        return
...
// Trigger: spcUnitTips
//===========================================================================
function Trig_spcUnitTipsFunc014Func001Func001Func001Conditions takes nothing returns nothing
    if ( ( IsUnitType(GetTriggerUnit(), UNIT_TYPE_HERO) == true ) ) then
        call CreateTextTagUnitBJ(LoadStr(YDHT, GetHandleId(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()), 0x6BE5A85C)), 0xF0DBC7A2), LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()), 0x6BE5A85C), 20.00, 10.00, 100, 100, 100, 0)
        call SetTextTagPermanent(bj_lastCreatedTextTag, false)
        call SetTextTagFadepoint(bj_lastCreatedTextTag, 10.00)
        call SetTextTagLifespan(bj_lastCreatedTextTag, 12.00)
        call ShowTextTagForceBJ(true, bj_lastCreatedTextTag, udg_pgroupHeros[GetConvertedPlayerId(GetOwningPlayer(GetTriggerUnit()))])
    else
    endif
endfunction
function Trig_spcUnitTipsFunc014Func001Func002Conditions takes nothing returns nothing
    if ( ( IsUnitType(GetTriggerUnit(), UNIT_TYPE_HERO) == true ) and ( FirstOfGroup(udg_groupDeath) != null ) ) then
        call CreateTextTagUnitBJ("右键点击来引导复活其他吸血鬼的仪式！", LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()), 0x6BE5A85C), 32.00, 12.00, 100, 100, 100, 0)
        call SetTextTagPermanent(bj_lastCreatedTextTag, false)
        call SetTextTagFadepoint(bj_lastCreatedTextTag, 10.00)
        call SetTextTagLifespan(bj_lastCreatedTextTag, 12.00)
        call ShowTextTagForceBJ(true, bj_lastCreatedTextTag, udg_pgroupHeros[GetConvertedPlayerId(GetOwningPlayer(GetTriggerUnit()))])
...
function Trig_spcUnitTipsActions takes nothing returns nothing
    local group ydl_group
    local unit ydl_unit
    local trigger ydl_trigger
    call SaveStr(YDHT, GetHandleId(gg_unit_nech_0026), 0xF0DBC7A2, "山巅竞技场旧址")
    call SaveStr(YDHT, GetHandleId(gg_unit_nech_0063), 0xF0DBC7A2, "请小心，被腐败折磨疯狂的生灵们")
    call SaveStr(YDHT, GetHandleId(gg_unit_nech_0064), 0xF0DBC7A2, "吸血鬼！吸血鬼！")
    call SaveStr(YDHT, GetHandleId(gg_unit_nech_0065), 0xF0DBC7A2, "南方，日出村")
    call SaveStr(YDHT, GetHandleId(gg_unit_nech_0067), 0xF0DBC7A2, "雪山，小心保暖")
    call SaveStr(YDHT, GetHandleId(gg_unit_nech_0068), 0xF0DBC7A2, "折返吧")
    call SaveStr(YDHT, GetHandleId(gg_unit_nech_0069), 0xF0DBC7A2, "峡谷前方，月光林地")
    call SaveStr(YDHT, GetHandleId(gg_unit_nech_0070), 0xF0DBC7A2, "离开吧，蛮人")
    call SaveStr(YDHT, GetHandleId(gg_unit_nech_0071), 0xF0DBC7A2, "路口")
    call SaveStr(YDHT, GetHandleId(gg_unit_nech_0072), 0xF0DBC7A2, "边锋上尉的营寨")
    call SaveStr(YDHT, GetHandleId(gg_unit_nech_0096), 0xF0DBC7A2, "警惕，生命在腐败")
    call SaveStr(YDHT, GetHandleId(gg_unit_nech_0101), 0xF0DBC7A2, "莫要打扰半神")
    ...
    loop
        ...
        if ( ( GetUnitTypeId(ydl_unit) == 'nbse' ) ) then
            set ydl_trigger=CreateTrigger()
            call SaveUnitHandle(YDLOC, GetHandleId(ydl_trigger), 0x6BE5A85C, ydl_unit)
            call TriggerRegisterUnitInRangeSimple(ydl_trigger, 800.00, ydl_unit)
            call TriggerAddCondition(ydl_trigger, Condition(function Trig_spcUnitTipsFunc014Func001Func002Conditions))
        else
            if ( ( GetUnitTypeId(ydl_unit) == 'nech' ) ) then
                set ydl_trigger=CreateTrigger()
                call SaveUnitHandle(YDLOC, GetHandleId(ydl_trigger), 0x6BE5A85C, ydl_unit)
                call TriggerRegisterUnitInRangeSimple(ydl_trigger, 600.00, ydl_unit)
                call TriggerAddCondition(ydl_trigger, Condition(function Trig_spcUnitTipsFunc014Func001Func001Func001Conditions))
            else
            endif
        endif
    endloop
...
//===========================================================================
function InitTrig_spcUnitTips takes nothing returns nothing
    set gg_trg_spcUnitTips=CreateTrigger()
    call TriggerRegisterTimerEventSingle(gg_trg_spcUnitTips, 1.00)
    call TriggerAddAction(gg_trg_spcUnitTips, function Trig_spcUnitTipsActions)
endfunction
//===========================================================================
// Trigger: overShow
//===========================================================================
...
// Trigger: mode
//===========================================================================
function Trig_modeFunc023Func001Func013T takes nothing returns nothing
...
function Trig_modeFunc023Func001Func029T takes nothing returns nothing
...
function Trig_modeFunc023Func001Func030T takes nothing returns nothing
...
function Trig_modeFunc023Func001Func031T takes nothing returns nothing
    call SetUnitLifePercentBJ(LoadUnitHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0x9F0C6E00), 100)
endfunction
function Trig_modeFunc023Conditions takes nothing returns nothing
    local timer ydl_timer
    if ( ( GetClickedButtonBJ() == udg_winGameModeButton[0] ) ) then
        set udg_GameMode=0
        ...
        call SetCameraTargetControllerNoZForPlayer(GetOwningPlayer(udg_hero), udg_hero, 0, 0, false)
        set ydl_timer=CreateTimer()
        call TimerStart(ydl_timer, 0.10, false, function Trig_modeFunc023Func001Func013T)
        ...
        set ydl_timer=CreateTimer()
        call TimerStart(ydl_timer, 30.00, false, function Trig_modeFunc023Func001Func029T)
        set ydl_timer=CreateTimer()
        ...
        call TimerStart(ydl_timer, 0.10, true, function Trig_modeFunc023Func001Func030T)
        set ydl_timer=CreateTimer()
        call SaveUnitHandle(YDLOC, GetHandleId(ydl_timer), 0x9F0C6E00, udg_hero)
        call TimerStart(ydl_timer, 0.10, true, function Trig_modeFunc023Func001Func031T)
    else
        set bj_forLoopAIndex=1
...
function Trig_modeActions takes nothing returns nothing
 ...
 exitwhen true //()
    ...
    set udg_winGameModeButton[5]=DialogAddButton(udg_winGameMode, "吸血鬼必须死[5]", '5')
    set udg_strGameMode[5]="已选择当前难度|cff00ff00[吸血鬼必须死]|r：吸血鬼获得的治疗将为0，敌人移动速度将更快，玩家受到的伤害将更高，玩家造成伤害将更低"
    set udg_int=0
    set bj_forLoopAIndex=1
    set bj_forLoopAIndexEnd=4
    loop
    ...
    set ydl_trigger=CreateTrigger()
    call TriggerRegisterDialogEvent(ydl_trigger, udg_winGameMode)
    call TriggerAddCondition(ydl_trigger, Condition(function Trig_modeFunc023Conditions))
    set ydl_trigger=null
endfunction
//===========================================================================
...
function Trig_initFunc007Func004A takes nothing returns nothing
    set udg_hero=GetEnumUnit()
...
function Trig_initActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    ...
    if ( ( GetTriggerExecCount(GetTriggeringTrigger()) == 27 ) ) then
        ...
        call ClearSelection()
        call ForGroupBJ(udg_groupHero, function Trig_initFunc007Func004A)
    else
    endif
...
// Trigger: bossRect
//===========================================================================
function Trig_bossRectFunc041Func015T takes nothing returns nothing
    call SetUnitTimeScale(LoadUnitHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0x1900CCFD), 0.00)
endfunction
function Trig_bossRectFunc041Func017Func015T takes nothing returns nothing
...
function Trig_bossRectFunc041Func017Conditions takes nothing returns nothing
    local timer ydl_timer
    ...
    call TimerStart(ydl_timer, 9.00, false, function Trig_bossRectFunc041Func017Func015T)
    call FlushChildHashtable(YDLOC, GetHandleId(GetTriggeringTrigger()))
    call DestroyTrigger(GetTriggeringTrigger())
    set ydl_timer=null
endfunction
function Trig_bossRectFunc042Conditions takes nothing returns nothing
...
function Trig_bossRectActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    ...
    call SaveLocationHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xED070B7B + ( 7 ), GetRectCenter(gg_rct_Boss_7))
    call SaveLocationHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xED070B7B + ( 8 ), GetRectCenter(gg_rct_Boss_8))
    ...
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xD34074AD + ( 7 ), 'ur07')
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xD34074AD + ( 8 ), 'ur08')
    ...
    call SaveUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5F8B9FBC + ( 7 ), gg_unit_nwgt_0050)
    call SaveUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5F8B9FBC + ( 8 ), gg_unit_nwgt_0100)
    ...
    call SaveUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xB5F4F979 + ( 71 ), gg_unit_nech_0064)
    call SaveUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xB5F4F979 + ( 72 ), gg_unit_nech_0096)
    call SaveUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xB5F4F979 + ( 81 ), gg_unit_nech_0069)
    call SaveUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xB5F4F979 + ( 82 ), gg_unit_nech_0101)
    set bj_forLoopAIndex=1
    set bj_forLoopAIndexEnd=8
    loop
        exitwhen bj_forLoopAIndex > bj_forLoopAIndexEnd
        ...
        call TimerStart(ydl_timer, 0.01, false, function Trig_bossRectFunc041Func015T)
        ...
        call TriggerAddCondition(ydl_trigger, Condition(function Trig_bossRectFunc041Func017Conditions))
        set bj_forLoopAIndex=bj_forLoopAIndex + 1
    endloop
    set ydl_trigger=CreateTrigger()
    call TriggerRegisterUnitEvent(ydl_trigger, gg_unit_ugrv_0027, EVENT_UNIT_SELL)
    call TriggerAddCondition(ydl_trigger, Condition(function Trig_bossRectFunc042Conditions))
...
function Trig_ItemSpell_24Func002T takes nothing returns nothing
    if ( ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x2970F80D) == 0 ) ) then
        ...
        if ( ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x891AB8C4) == 'I24K' ) ) then
            ...
            call moverLineHited(udg_int , 175 , udg_real , "敌方" , 6)
        endif
...
//===========================================================================
// Trigger: ItemSpell-26
//===========================================================================
function Trig_ItemSpell_26Actions takes nothing returns nothing
    local group ydl_group
    local unit ydl_unit
    set udg_unitType='e000'
    set udg_dummy=createItemDummy(udg_unitType , udg_point)
...
//===========================================================================
function InitTrig_ItemSpell_26 takes nothing returns nothing
    set gg_trg_ItemSpell_26=CreateTrigger()
    call TriggerAddAction(gg_trg_ItemSpell_26, function Trig_ItemSpell_26Actions)
endfunction
//===========================================================================
// Trigger: ItemSpell-27
//===========================================================================
function Trig_ItemSpell_27Func004T takes nothing returns nothing
    set udg_point=GetUnitLoc(LoadUnitHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0xE6E64075))
    set udg_point2=PolarProjectionBJ(udg_point, GetRandomReal(150.00, 800.00), GetRandomDirectionDeg())
    call IssuePointOrderLoc(LoadUnitHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0x535B7E08), "blizzard", udg_point2)
    call RemoveLocation(udg_point)
    call RemoveLocation(udg_point2)
    if ( ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x2970F80D) == 0 ) ) then
        call UnitApplyTimedLife(LoadUnitHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0x535B7E08), 'BHwe', 0.10)
        call FlushChildHashtable(YDLOC, GetHandleId(GetExpiredTimer()))
        call DestroyTimer(GetExpiredTimer())
    else
        call SaveInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x2970F80D, ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x2970F80D) - 1 ))
...
function Trig_ItemSpell_27Actions takes nothing returns nothing
    local timer ydl_timer
    local integer ydl_localvar_step= LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76)
 set ydl_localvar_step=ydl_localvar_step + 3
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76, ydl_localvar_step)
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    set udg_unitType='e00D'
    set udg_dummy=createItemDummy(udg_unitType , udg_point)
    call SaveReal(YDHT, GetHandleId(udg_item), 0x9190F110, 2.00)
    set ydl_timer=CreateTimer()
    call SaveUnitHandle(YDLOC, GetHandleId(ydl_timer), 0xE6E64075, udg_hero)
    call SaveUnitHandle(YDLOC, GetHandleId(ydl_timer), 0x535B7E08, udg_dummy)
    call SaveInteger(YDLOC, GetHandleId(ydl_timer), 0x2970F80D, 5)
    call TimerStart(ydl_timer, 0.40, true, function Trig_ItemSpell_27Func004T)
    call FlushChildHashtable(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step)
    set ydl_timer=null
endfunction
//===========================================================================
function InitTrig_ItemSpell_27 takes nothing returns nothing
    set gg_trg_ItemSpell_27=CreateTrigger()
    call TriggerAddAction(gg_trg_ItemSpell_27, function Trig_ItemSpell_27Actions)
endfunction
//===========================================================================
// Trigger: ItemSpell-28
//===========================================================================
function Trig_ItemSpell_28Actions takes nothing returns nothing
    set udg_real=lifeCount(udg_hero , 3)
    call SaveReal(YDHT, GetHandleId(udg_item), 0x9190F110, udg_real)
    set udg_unitType='e00Z'
    set udg_dummy=createItemDummy(udg_unitType , udg_point)
    if ( ( triType == 'I28K' ) ) then
        call AroundUwithU(udg_dummy , udg_hero , 0 , 0 , udg_real)
    else
    endif
    call UnitApplyTimedLife(udg_dummy, 'BTLF', udg_real)
    call SetUnitTimeScale(udg_dummy, ( 4.50 / udg_real ))
    call SaveItemHandle(YDHT, GetHandleId(udg_dummy), 0x53A92F9D, udg_item)
    call IssueImmediateOrder(udg_dummy, "starfall")
endfunction
//===========================================================================
function InitTrig_ItemSpell_28 takes nothing returns nothing
    set gg_trg_ItemSpell_28=CreateTrigger()
    call TriggerAddAction(gg_trg_ItemSpell_28, function Trig_ItemSpell_28Actions)
endfunction
//===========================================================================
// Trigger: ItemSpell-29
//===========================================================================
function Trig_ItemSpell_29Func010T takes nothing returns nothing
    local group ydl_group
    local unit ydl_unit
    set udg_dummy=LoadUnitHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0x535B7E08)
    if ( ( LoadReal(YDLOC, GetHandleId(GetExpiredTimer()), 0x6B54C545) <= 0.00 ) ) then
        call DestroyGroup(LoadGroupHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0x9E80183F))
        set ydl_group=null
        set ydl_unit=null
        return
        call FlushChildHashtable(YDLOC, GetHandleId(GetExpiredTimer()))
        ...
        call SaveReal(YDLOC, GetHandleId(GetExpiredTimer()), 0x6B54C545, ( LoadReal(YDLOC, GetHandleId(GetExpiredTimer()), 0x6B54C545) - LoadReal(YDLOC, GetHandleId(GetExpiredTimer()), 0xF94CE803) ))
    endif
    if ( ( IsUnitDeadBJ(udg_dummy) == true ) ) then
        call DestroyGroup(LoadGroupHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0x9E80183F))
        set ydl_group=null
        set ydl_unit=null
        return
    ...
    set ydl_group=CreateGroup()
    call GroupEnumUnitsInRange(ydl_group, GetUnitX(udg_dummy), GetUnitY(udg_dummy), 800.00, null)
    loop
        set ydl_unit=FirstOfGroup(ydl_group)
        exitwhen ydl_unit == null
        call GroupRemoveUnit(ydl_group, ydl_unit)
        set udg_unit=ydl_unit
        if ( ( IsUnitEnemy(udg_unit, GetOwningPlayer(udg_dummy)) == true ) and ( IsUnitInGroup(udg_unit, LoadGroupHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0x9E80183F)) == false ) ) then
            call GroupAddUnit(LoadGroupHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0x9E80183F), udg_unit)
            call IssueTargetOrder(udg_dummy, "fingerofdeath", udg_unit)
            set udg_int=LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x7A4DAD1D)
            set udg_int2=addDotBuff(udg_dummy , udg_unit , 8 , 0 + udg_int * 50)
            call setDotBuffEffect(udg_int2 , "Abilities\\Spells\\Other\\Drain\\DrainTarget.mdl" , "head")
            set ydl_group=null
            set ydl_unit=null
            return
        else
...
function Trig_ItemSpell_29Actions takes nothing returns nothing
    local timer ydl_timer
    local integer ydl_localvar_step= LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76)
 set ydl_localvar_step=ydl_localvar_step + 3
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76, ydl_localvar_step)
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    set udg_real=lifeCount(udg_hero , 8)
    call SaveReal(YDHT, GetHandleId(udg_item), 0x9190F110, udg_real)
    set udg_unitType='e010'
    set udg_dummy=createItemDummy(udg_unitType , udg_point)
    call AroundUwithU(udg_dummy , udg_hero , 0 , 0 , udg_real)
    call UnitApplyTimedLife(udg_dummy, 'BTLF', ( udg_real + 8.00 ))
    call SetUnitTimeScale(udg_dummy, 0.40)
    call SaveItemHandle(YDHT, GetHandleId(udg_dummy), 0x53A92F9D, udg_item)
    if ( ( triType == 'I29K' ) ) then
        set udg_real2=0.50
    else
        set udg_real2=1.00
    endif
    set ydl_timer=CreateTimer()
    call SaveUnitHandle(YDLOC, GetHandleId(ydl_timer), 0x535B7E08, udg_dummy)
    call SaveGroupHandle(YDLOC, GetHandleId(ydl_timer), 0x9E80183F, CreateGroup())
    call SaveInteger(YDLOC, GetHandleId(ydl_timer), 0x7A4DAD1D, udg_itemSpellLevel)
    call SaveReal(YDLOC, GetHandleId(ydl_timer), 0x6B54C545, udg_real)
    call SaveReal(YDLOC, GetHandleId(ydl_timer), 0xF94CE803, udg_real2)
    call TimerStart(ydl_timer, udg_real2, true, function Trig_ItemSpell_29Func010T)
    call FlushChildHashtable(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step)
    set ydl_timer=null
endfunction
//===========================================================================
function InitTrig_ItemSpell_29 takes nothing returns nothing
    set gg_trg_ItemSpell_29=CreateTrigger()
    call TriggerAddAction(gg_trg_ItemSpell_29, function Trig_ItemSpell_29Actions)
endfunction
//===========================================================================
// Trigger: ItemCD
//===========================================================================
...
set udg_bossTypeTotal=udg_bossTypeTotal + 1
        set udg_armySpcType[n]='us00' + n - 1 //注册刷新的特殊怪，按照id排序
set udg_armySpcTypeTotal=udg_armySpcTypeTotal + 1
        exitwhen n >= 7
    endloop
...
function Trig_refreshActions takes nothing returns nothing
    ...
    loop
        ...
        if ( ( udg_gameTime > 1 ) and ( ModuloInteger(udg_gameTime, 240) == 0 ) ) then
            set udg_hero=udg_Heros[udg_int]
            if ( ( ( udg_hero == null ) or ( IsUnitAliveBJ(udg_hero) == false ) ) ) then
                set udg_hero=GroupPickRandomUnit(udg_groupHero)
            else
            ...
            set udg_int2=GetConvertedPlayerId(GetOwningPlayer(udg_hero))
            set udg_point=getAPassPoint(udg_rectNowRefresh[udg_int2])
            set udg_unit=CreateUnit(udg_player, udg_armySpcType[GetRandomInt(1, 3)], GetLocationX(udg_point), GetLocationY(udg_point), 0)
            call SaveUnitHandle(YDHT, GetHandleId(udg_unit), 0x1EC89548, udg_hero)
            call SetUnitMoveSpeed(udg_unit, ( GetUnitMoveSpeed(udg_unit) + ( ( I2R(udg_GameMode) - 1.00 ) * 10.00 ) ))
            if ( ( udg_GameMode >= 3 ) ) then
                call UnitAddAbility(udg_unit, 'AItx')
...
function Trig_reward_armyFunc009Func002T takes nothing returns nothing
...
function Trig_reward_armyFunc012Func006T takes nothing returns nothing
    call SaveReal(YDLOC, GetHandleId(GetExpiredTimer()), 0xFB6E8B46, ( ( LoadReal(YDLOC, GetHandleId(GetExpiredTimer()), 0x47527379) / LoadReal(YDLOC, GetHandleId(GetExpiredTimer()), 0x6B54C545) ) * 0.02 ))
    call SetUnitX(LoadUnitHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0x535B7E08), ( ( GetUnitX(LoadUnitHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0x535B7E08)) ) + ( LoadReal(YDLOC, GetHandleId(GetExpiredTimer()), 0xFB6E8B46) ) * ( CosBJ(LoadReal(YDLOC, GetHandleId(GetExpiredTimer()), 0x9966AD24)) ) ))
    call SetUnitY(LoadUnitHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0x535B7E08), ( ( GetUnitY(LoadUnitHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0x535B7E08)) ) + ( LoadReal(YDLOC, GetHandleId(GetExpiredTimer()), 0xFB6E8B46) ) * ( SinBJ(LoadReal(YDLOC, GetHandleId(GetExpiredTimer()), 0x9966AD24)) ) ))
    call SaveReal(YDLOC, GetHandleId(GetExpiredTimer()), 0x014E1344, ( LoadReal(YDLOC, GetHandleId(GetExpiredTimer()), 0x014E1344) + 0.02 ))
...
function Trig_reward_armyActions takes nothing returns nothing
 ...
 exitwhen true //()
    ...
    if ( ( calculateLuck(udg_hero , 2) ) and ( bloodAbilities[( GetPlayerId(GetOwningPlayer(udg_hero)) + 1 ) * 100 + 83] ) ) then
    ...
    if ( ( GetRandomInt(1, 1000) > 500 ) ) then
        ...
        if ( ( GetRandomInt(1, 1000) < ( 50 - ( udg_GameMode * 10 ) ) ) ) then
            set udg_dummy=CreateUnitAtLoc(Player(PLAYER_NEUTRAL_PASSIVE), 'e002', udg_point2, 0)
            call UnitApplyTimedLife(udg_dummy, 'BHwe', 300.00)
        else
        endif
    endif
    if ( ( udg_dummy != null ) ) then
        ...
        call TimerStart(ydl_timer, 0.02, true, function Trig_reward_armyFunc009Func002T)
    else
    endif
    call RemoveLocation(udg_point2)
    set udg_point2=OffsetLocation(udg_point, GetRandomReal(- 100.00, 100.00), GetRandomReal(- 100.00, 100.00))
    if ( ( GetRandomInt(1, 1000) <= 250 ) ) then
        ...
        call SaveReal(YDLOC, GetHandleId(ydl_timer), 0xFB6E8B46, LoadReal(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xFB6E8B46))
        call TimerStart(ydl_timer, 0.02, true, function Trig_reward_armyFunc012Func006T)
    else
        if ( ( GetRandomInt(1, 1000) < 3 ) ) then
...
function Trig_reward_useSelectActions takes nothing returns nothing
    ...
    set udg_hero=GetTriggerUnit()
    set udg_dummy=GetSoldUnit()
    if ( ( GetUnitTypeId(udg_dummy) >= 'uk00' and GetUnitTypeId(udg_dummy) <= ( 'uk90' ) ) ) then
        ...
        if ( ( GetUnitTypeId(udg_dummy) >= ABIUNIT_FRISTID and GetUnitTypeId(udg_dummy) <= ABIUNIT_ENDID ) ) then
            ...
            if ( ( udg_flag == false ) ) then
                ...
                set udg_int=(LoadInteger(initData__ht, initData__keyId, (udg_int))) // INLINED!!
...
function Trig_blood_dmgActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    ...
    if ( ( (LoadStr(initData__ht, initData__keyClass, (GetItemTypeId(udg_item)))) == "场地类" ) and ( GetUnitAbilityLevel(udg_hero, 'AB0M') > 0 ) ) then // INLINED!!
...
function Trig_blood_killActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    ...
    if ( ( bloodAbilities[udg_int * 100 + 11] ) and ( calculateLuck(udg_hero , 20) ) ) then
        ...
        set udg_real=( ( I2R(GetHeroLevel(udg_hero)) ) * ( 5.00 ) + ( 180.00 ) )
        set ydl_group=CreateGroup()
        ...
        if ( ( udg_eggs_reward[LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0xEEBCF22A)] != 'ches' ) ) then
            if ( ( udg_eggs_reward[LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0xEEBCF22A)] == 'k3m3' ) ) then
                ...
                if ( ( udg_eggs_reward[LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0xEEBCF22A)] == 'mort' ) ) then
                    set udg_item=CreateItem(GetRandomInt(ABIITEM_FRISTID, ABIITEM_ENDID), GetUnitX(LoadUnitHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0xB6A6EBAA)), GetUnitY(LoadUnitHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0xB6A6EBAA)))
                else
...
function Trig_saveData_dmgActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    if ( ( GetOwningPlayer(GetTriggerUnit()) != GetOwningPlayer(GetEventDamageSource()) ) and ( GetPlayerController(GetOwningPlayer(GetEventDamageSource())) == MAP_CONTROL_USER ) and ( GetEventDamage() > 2.00 ) ) then
        ...
        call SaveStr(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x3EBAB032, (LoadStr(initData__ht, initData__keyIcon, (udg_itemType)))) // INLINED!!
...
function Trig_YDWEINITConditions takes nothing returns boolean
    return ( ( YDWEUnitHasItemOfTypeBJNull(GetTriggerUnit() , 'texp') == true ) and ( YDWEGetUnitWoodCost('hfoo') == 0 ) )
endfunction
...
function Trig_gmActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    ...
    if ( ( GetEventPlayerChatString() == "-cs" ) ) then
        call clearSave(GetTriggerPlayer() , 1)
    else
    endif
    ...
    if ( ( GetEventPlayerChatString() == "-tid" ) ) then
        ...
        call Debug((LoadStr(initData__ht, initData__keyClass, (udg_itemType)))) // INLINED!!
        call Debug((LoadStr(initData__ht, initData__keyDamageType, (udg_itemType)))) // INLINED!!
    else
    endif
    if ( ( SubString(GetEventPlayerChatString(), 0, 3) == "-kb" ) ) then
        set udg_int=GetConvertedPlayerId(GetTriggerPlayer())
        set udg_hero=udg_Heros[udg_int]
        set udg_int2=S2I(SubString(GetEventPlayerChatString(), 3, StringLength(GetEventPlayerChatString())))
...
//===========================================================================
// Trigger: ItemSpell-30
//===========================================================================
function Trig_ItemSpell_30Actions takes nothing returns nothing
    local group ydl_group
    local unit ydl_unit
    local integer ydl_localvar_step= LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76)
 set ydl_localvar_step=ydl_localvar_step + 3
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    set udg_unitType='e000'
    set udg_dummy=createItemDummy(udg_unitType , udg_point)
    call UnitApplyTimedLife(udg_dummy, 'BTLF', 0.10)
    call SaveItemHandle(YDHT, GetHandleId(udg_dummy), 0x53A92F9D, udg_item)
    set ydl_group=CreateGroup()
    call GroupEnumUnitsInRange(ydl_group, GetUnitX(udg_dummy), GetUnitY(udg_dummy), 800.00, null)
    loop
        ...
        call GroupRemoveUnit(ydl_group, ydl_unit)
        set udg_unit=ydl_unit
        if ( ( IsUnitEnemy(udg_unit, GetOwningPlayer(udg_dummy)) == true ) and ( IsUnitType(ydl_unit, UNIT_TYPE_SAPPER) == false ) and ( IsUnitType(ydl_unit, UNIT_TYPE_TAUREN) == false ) ) then
            call GroupAddUnit(LoadGroupHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x9E80183F), udg_unit)
            call IssueTargetOrder(udg_dummy, "fingerofdeath", udg_unit)
            call FlushChildHashtable(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step)
            set ydl_group=null
            set ydl_unit=null
...
//===========================================================================
function InitTrig_ItemSpell_30 takes nothing returns nothing
    set gg_trg_ItemSpell_30=CreateTrigger()
    call TriggerAddAction(gg_trg_ItemSpell_30, function Trig_ItemSpell_30Actions)
endfunction
//===========================================================================
function InitCustomTriggers takes nothing returns nothing
    call InitTrig_spcUnitTips()
    ...
    call InitTrig_ItemSpell_26()
    call InitTrig_ItemSpell_27()
    call InitTrig_ItemSpell_28()
    call InitTrig_ItemSpell_29()
...
call ExecuteFunc("Tips__init")
call ExecuteFunc("YDTriggerSaveLoadSystem__Init")
call ExecuteFunc("InitializeYD")
call ExecuteFunc("baseSystem__init")
call ExecuteFunc("keyBoardMove__init")
call ExecuteFunc("rectChange__init")
...
call ExecuteFunc("dotBuff__init")
call ExecuteFunc("item__init")
call ExecuteFunc("select__init")
call ExecuteFunc("treeShow___init")
call ExecuteFunc("talent__init")
