...
local baseSkill = {
    ...
    ['AB0I'] = {
        ...
        DataA = {20, 200},
        Tip = [=[ - [|cffffcc00等级 *lv|r]]=],
        Ubertip = [[获得5%的暴击几率，额外提高暴击伤害，初始暴击伤害为150%|n|n暴击伤害：|cff89D5FF<*id,DataA*lv>%|r]],
        targs = {"nonhero,self"},
        Buttonpos_1 = 0,
        Buttonpos_2 = 2,
        targetArt = [[]],
    ...
    ['AB0J'] = {
        ...
        DataA = {1, 10},
        Tip = [=[ - [|cffffcc00等级 *lv|r]]=],
        Ubertip = [[每当击杀1个敌人获得治疗|n|n治疗：|cff89D5FF<*id,DataA*lv>|r]],
        targs = {"nonhero,self"},
        Buttonpos_1 = 0,
        Buttonpos_2 = 2,
        targetArt = [[]],
    ...
    ['AB0Q'] = {
        ...
        Cool = {10, 55},
        Tip = [=[ - [|cffffcc00等级 *lv|r]]=],
        Ubertip = [[增加暴击率,初始暴击伤害为150%|n|n暴击率：|cff89D5FF<*id,Cool*lv>%|r]],
        targs = {"nonhero,self"},
        Buttonpos_1 = 0,
        Buttonpos_2 = 2,
        targetArt = [[]],
    ...
    ['AB0R'] = { --18
        id = 'ACac',
        Name = [[温差撕裂]],
        Art = [[ReplaceableTextures\PassiveButtons\PASBTNtemtear.blp]],
        levels = 10,
        Cool = {50, 500},
        Tip = [=[ - [|cffffcc00等级 *lv|r]]=],
        Ubertip = [[使用|cff3399ff冰冻|r伤害攻击被|cffaa5555火焰|r伤害过的敌人时附加额外伤害|n|n额外伤害：|cff89D5FF<*id,Cool*lv>|r]],
        targs = {"nonhero,self"},
        Buttonpos_1 = 0,
        Buttonpos_2 = 2,
        targetArt = [[]],
    ...
    ['AB0S'] = {
        ...
        DataA = {0.6, 6},
        Tip = [=[ - [|cffffcc00等级 *lv|r]]=],
        Ubertip = [[|cff3399ff魔法|r伤害可以使得接下来的|cffffcc00非魔法|r伤害更高，最多叠加10层|n|n额外伤害：|cff89D5FF<*id,DataA*lv>%|r/层]],
        targs = {"nonhero,self"},
        Buttonpos_1 = 0,
        Buttonpos_2 = 2,
        targetArt = [[]],
    ...
    ['AB0T'] = { --20
        id = 'ACac',
        Name = [[腐坏意志]],
        Art = [[ReplaceableTextures\PassiveButtons\PASBTNSpellShadowAntiShadow.blp]],
        levels = 10,
        DataA = {30, 120},
        Tip = [=[ - [|cffffcc00等级 *lv|r]]=],
        Ubertip = [[|cff3399ff诅咒|r伤害杀死的敌人会腐坏周围300范围的其他敌人，使得他们流失生命|n流失的生命相当于致死伤害的一定比例|n|n流失比例：|cff89D5FF<*id,DataA*lv>%|r]],
        targs = {"nonhero,self"},
        Buttonpos_1 = 0,
        Buttonpos_2 = 2,
        targetArt = [[]],
